...
| Service risk is \(0.01\theta_i\sigma_i\), and operating cost is service cost plus path distance plus energy proxy | `src/lunar_ice_bpc/exact/core/columns.py`; `src/lunar_ice_bpc/exact/core/objective.py`; manuscript (6b) | supported |
