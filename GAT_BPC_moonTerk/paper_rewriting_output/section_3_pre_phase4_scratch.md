<!--
ARCHIVED BEFORE PHASE 4
NON-AUTHORITATIVE CONSISTENCY-CHECK ARTIFACT
This file is not the active manuscript.
It predates the Phase 3 pre-draft freeze and is retained only to preserve prior
work and expose model-consistency issues. It does not mark P01-P09 as drafted
or passed. Do not extend, translate, humanize, or export it without a new,
explicit user instruction authorizing manuscript prose.
Date demoted: 2026-07-23
Language: English
-->

> **Inactive scratch status.** The text below is not current manuscript prose.
> The controlling pre-draft sources are `phase_3_pre_draft_freeze.md`,
> `model_notation_and_equation_register.md`, and
