...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_2_cold_exact_support_continuation_protected_telemetry_smoke_5_001/proofs/scale_005/instance_001/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_2_cold_exact_support_continuation_protected_telemetry_smoke_5_001/proofs/scale_005/instance_001/b4_1_summary.json`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 1 | 1 | 1 | 0 | 0 | 0.0 | 0.169053 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 27.0 | 27.0 | None | -0.0 | 0.00633 |
...
- Dual-search audit rows: `1`；false-positive rows `0`；miss rows `0`；mean false+ `0.0`；mean miss `0.0`。
