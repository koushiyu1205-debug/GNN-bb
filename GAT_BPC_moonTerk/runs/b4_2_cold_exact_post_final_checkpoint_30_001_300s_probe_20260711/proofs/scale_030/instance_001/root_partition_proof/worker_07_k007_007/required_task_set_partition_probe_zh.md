...
- region MIP-start: enabled `37`; OK `9`; exact OK `5`; residual OK `4`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `36.89278`
...
| residual_task_count_007_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_REQUIRED_TASK_COUNT_INFEASIBLE | REQUIRED_TASK_COUNT_PRICING_INFEASIBLE | None |  |  | 321 | 321 | True | True | False | False | False |  |
| residual_task_count_007_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.362157998 | -0.362157998 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.351256331 | -0.351256331 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.322559665 | -0.322559665 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.142326999 | -0.142326999 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_006 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | 0.117913334 |  |  | 321 | 321 | True | True | False | False | False |  |
| residual_task_count_007_active_sorties_007 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_RESTRICTED_INFEASIBLE | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_INFEASIBLE | None |  |  | 321 | 321 | True | True | False | False | False |  |
