...
- region MIP-start: enabled `37`; OK `7`; exact OK `5`; residual OK `2`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `8.342037`
...
| residual_task_count_005_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.202977999 | -0.202977999 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.302574665 | -0.302574665 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.252607665 | -0.252607665 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.188218665 | -0.188218665 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.062495665 | -0.062495665 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
