...
- region MIP-start: enabled `38`; OK `10`; exact OK `5`; residual OK `5`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `23.402477`
...
| residual_task_count_006_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.028530666 | -0.028530666 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.310041665 | -0.310041665 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.350802998 | -0.350802998 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.224363332 | -0.224363332 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.159975332 | -0.159975332 | 0.0 | 321 | 321 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_006 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | 0.068880001 |  |  | 321 | 321 | True | True | False | False | False |  |
