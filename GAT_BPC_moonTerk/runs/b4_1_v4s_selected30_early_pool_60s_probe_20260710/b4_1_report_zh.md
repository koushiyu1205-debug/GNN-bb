...
- CSV rows: `runs/b4_1_v4s_selected30_early_pool_60s_probe_20260710/b4_1_rows.csv`
- JSON summary: `runs/b4_1_v4s_selected30_early_pool_60s_probe_20260710/b4_1_summary.json`
...
| R4_stage_c_selected_diagnostic | pass | {"stage_c_diagnostic_clean":true,"stage_c_row_count":5,"stage_c_selected_row_count":5} |  |
| R5_stage_bc_diagnostic_only | pass | {"frontier_lb_official_row_count":0,"stage_bc_certificate_claim_count":0,"stage_bc_row_count":5} |  |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| C | B4.1_30_tree_closure_from_probe | V4S_pair_weighted_strengthened_early_pool_60s | 5 | 0 | 0 | 0 | 0 | None | 0.267357 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| C | B4.1_30_tree_closure_from_probe | V4S_pair_weighted_strengthened_early_pool_60s | 38.2 | 38.2 | None | None | 0.267357 |
