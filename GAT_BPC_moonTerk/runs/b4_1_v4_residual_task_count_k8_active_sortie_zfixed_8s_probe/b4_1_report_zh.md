...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k8_active_sortie_zfixed_8s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k8_active_sortie_zfixed_8s_probe/b4_1_summary.json`
...
- Partition model size: max variables `5322`；max constraints `15477`；max mean variables `3459.125`；max mean constraints `10020.625`。
- Partition slot pruning: max feasible assignments `178`；pruned assignments sum `195`；pruned arc options sum `70`。
