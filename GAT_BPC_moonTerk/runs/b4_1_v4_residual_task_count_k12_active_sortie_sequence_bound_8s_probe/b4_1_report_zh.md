...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k12_active_sortie_sequence_bound_8s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k12_active_sortie_sequence_bound_8s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6192`；max constraints `18099`；max mean variables `4288.25`；max mean constraints `12466.75`。
- Partition slot pruning: max feasible assignments `229`；pruned assignments sum `605`；pruned arc options sum `146`。
