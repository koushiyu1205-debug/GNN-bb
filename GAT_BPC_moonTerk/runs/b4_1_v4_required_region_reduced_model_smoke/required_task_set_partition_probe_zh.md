...
- partition_candidate_gate_issue_codes: `['incomplete_residual_region', 'unproven_residual_region']`
...
- region MIP-start: enabled `2`; OK `2`; exact OK `1`; residual OK `1`
...
| residual_after_exact_task_sets | residual_after_exact_task_sets | V4_current_strengthening | COMPACT_HIGHS_PRICING_TIME_LIMIT_REACHED | NOT_SOLVED | 0.0 |  |  | 345 | 345 | False | False | False | False | False |  |
