...
- region MIP-start: enabled `33`; OK `5`; exact OK `5`; residual OK `0`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `5.286062`
...
| residual_task_count_004_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.357643704 | -0.357643704 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.345416704 | -0.345416704 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.331702704 | -0.331702704 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.229633223 | -0.229633223 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
