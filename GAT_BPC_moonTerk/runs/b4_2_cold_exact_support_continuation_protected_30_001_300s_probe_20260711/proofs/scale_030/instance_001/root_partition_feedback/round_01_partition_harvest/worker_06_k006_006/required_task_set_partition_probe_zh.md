...
- region MIP-start: enabled `33`; OK `6`; exact OK `5`; residual OK `1`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `7.123196`
...
| residual_task_count_006_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.394944742 | -0.394944742 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.567988556 | -0.567988556 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.539423556 | -0.539423556 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.521808556 | -0.521808556 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.415353149 | -0.415353149 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_006 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.23855026 | -0.23855026 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
