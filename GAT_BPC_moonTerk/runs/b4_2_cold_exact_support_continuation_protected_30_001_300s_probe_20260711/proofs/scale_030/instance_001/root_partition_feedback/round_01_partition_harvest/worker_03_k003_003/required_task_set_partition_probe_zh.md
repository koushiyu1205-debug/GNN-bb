...
- region MIP-start: enabled `33`; OK `7`; exact OK `5`; residual OK `2`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `3.733157`
...
| residual_task_count_003_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.252116778 | -0.252116778 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_003_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.238402778 | -0.238402778 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_003_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.15356963 | -0.15356963 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
