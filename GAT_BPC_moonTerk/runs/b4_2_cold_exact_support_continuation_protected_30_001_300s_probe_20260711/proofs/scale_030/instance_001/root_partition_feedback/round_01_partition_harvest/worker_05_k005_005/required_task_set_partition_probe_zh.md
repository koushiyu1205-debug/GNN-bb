...
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `5.470166`
...
| residual_task_count_005_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.467660297 | -0.467660297 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.453946297 | -0.453946297 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.42850763 | -0.42850763 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.407766297 | -0.407766297 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.30131089 | -0.30131089 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
