...
- model: `P0V4_BIDIRECTIONAL_ROOT_PARTIAL_ESCAPE_BATCH_ALL_SCALE_CANDIDATE_V4_S50_native_rcspp_bidirectional_root_partial_hybrid_v3`
- config hash: `30c15f124a99d845`
...
- root-pool post-final-judge selected/new/replacement/added: `3674` / `3674` / `0` / `3674`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 3603.063839 | 3603.063839 | 657.963054 | None | 2942.918232 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_005 | BPC_GAP_AVAILABLE | BPC_NODE_LP_CERTIFIED | CERTIFIED_NO_NEGATIVE | False | False | 3603.063839 | 657.963054 | None | 2942.918232 | 3729 | 0 | 0 | 3674 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | tree closure did not produce BPC_TREE_OPTIMAL |
