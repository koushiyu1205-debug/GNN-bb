...
- model: `P0V4_BIDIRECTIONAL_ROOT_PARTIAL_ESCAPE_BATCH_ALL_SCALE_CANDIDATE_V4_S5_native_rcspp_bidirectional_root_partial_hybrid_v3`
- config hash: `5a24ae26ed2664a2`
...
- root-pool post-final-judge selected/new/replacement/added: `17` / `16` / `1` / `17`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 5 | 1 | 1 | 1 | 0 | 0.456385 | 0.456385 | 0.117944 | None | 0.190188 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 5 | instance_001 | BPC_OPTIMAL | BPC_TREE_OPTIMAL | CERTIFIED_NO_NEGATIVE | True | True | 0.456385 | 0.117944 | None | 0.190188 | 22 | 0 | 0 | 17 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback |  |
