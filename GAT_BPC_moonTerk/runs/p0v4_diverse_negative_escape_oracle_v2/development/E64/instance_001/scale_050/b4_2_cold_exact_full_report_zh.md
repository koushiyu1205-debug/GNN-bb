...
- labeling final judge: `on`, max exact tasks `50`, exact harvest target `64`
- rows: `1`
- no-cheat fail: `0`
...
- root-pool post-final-judge selected/new/replacement/added: `5545` / `5545` / `0` / `5545`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 3592.311472 | 3592.311472 | 3591.312682 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 3592.311472 | 3591.312682 | None | None | 5600 | 0 | 0 | 5545 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
