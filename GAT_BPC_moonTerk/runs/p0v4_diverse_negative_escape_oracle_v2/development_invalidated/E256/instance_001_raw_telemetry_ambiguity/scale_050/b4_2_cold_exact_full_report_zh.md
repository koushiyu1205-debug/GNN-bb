...
- labeling final judge: `on`, max exact tasks `50`, exact harvest target `256`
- rows: `1`
- no-cheat fail: `0`
...
- root-pool post-final-judge selected/new/replacement/added: `13979` / `13975` / `4` / `13979`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 3138.478897 | 3138.478897 | 3136.463597 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 3138.478897 | 3136.463597 | None | None | 14030 | 0 | 0 | 13979 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
