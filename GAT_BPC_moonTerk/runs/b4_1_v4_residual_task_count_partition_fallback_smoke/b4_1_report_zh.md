...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_partition_fallback_smoke/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_partition_fallback_smoke/b4_1_summary.json`
...
- Partition region MIP-start: enabled `5`；OK `5`；exact OK `1`；residual OK `4`。
- Residual task-count partition: enabled rows `1`；expected `30`；observed `4`；proven `3`；incomplete `1`；negative `0`；missing `26`。
