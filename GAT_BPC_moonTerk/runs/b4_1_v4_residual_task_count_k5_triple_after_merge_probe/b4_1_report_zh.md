...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k5_triple_after_merge_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k5_triple_after_merge_probe/b4_1_summary.json`
...
- Partition candidate top issue: `unproven_residual_task_count_region`；issue counts `{"missing_residual_task_count_region":1,"negative_bound_residual_task_count_region":1,"negative_residual_task_count_region":1,"unproven_residual_task_count_region":1}`。
- Partition negative regions: `1`；payload available `1`；best negative RC `-0.000325`。
- Partition negative relation: already active `0`；replacement `1`；new task-set `0`。
...
- Residual task-count partition: enabled rows `1`；expected `30`；observed `1`；proven `0`；incomplete `0`；negative `1`；missing `29`。
