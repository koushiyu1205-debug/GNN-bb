...
- partition_best_negative_rc: `-0.000325`
- partition negative relation counts: already_active `0`; replacement `1`; new_task_set `0`
...
| --- | --- | ---: | --- | ---: | --- | --- | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- | --- | --- |
| /home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k5_triple_after_merge_probe/required_task_set_partition_probe.json | lunar_ice_sp50_030_001_seed929001 | 3 | False | 4 | missing_residual_task_count_region, negative_bound_residual_task_count_region, negative_residual_task_count_region, unproven_residual_task_count_region | V4_current_triple_time_window_infeasible | refreshed_active_pool_restricted_rmp | RESTRICTED_RMP_OPTIMAL | 1 | 0 | 0 | 347/347 | 0 | 0 | -0.000325 | False | False | False |
