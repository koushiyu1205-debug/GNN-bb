...
- model: `NATIVE_SPPRC_ACCEPTANCE_V1_S20_native_rcspp_dssr_inprocess`
- config hash: `a4b36f3560bafebd`
...
- root-pool post-final-judge selected/new/replacement/added: `426` / `422` / `4` / `426`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 20 | 1 | 1 | 0 | 0 | 896.054262 | 896.054262 | 464.734821 | None | 430.941147 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 20 | instance_011 | BPC_OPTIMAL | BPC_TREE_OPTIMAL | CERTIFIED_NO_NEGATIVE | True | False | 896.054262 | 464.734821 | None | 430.941147 | 445 | 0 | 0 | 426 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback |  |
