...
- model: `NATIVE_SPPRC_ACCEPTANCE_V1_S50_native_rcspp_dssr_host`
- config hash: `f81063c34b657abe`
...
- root-pool post-final-judge selected/new/replacement/added: `10186` / `10180` / `6` / `10186`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 3593.298121 | 3593.298121 | 3590.396314 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_002 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 3593.298121 | 3590.396314 | None | None | 10235 | 0 | 0 | 10186 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
