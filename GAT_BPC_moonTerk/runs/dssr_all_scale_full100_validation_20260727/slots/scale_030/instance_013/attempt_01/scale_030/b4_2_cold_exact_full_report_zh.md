...
- model: `NATIVE_SPPRC_ACCEPTANCE_V1_S30_native_rcspp_dssr_inprocess`
- config hash: `d00042a1906ef322`
...
- root-pool post-final-judge selected/new/replacement/added: `2136` / `2135` / `1` / `2136`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 3591.078404 | 3591.078404 | 3590.242201 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 30 | instance_013 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 3591.078404 | 3590.242201 | None | None | 2169 | 0 | 0 | 2136 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
