...
- model: `NATIVE_SPPRC_ACCEPTANCE_V1_S10_native_rcspp_dssr_inprocess`
- config hash: `72bff97674fa85b2`
...
- root-pool post-final-judge selected/new/replacement/added: `100` / `100` / `0` / `100`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 10 | 1 | 1 | 1 | 0 | 3.392956 | 3.392956 | 1.853036 | None | 1.349964 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 10 | instance_013 | BPC_OPTIMAL | BPC_TREE_OPTIMAL | CERTIFIED_NO_NEGATIVE | True | True | 3.392956 | 1.853036 | None | 1.349964 | 112 | 0 | 0 | 100 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback |  |
