...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k29_active_sortie_pairconflict_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k29_active_sortie_pairconflict_full_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `0`；max constraints `0`；max mean variables `0.0`；max mean constraints `0.0`。
- Partition slot pruning: max feasible assignments `275`；pruned assignments sum `5680`；pruned arc options sum `0`。
