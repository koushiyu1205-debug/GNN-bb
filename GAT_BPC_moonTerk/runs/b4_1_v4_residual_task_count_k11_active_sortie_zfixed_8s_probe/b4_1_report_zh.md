...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k11_active_sortie_zfixed_8s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k11_active_sortie_zfixed_8s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6057`；max constraints `17691`；max mean variables `4115.181818`；max mean constraints `11954.727273`。
- Partition slot pruning: max feasible assignments `219`；pruned assignments sum `474`；pruned arc options sum `127`。
