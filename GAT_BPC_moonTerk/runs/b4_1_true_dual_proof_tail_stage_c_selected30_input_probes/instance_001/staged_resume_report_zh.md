...
- latest_probe: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_true_dual_proof_tail_stage_c_selected30_input_probes/instance_001/stage_001/probe.json`
- stage_count: `1`

| stage | batch | round cap | resume cols | active cols | added | rounds | state | scope | best RC | elapsed s |
|---:|---:|---:|---:|---:|---:|---:|---|---|---:|---:|
| 1 | 5 | 3 | 0 | 37 | 3 | 3 | INCOMPLETE_LIMIT | DIAGNOSTIC_PRICING_FRONTIER | -0.6281595 | 301.312432 |
