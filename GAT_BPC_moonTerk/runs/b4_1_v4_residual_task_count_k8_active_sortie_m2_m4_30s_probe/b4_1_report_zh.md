...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k8_active_sortie_m2_m4_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k8_active_sortie_m2_m4_30s_probe/b4_1_summary.json`
...
- Partition candidate top issue: `unproven_residual_task_count_region`；issue counts `{"incomplete_residual_task_count_region":1,"missing_residual_active_sortie_count_region":1,"missing_residual_task_count_region":1,"unproven_residual_task_count_region":1}`。
...
- Partition model size: max variables `3583`；max constraints `10354`；max mean variables `2874.333333`；max mean constraints `8303.666667`。
- Partition slot pruning: max feasible assignments `105`；pruned assignments sum `25`；pruned arc options sum `22`。
