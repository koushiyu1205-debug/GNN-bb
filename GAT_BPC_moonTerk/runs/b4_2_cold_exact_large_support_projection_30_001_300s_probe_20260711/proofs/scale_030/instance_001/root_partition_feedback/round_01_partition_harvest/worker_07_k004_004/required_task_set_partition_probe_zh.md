...
- region MIP-start: enabled `35`; OK `20`; exact OK `20`; residual OK `0`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `4.346436`
...
| residual_task_count_004_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.086112529 | -0.086112529 | 0.0 | 223 | 223 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.113666176 | -0.113666176 | 0.0 | 223 | 223 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.069607235 | -0.069607235 | 0.0 | 223 | 223 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.048479882 | -0.048479882 | 0.0 | 223 | 223 | True | False | True | True | False | new_task_set |
