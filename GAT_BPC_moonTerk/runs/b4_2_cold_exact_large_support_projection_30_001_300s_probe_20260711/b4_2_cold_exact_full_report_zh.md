...
- config hash: `0fec316fdb8e7576`
- root engine: `b2b_r3_worker`
- worker pricer: `relaxed_labeling`, max task cap `4`
...
- root-pool support-continuation seeds/active/protected/leaks: `61` / `55` / `32` / `0`
- root-pool exact harvest candidates/selected/new/replacement: `0` / `0` / `0` / `0`
- root-pool worker selected/new/replacement: `93` / `93` / `0`
- root-pool post-final-judge selected/new/replacement/added: `0` / `0` / `0` / `0`
- root-partition post-final feedback selected/added: `32` / `32`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 301.351407 | 301.351407 | 91.287927 | 162.757873 | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 301.351407 | 91.287927 | 162.757873 | None | 354 | 0 | 93 | 0 | 32 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | post-final partition feedback checkpointed addable negative columns, but fixed row budget is exhausted |
