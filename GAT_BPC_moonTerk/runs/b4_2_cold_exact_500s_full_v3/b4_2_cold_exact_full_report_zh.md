...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 501.890412 | 501.890412 | 500.016666 | None |

## Per-Instance

| scale | instance | status | scope | pricing | exact | under500 | total | root | tree | active cols | provenance | fail reason |
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 501.890412 | 500.016666 | None | 528 | instance_json_fixed_seed_and_same_run_checkpoints | row time limit reached before root pool certificate |
