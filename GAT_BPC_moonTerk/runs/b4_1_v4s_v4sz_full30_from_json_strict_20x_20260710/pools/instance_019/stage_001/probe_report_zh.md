...
- sortie slot-position bounds rows: `83`
...
- triple time-window infeasible cut rows: `72`
...
- best_reduced_cost: `-1.492944`
- final_judge_wall_time: `220.810511`
- resume source: ``
...
|---:|---|---:|---:|---:|---|
| 1 | FOUND_NEGATIVE | 5 | -1.492944 | -1.492943792 | optimization_harvest |
