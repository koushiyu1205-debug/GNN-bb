...
- sortie slot-position bounds rows: `68`
...
- triple time-window infeasible cut rows: `42`
...
- best_reduced_cost: `-0.6574355`
- final_judge_wall_time: `176.526418`
- resume source: ``
...
|---:|---|---:|---:|---:|---|
| 1 | FOUND_NEGATIVE | 5 | -0.6574355 | -0.65743536 | optimization_harvest |
