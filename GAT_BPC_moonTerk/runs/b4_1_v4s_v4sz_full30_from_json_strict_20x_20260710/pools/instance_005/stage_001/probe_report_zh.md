...
- sortie slot-position bounds rows: `77`
...
- triple time-window infeasible cut rows: `27`
...
- best_reduced_cost: `-1.925501`
- final_judge_wall_time: `102.797849`
- resume source: ``
...
|---:|---|---:|---:|---:|---|
| 1 | FOUND_NEGATIVE | 5 | -1.925501 | -1.925501419 | optimization_harvest |
