...
- sortie slot-position bounds rows: `71`
...
- triple time-window infeasible cut rows: `306`
...
- best_reduced_cost: `-0.7854915`
- final_judge_wall_time: `138.879757`
- resume source: ``
...
|---:|---|---:|---:|---:|---|
| 1 | FOUND_NEGATIVE | 5 | -0.7854915 | -0.785491117 | optimization_harvest |
