...
- sortie slot-position bounds rows: `80`
...
- triple time-window infeasible cut rows: `26`
...
- best_reduced_cost: `-0.557342`
- final_judge_wall_time: `249.976189`
- resume source: ``
...
|---:|---|---:|---:|---:|---|
| 1 | FOUND_NEGATIVE | 5 | -0.557342 | -0.557341623 | optimization_harvest |
