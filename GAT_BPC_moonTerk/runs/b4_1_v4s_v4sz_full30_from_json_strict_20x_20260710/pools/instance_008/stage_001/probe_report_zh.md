...
- sortie slot-position bounds rows: `74`
...
- triple time-window infeasible cut rows: `11`
...
- best_reduced_cost: `-0.9443495`
- final_judge_wall_time: `66.262539`
- resume source: ``
...
|---:|---|---:|---:|---:|---|
| 1 | FOUND_NEGATIVE | 5 | -0.9443495 | -0.94434947 | optimization_harvest |
