...
- sortie slot-position bounds rows: `47`
...
- triple time-window infeasible cut rows: `31`
...
- best_reduced_cost: `-0.660489`
- final_judge_wall_time: `100.929596`
- resume source: ``
...
|---:|---|---:|---:|---:|---|
| 1 | FOUND_NEGATIVE | 5 | -0.660489 | -0.660489293 | optimization_harvest |
