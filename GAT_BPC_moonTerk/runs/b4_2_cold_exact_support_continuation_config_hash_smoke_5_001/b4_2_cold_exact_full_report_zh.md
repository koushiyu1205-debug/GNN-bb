...
- labeling support-continuation: enabled `True`, max seed sets `240`, max neighbors `4`
...
- root-pool support-continuation seeds/active/leaks: `0` / `0` / `0`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 5 | 1 | 1 | 1 | 0 | 0.881062 | 0.881062 | 0.503428 | None | 0.254336 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 5 | instance_001 | BPC_OPTIMAL | BPC_TREE_OPTIMAL | CERTIFIED_NO_NEGATIVE | True | True | 0.881062 | 0.503428 | None | 0.254336 | 27 | 0 | 21 | 0 | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback |  |
