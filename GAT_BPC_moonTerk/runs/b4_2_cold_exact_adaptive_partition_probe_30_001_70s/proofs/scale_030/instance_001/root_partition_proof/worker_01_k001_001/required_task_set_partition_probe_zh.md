...
- adaptive active-sortie refinement: enabled `True`; attempts `1`; coarse accepted `1`; refined `0`; discarded coarse wall `0.0`; total wall `1.709704`
...
| residual_task_count_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_TASK_COUNT_PRICING_OPTIMAL | 0.083135 |  |  | 199 | 199 | True | True | False | False | False |  |
