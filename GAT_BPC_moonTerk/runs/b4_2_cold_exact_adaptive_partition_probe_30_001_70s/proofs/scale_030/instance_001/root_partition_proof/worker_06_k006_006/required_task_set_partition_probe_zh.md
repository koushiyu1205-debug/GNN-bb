...
- region MIP-start: enabled `30`; OK `5`; exact OK `5`; residual OK `0`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `True`; attempts `1`; coarse accepted `0`; refined `1`; discarded coarse wall `2.204032`; total wall `9.709364`
...
| residual_task_count_006_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.333691 | -0.333691 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.400939125 | -0.400939125 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.3960495 | -0.3960495 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.3878995 | -0.3878995 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.3760715 | -0.3760715 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_006 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.3301545 | -0.3301545 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
