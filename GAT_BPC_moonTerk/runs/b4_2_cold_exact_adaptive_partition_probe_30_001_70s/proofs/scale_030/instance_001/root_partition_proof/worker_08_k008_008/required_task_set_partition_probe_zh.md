...
- adaptive active-sortie refinement: enabled `True`; attempts `1`; coarse accepted `0`; refined `1`; discarded coarse wall `2.215942`; total wall `18.923528`
...
| residual_task_count_008_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.033484875 | -0.033484875 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
