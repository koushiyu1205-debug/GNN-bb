...
- Source probe: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_2_cold_exact_adaptive_partition_probe_30_001_70s/pools/scale_030/instance_001/stage_002/probe.json`
...
- negative relation counts: already_active `0`; replacement `1`; new_task_set `4`
...
- region MIP-start: enabled `29`; OK `6`; exact OK `5`; residual OK `1`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `True`; attempts `1`; coarse accepted `0`; refined `1`; discarded coarse wall `2.216224`; total wall `14.191716`
...
| residual_task_count_007_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.43319 | -0.43319 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_TIME_LIMIT_REACHED | NOT_SOLVED | -0.001485 | -0.001485 | 0.0 | 199 | 199 | False | False | True | True | False | replacement |
| residual_task_count_007_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_TIME_LIMIT_REACHED | NOT_SOLVED | -0.418505 | -0.418505 | 0.0 | 199 | 199 | False | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.164524875 | -0.164524875 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_006 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.385510375 | -0.385510375 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
