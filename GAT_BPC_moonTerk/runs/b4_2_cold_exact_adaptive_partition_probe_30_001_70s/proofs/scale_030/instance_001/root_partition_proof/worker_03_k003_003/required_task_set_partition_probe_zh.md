...
- region MIP-start: enabled `30`; OK `6`; exact OK `5`; residual OK `1`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `True`; attempts `1`; coarse accepted `0`; refined `1`; discarded coarse wall `0.763192`; total wall `3.34164`
...
| residual_task_count_003_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.2029355 | -0.2029355 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_003_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.1911075 | -0.1911075 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_003_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.1639055 | -0.1639055 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
