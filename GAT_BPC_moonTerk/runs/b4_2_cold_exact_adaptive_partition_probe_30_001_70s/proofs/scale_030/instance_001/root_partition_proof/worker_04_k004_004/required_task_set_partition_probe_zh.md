...
- adaptive active-sortie refinement: enabled `True`; attempts `1`; coarse accepted `0`; refined `1`; discarded coarse wall `2.042855`; total wall `5.729127`
...
| residual_task_count_004_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.29252025 | -0.29252025 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.28598625 | -0.28598625 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.27783625 | -0.27783625 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
| residual_task_count_004_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.26600725 | -0.26600725 | 0.0 | 199 | 199 | True | False | True | True | False | new_task_set |
