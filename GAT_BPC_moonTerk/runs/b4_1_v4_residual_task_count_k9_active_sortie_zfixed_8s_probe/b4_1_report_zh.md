...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k9_active_sortie_zfixed_8s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k9_active_sortie_zfixed_8s_probe/b4_1_summary.json`
...
- Partition model size: max variables `5641`；max constraints `16439`；max mean variables `3701.555556`；max mean constraints `10733.777778`。
- Partition slot pruning: max feasible assignments `194`；pruned assignments sum `271`；pruned arc options sum `89`。
