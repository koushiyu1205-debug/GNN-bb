...
- CSV rows: `runs/objective_normalized_cost_risk_completion_full/b3_scale005_rows.csv`
- JSON summary: `runs/objective_normalized_cost_risk_completion_full/b3_scale005_summary.json`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 5 | 5-scale full normalized objective | B0_pure_direct_dp | 20 | 0 | 0 | 0 | 0.01135 | 0 | 0 |
| 5 | 5-scale full normalized objective | B2B_R3_true_dual_negative_search_worker | 20 | 0 | 20 | 0 | 0.354847 | 0 | 0 |
| 5 | 5-scale full normalized objective | B2_PRODUCT_EXACT_SOLVER | 20 | 0 | 0 | 0 | 0.010951 | 0 | 0 |
| 5 | 5-scale full normalized objective | B3A_full_universe_branch_audit | 20 | 0 | 20 | 0 | 0.276123 | 1 | 0 |
| 5 | 5-scale full normalized objective | B3B_seeded_branch_price_tree | 20 | 20 | 20 | 0 | 0.376418 | 1 | 0 |
