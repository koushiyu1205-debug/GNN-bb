...
- CSV rows: `runs/objective_normalized_cost_risk_completion_full/b3_scale030_rows.csv`
- JSON summary: `runs/objective_normalized_cost_risk_completion_full/b3_scale030_summary.json`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 30 | 30-scale full normalized objective | B0_pure_direct_dp | 20 | 0 | 0 | 20 | 0.0 | 0 | 20 |
| 30 | 30-scale full normalized objective | B2B_R3_true_dual_negative_search_worker | 20 | 0 | 0 | 20 | 0.0 | 0 | 20 |
| 30 | 30-scale full normalized objective | B2_PRODUCT_EXACT_SOLVER | 20 | 0 | 0 | 20 | 0.0 | 0 | 20 |
| 30 | 30-scale full normalized objective | B3A_full_universe_branch_audit | 20 | 0 | 0 | 20 | 0.0 | 0 | 20 |
| 30 | 30-scale full normalized objective | B3B_seeded_branch_price_tree | 20 | 0 | 0 | 20 | 0.0 | 0 | 20 |

## Acceptance Scope

- Cross-scale B3 acceptance is not evaluated in this artifact; this report may contain only one scale or one batch.
- Local B3B BPC_TREE_OPTIMAL: 0/20.
- Local B3B all tree optimal: False.
