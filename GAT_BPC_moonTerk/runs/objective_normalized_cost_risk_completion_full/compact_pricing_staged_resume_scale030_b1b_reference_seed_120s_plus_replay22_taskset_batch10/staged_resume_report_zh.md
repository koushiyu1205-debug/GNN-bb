...
- latest_probe: `/home/kai/work/GAT_BPC_moonTerk/runs/objective_normalized_cost_risk_completion_full/compact_pricing_staged_resume_scale030_b1b_reference_seed_120s_plus_replay22_taskset_batch10/stage_001/probe.json`
- stage_count: `1`

| stage | batch | round cap | resume cols | active cols | added | rounds | state | scope | best RC | elapsed s |
|---:|---:|---:|---:|---:|---:|---:|---|---|---:|---:|
| 1 | 10 | 4 | 175 | 176 | 1 | 2 | INCOMPLETE_LIMIT | DIAGNOSTIC_PRICING_FRONTIER | -0.218606299 | 900.840071 |
