...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_true_dual_proof_tail_acceptance_audit_with_tree_closure/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_true_dual_proof_tail_acceptance_audit_with_tree_closure/b4_1_summary.json`
...
| R3_stage_b_matrix_complete | pass | {"missing":[],"observed":["B4V2_baseline","B4V2_frontier_ledger_diagnostic","B4V2_harvesting","B4V2_harvesting_frontier_ledger_diagnostic","B4V2_hidden_negative_audit","B4V4_combined_formulation_diagnostic"],"stage_b_row_count":18} |  |
| R4_stage_c_selected_diagnostic | pass | {"stage_c_diagnostic_clean":true,"stage_c_row_count":10,"stage_c_selected_row_count":10} |  |
| R5_stage_bc_diagnostic_only | pass | {"frontier_lb_official_row_count":0,"stage_bc_certificate_claim_count":0,"stage_bc_row_count":28} |  |
...
| R7_30_scale_exact_closure | pass | {"known_boundary":"A 30-scale root LP no-negative proof can be recorded as underlying evidence, but R7 remains incomplete until BPC_TREE_OPTIMAL is proven.","thirty_scale_bpc_tree_optimal_count":1,"thirty_scale_underlying_exhaustive_no_negative_count":2,"thirty_scale_underlying_node_lp_certified_count":2} |  |
...
| B | B4.1_probe_final_judge_evidence | V4_combined_endpoint_pair_latest_start_time_window | 12 | 0 | 0 | 0 | 31 | -0.00091019 | 570.224962 |
...
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 1 | 1 | 0 | 0 | 0 | None | 549.355622 |
...
| B | B4.1_probe_final_judge_evidence | V4_combined_endpoint_pair_latest_start_time_window | 349.166667 | 349.166667 | -0.007705961 | -0.007705961 | 570.224962 |
...
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 371.0 | 371.0 | None | None | 549.355622 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | ---: | --- |
| B4.1_probe_final_judge_evidence | V4_combined_endpoint_pair_latest_start_time_window | 371 | 0 | 0 | None | None | FRONTIER_BOUND_INCOMPLETE | DIAGNOSTIC_PRICING_FRONTIER | BPC_NODE_LP_CERTIFIED | EXHAUSTIVE_NO_NEGATIVE | True | 292.704916 | runs/b4_1_true_dual_proof_tail_stage_b_30_v4_after_epsilon_band_merge_official_eps_600s/stage_002/probe.json |
...
- 30-scale underlying root LP certified rows: `2`。
- 30-scale underlying exhaustive no-negative proofs: `2`。
