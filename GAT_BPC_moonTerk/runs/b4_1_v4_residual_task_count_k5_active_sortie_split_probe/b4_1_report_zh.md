...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k5_active_sortie_split_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k5_active_sortie_split_probe/b4_1_summary.json`
...
- Partition candidate top issue: `missing_residual_task_count_region`；issue counts `{"duplicate_residual_task_count_region":1,"missing_residual_task_count_region":1}`。
...
- Residual task-count partition: enabled rows `1`；expected `30`；observed `1`；proven `5`；incomplete `0`；negative `0`；missing `29`。
