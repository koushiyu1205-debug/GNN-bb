...
- large-task direct worker: enabled `True`, max tasks `12`, candidate sets `240`, time cap `25.0`
...
- root-pool support-continuation seeds/active/protected/leaks: `15` / `15` / `15` / `0`
- root-pool exact harvest candidates/selected/new/replacement: `0` / `0` / `0` / `0`
- root-pool worker selected/new/replacement: `21` / `20` / `1`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 5 | 1 | 1 | 1 | 0 | 0.923489 | 0.923489 | 0.525875 | None | 0.265315 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 5 | instance_001 | BPC_OPTIMAL | BPC_TREE_OPTIMAL | CERTIFIED_NO_NEGATIVE | True | True | 0.923489 | 0.525875 | None | 0.265315 | 27 | 0 | 21 | 0 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback |  |
