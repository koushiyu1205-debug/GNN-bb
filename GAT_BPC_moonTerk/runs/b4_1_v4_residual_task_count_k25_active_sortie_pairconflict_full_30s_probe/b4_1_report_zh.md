...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k25_active_sortie_pairconflict_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k25_active_sortie_pairconflict_full_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6656`；max constraints `19549`；max mean variables `3797.84`；max mean constraints `11100.88`。
- Partition slot pruning: max feasible assignments `275`；pruned assignments sum `4260`；pruned arc options sum `276`。
