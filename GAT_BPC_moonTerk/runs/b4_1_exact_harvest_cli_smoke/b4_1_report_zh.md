...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_exact_harvest_cli_smoke/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_exact_harvest_cli_smoke/b4_1_summary.json`
...
| stage_a_tree_closure_miss_count | 1 | 0 |
...
| --- | --- | --- | --- |
| R1_redlines_zero | fail | {"redline_count":9,"redline_failures":{"stage_a_tree_closure_miss_count":1}} | Fix failing redlines before interpreting any B4.1 diagnostic as evidence. |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| A | stageA_B4V2_default_final_judge_harvesting |  | 1 | 0 | 0 | 0 | 10 | None | 0.100681 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| A | stageA_B4V2_default_final_judge_harvesting |  | None | None | None | -0.588415 | 3.2e-05 |
