...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 150.03873 | 150.03873 | 74.689956 | 74.712479 | None |

## Per-Instance

| scale | instance | status | scope | pricing | exact | under500 | total | root | partition | tree | active cols | provenance | fail reason |
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 150.03873 | 74.689956 | 74.712479 | None | 179 | instance_json_fixed_seed_and_same_run_checkpoints | reserved remaining budget for official root partition proof |
