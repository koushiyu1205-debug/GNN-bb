...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k9_active_sortie_quad_tw_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k9_active_sortie_quad_tw_full_30s_probe/b4_1_summary.json`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| B | B4.1_partition_candidate_audit | V4_current_quad_time_window_infeasible | 1 | 0 | 0 | 0 | 0 | None | None |
...
- Partition model size: max variables `5641`；max constraints `16487`；max mean variables `3701.555556`；max mean constraints `10775.222222`。
