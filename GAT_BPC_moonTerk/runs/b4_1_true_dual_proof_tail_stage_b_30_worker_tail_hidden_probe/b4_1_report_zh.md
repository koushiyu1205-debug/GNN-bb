...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_true_dual_proof_tail_stage_b_30_worker_tail_hidden_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_true_dual_proof_tail_stage_b_30_worker_tail_hidden_probe/b4_1_summary.json`
...
- Stage B observed matrix cells: `B4V2_baseline, B4V2_frontier_ledger_diagnostic, B4V2_hidden_negative_audit`。
- Stage B missing matrix cells: `B4V2_harvesting, B4V2_harvesting_frontier_ledger_diagnostic, B4V4_combined_formulation_diagnostic`。
