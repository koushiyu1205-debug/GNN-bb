...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_after_k4_merge_smoke/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_after_k4_merge_smoke/b4_1_summary.json`
...
- Residual task-count partition: enabled rows `1`；expected `30`；observed `4`；proven `4`；incomplete `0`；negative `0`；missing `26`。
