...
- partition_best_negative_rc: `-0.005443`
...
| --- | --- | ---: | --- | ---: | --- | --- | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- | --- | --- |
| /home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k4_fallback_20s_probe/required_task_set_partition_probe.json | lunar_ice_sp50_030_001_seed929001 | 1 | False | 4 | missing_residual_task_count_region, negative_bound_residual_task_count_region, negative_residual_task_count_region, unproven_residual_task_count_region | V4_current_strengthening | refreshed_active_pool_restricted_rmp | RESTRICTED_RMP_OPTIMAL | 1 | 0 | 1 | 345/345 | 0 | 0 | -0.005443 | False | False | False |
