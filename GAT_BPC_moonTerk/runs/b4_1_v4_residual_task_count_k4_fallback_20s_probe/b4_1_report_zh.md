...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k4_fallback_20s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k4_fallback_20s_probe/b4_1_summary.json`
...
- Partition negative regions: `1`；payload available `1`；best negative RC `-0.005443`。
...
- Partition region MIP-start: enabled `2`；OK `2`；exact OK `1`；residual OK `1`。
