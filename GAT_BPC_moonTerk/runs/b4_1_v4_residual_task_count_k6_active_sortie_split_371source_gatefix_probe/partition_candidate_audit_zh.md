...
- gate issue counts: `{'incomplete_residual_task_count_region': 1, 'missing_residual_task_count_region': 1, 'negative_bound_residual_task_count_region': 1, 'unproven_residual_task_count_region': 1}`
...
| --- | --- | ---: | --- | ---: | --- | --- | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- | --- | --- |
| /home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k6_active_sortie_split_371source_gatefix_probe/required_task_set_partition_probe.json | lunar_ice_sp50_030_001_seed929001 | 0 | False | 4 | incomplete_residual_task_count_region, missing_residual_task_count_region, negative_bound_residual_task_count_region, unproven_residual_task_count_region | V4_current_strengthening | refreshed_active_pool_restricted_rmp | RESTRICTED_RMP_OPTIMAL | 0 | 0 | 0 | 371/371 | 0 | 0 | None | False | False | False |
