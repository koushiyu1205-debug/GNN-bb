...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k6_active_sortie_split_371source_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k6_active_sortie_split_371source_probe/b4_1_summary.json`
...
- Partition candidate top issue: `no_target_task_sets`；issue counts `{"missing_residual_region":1,"no_target_task_sets":1}`。
...
- Residual task-count partition: enabled rows `0`；expected `30`；observed `0`；proven `0`；incomplete `0`；negative `0`；missing `0`。
