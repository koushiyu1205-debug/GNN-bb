...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_2_cold_exact_telemetry_smoke_5_001_v3/proofs/scale_005/instance_001/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_2_cold_exact_telemetry_smoke_5_001_v3/proofs/scale_005/instance_001/b4_1_summary.json`
...
| R6_tail_dual_worker_only | fail | {"tail_dual_certificate_leak_count":1,"tail_dual_enabled_count":1,"tail_dual_no_column_can_certify_count":0,"tail_dual_official_true_dual_source_count":1,"tail_dual_true_dual_recomputed_count":1,"tail_dual_worker_only_count":1} | Keep tail dual as candidate-search telemetry only; recompute selected columns under the current true RMP dual. |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 1 | 1 | 1 | 0 | 0 | 0.0 | 0.164839 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 27.0 | 27.0 | None | 0.0 | 0.006052 |
