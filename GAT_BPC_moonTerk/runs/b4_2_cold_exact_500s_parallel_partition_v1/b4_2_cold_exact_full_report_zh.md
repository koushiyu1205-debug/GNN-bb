...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 505.18903 | 505.18903 | 279.921282 | 223.961161 | None |

## Per-Instance

| scale | instance | status | scope | pricing | exact | under500 | total | root | partition | tree | active cols | provenance | fail reason |
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 505.18903 | 279.921282 | 223.961161 | None | 459 | instance_json_fixed_seed_and_same_run_checkpoints | parallel partition gate did not satisfy official B4.2 criteria |
