...
- region MIP-start: enabled `35`; OK `14`; exact OK `13`; residual OK `1`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `9.830349`
...
| residual_task_count_005_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.181396047 | -0.181396047 | 0.0 | 224 | 224 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.164824524 | -0.164824524 | 0.0 | 224 | 224 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.143576191 | -0.143576191 | 0.0 | 224 | 224 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.09450581 | -0.09450581 | 0.0 | 224 | 224 | True | False | True | True | False | new_task_set |
| residual_task_count_005_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.023957524 | -0.023957524 | 0.0 | 224 | 224 | True | False | True | True | False | new_task_set |
