...
- root-pool support-continuation seeds/active/protected/leaks: `63` / `53` / `32` / `0`
- root-pool exact harvest candidates/selected/new/replacement: `0` / `0` / `0` / `0`
- root-pool worker selected/new/replacement: `64` / `64` / `0`
- root-pool post-final-judge selected/new/replacement/added: `0` / `0` / `0` / `0`
- root-partition post-final feedback selected/added: `25` / `25`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 121.309952 | 121.309952 | 46.174614 | 74.452205 | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 121.309952 | 46.174614 | 74.452205 | None | 224 | 0 | 64 | 0 | 25 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | post-final partition feedback checkpointed addable negative columns, but fixed row budget is exhausted |
