...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_after_k5_replacement_merge_smoke/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_after_k5_replacement_merge_smoke/b4_1_summary.json`
...
- Partition region MIP-start: enabled `6`；OK `6`；exact OK `1`；residual OK `5`。
- Residual task-count partition: enabled rows `1`；expected `30`；observed `5`；proven `4`；incomplete `1`；negative `0`；missing `25`。
