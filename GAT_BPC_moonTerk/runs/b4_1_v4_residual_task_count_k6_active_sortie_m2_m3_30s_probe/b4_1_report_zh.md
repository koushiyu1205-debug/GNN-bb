...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k6_active_sortie_m2_m3_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k6_active_sortie_m2_m3_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `2951`；max constraints `8526`；max mean variables `2520.0`；max mean constraints `7281.5`。
- Partition slot pruning: max feasible assignments `83`；pruned assignments sum `10`；pruned arc options sum `12`。
