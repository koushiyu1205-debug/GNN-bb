...
- CSV rows: `runs/b4_pricing_formulation_diagnostic/b4_pricing_rows.csv`
- JSON summary: `runs/b4_pricing_formulation_diagnostic/b4_pricing_summary.json`
...
| V2_latest_service_start_slot_bound | 3 | 4 | 0 | -0.011314348 | -0.008003885 | 0 | 288.681643 |
| V3_time_window_arc_pruning | 2 | 1 | 0 | -0.0080034 | -0.008003885 | 0 | 650.02078 |
| V4_combined_endpoint_pair_latest_start_time_window | 11 | 7 | 0 | -0.0545346 | -0.007881834 | 0 | 285.563242 |
| V5_subset_row_master_diagnostic_only | 3 | 0 | 10 | None | None | 0 | None |

## B4D Frontier Readout

- Pricing formulation diagnostic accepted: `True`。
- B4E pricing-formulation accepted: `True`。
- Measurable proof-tail progress rows: `17`。
