...
- root-pool worker selected/new/replacement: `112` / `112` / `0`
- root-pool post-final-judge selected/new/replacement/added: `0` / `0` / `0` / `0`
- root-partition post-final feedback selected/added: `10` / `10`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 301.256684 | 301.256684 | 90.585184 | 24.9159 | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 301.256684 | 90.585184 | 24.9159 | None | 379 | 0 | 112 | 0 | 10 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | post-final partition feedback checkpointed addable negative columns, but fixed row budget is exhausted |
