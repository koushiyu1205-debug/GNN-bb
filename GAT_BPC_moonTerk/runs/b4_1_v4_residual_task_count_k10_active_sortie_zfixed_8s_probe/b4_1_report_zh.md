...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k10_active_sortie_zfixed_8s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k10_active_sortie_zfixed_8s_probe/b4_1_summary.json`
...
- Partition model size: max variables `5896`；max constraints `17207`；max mean variables `3921.0`；max mean constraints `11381.1`。
- Partition slot pruning: max feasible assignments `208`；pruned assignments sum `363`；pruned arc options sum `108`。
