...
- region MIP-start: enabled `34`; OK `20`; exact OK `19`; residual OK `1`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `40.170485`
...
| residual_task_count_007_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_REQUIRED_TASK_COUNT_INFEASIBLE | REQUIRED_TASK_COUNT_PRICING_INFEASIBLE | None |  |  | 407 | 407 | True | True | False | False | False |  |
| residual_task_count_007_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.285331779 | -0.285331779 | 0.0 | 407 | 407 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.275626956 | -0.275626956 | 0.0 | 407 | 407 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.240398319 | -0.240398319 | 0.0 | 407 | 407 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.141511593 | -0.141511593 | 0.0 | 407 | 407 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_006 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.026442808 | -0.026442808 | 0.0 | 407 | 407 | True | False | True | True | False | new_task_set |
| residual_task_count_007_active_sorties_007 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_RESTRICTED_INFEASIBLE | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_INFEASIBLE | None |  |  | 407 | 407 | True | True | False | False | False |  |
