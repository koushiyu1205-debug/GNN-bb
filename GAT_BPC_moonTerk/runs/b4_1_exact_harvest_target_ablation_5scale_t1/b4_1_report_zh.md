...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_exact_harvest_target_ablation_5scale_t1/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_exact_harvest_target_ablation_5scale_t1/b4_1_summary.json`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| A | stageA_B4V2_default_final_judge_harvesting |  | 1 | 1 | 1 | 0 | 0 | None | 0.188166 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| A | stageA_B4V2_default_final_judge_harvesting |  | None | None | None | 0.0 | 3.2e-05 |
