...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k15_active_sortie_pairconflict_gated_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k15_active_sortie_pairconflict_gated_full_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6438`；max constraints `18867`；max mean variables `4565.733333`；max mean constraints `13302.133333`。
- Partition slot pruning: max feasible assignments `252`；pruned assignments sum `1130`；pruned arc options sum `201`。
