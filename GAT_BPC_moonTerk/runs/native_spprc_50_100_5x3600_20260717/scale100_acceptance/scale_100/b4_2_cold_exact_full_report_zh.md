...
- model: `NATIVE_SPPRC_ACCEPTANCE_V1_S100_native_rcspp_host`
- config hash: `7cb26a2d2b4ac17f`
- root engine: `b2b_r3_worker`
- worker pricer: `relaxed_labeling`, max task cap `100`
...
- labeling final judge: `on`, max exact tasks `100`, exact harvest target `128`
- rows: `5`
- no-cheat fail: `0`
...
- root-pool post-final-judge selected/new/replacement/added: `87444` / `87444` / `0` / `87444`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 100 | 5 | 0 | 0 | 5 | 880.900929 | 1093.099068 | 874.056323 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 100 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 752.263734 | 747.091339 | None | None | 14700 | 0 | 0 | 14592 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 100 | instance_002 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 761.816769 | 755.07497 | None | None | 14464 | 0 | 0 | 14356 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 100 | instance_003 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 860.16041 | 852.393704 | None | None | 18796 | 0 | 0 | 18688 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 100 | instance_004 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 1093.099068 | 1085.899696 | None | None | 21228 | 0 | 0 | 21120 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 100 | instance_005 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 937.164663 | 929.821908 | None | None | 18796 | 0 | 0 | 18688 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
