...
- model: `NATIVE_SPPRC_ACCEPTANCE_V1_S50_native_rcspp_host`
- config hash: `6139a58ad97c5570`
...
- labeling final judge: `on`, max exact tasks `50`, exact harvest target `96`
- rows: `5`
- no-cheat fail: `0`
...
- root-pool post-final-judge selected/new/replacement/added: `38002` / `37993` / `9` / `38002`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 5 | 0 | 0 | 5 | 440.744088 | 641.914692 | 438.406586 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 404.561351 | 402.954909 | None | None | 5062 | 0 | 0 | 5007 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 50 | instance_002 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 339.137098 | 336.048418 | None | None | 7785 | 0 | 0 | 7731 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 50 | instance_003 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 413.698829 | 411.826037 | None | None | 5086 | 0 | 0 | 5039 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 50 | instance_004 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 404.408468 | 402.165569 | None | None | 8179 | 0 | 0 | 8124 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
| 50 | instance_005 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 641.914692 | 639.037997 | None | None | 12156 | 0 | 0 | 12101 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
