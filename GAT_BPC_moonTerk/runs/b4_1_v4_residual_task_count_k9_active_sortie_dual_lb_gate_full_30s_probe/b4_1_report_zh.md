...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k9_active_sortie_dual_lb_gate_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k9_active_sortie_dual_lb_gate_full_30s_probe/b4_1_summary.json`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| B | B4.1_partition_candidate_audit | V4_current_dual_task_slot_lb_gate | 1 | 0 | 0 | 0 | 0 | None | None |
...
- Partition candidate top issue: `missing_residual_task_count_region`；issue counts `{"missing_residual_task_count_region":1}`。
...
- Residual task-count partition: enabled rows `1`；expected `30`；observed `1`；proven `1`；incomplete `0`；negative `0`；missing `29`。
