...
- partition_negative_region_count: `8`
- partition_negative_payload_available_count: `8`
- partition_best_negative_rc: `-0.574788499`
- partition negative relation counts: already_active `0`; replacement `0`; new_task_set `8`
...
| --- | --- | ---: | --- | ---: | --- | --- | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- | --- | --- |
| /home/kai/work/GAT_BPC_moonTerk/runs/b4_2_cold_exact_500s_feedback_gate_30_001_v1/proofs/scale_030/instance_001/root_partition_feedback/round_01_partition_harvest/worker_03_k005_006/required_task_set_partition_probe.json | lunar_ice_sp50_030_001_seed929001 | 0 | False | 4 | missing_residual_task_count_region, negative_bound_residual_task_count_region, negative_residual_task_count_region, unproven_residual_task_count_region | V4_current_pair_conflict_capacity_bound | refreshed_active_pool_restricted_rmp | RESTRICTED_RMP_OPTIMAL | 8 | 0 | 8 | 469/469 | 0 | 0 | -0.574788499 | False | False | False |
