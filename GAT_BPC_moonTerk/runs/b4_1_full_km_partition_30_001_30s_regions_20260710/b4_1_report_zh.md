...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_full_km_partition_30_001_30s_regions_20260710/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_full_km_partition_30_001_30s_regions_20260710/b4_1_summary.json`
...
- Partition model size: max variables `6005`；max constraints `18035`；max mean variables `3107.260215`；max mean constraints `9291.43871`。
- Partition slot pruning: max feasible assignments `275`；pruned assignments sum `58862`；pruned arc options sum `4813`。
- Partition dual/active scope mismatch rows: `465`；max active-pool-after-dual delta `33`；negative RC audit fail `0`。
- Partition region MIP-start: enabled `24`；OK `7`；exact OK `0`；residual OK `7`。
