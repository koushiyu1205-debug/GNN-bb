...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k16_active_sortie_pairconflict_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k16_active_sortie_pairconflict_full_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6504`；max constraints `19079`；max mean variables `4686.875`；max mean constraints `13663.1875`。
- Partition slot pruning: max feasible assignments `259`；pruned assignments sum `1351`；pruned arc options sum `220`。
