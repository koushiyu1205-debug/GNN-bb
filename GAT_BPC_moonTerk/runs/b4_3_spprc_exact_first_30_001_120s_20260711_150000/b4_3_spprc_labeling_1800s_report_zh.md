...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 0 | 1 | 120.37258 | 120.37258 | 119.928466 | 0.0 |

## Per-Instance

| scale | instance | scope | pricing | exact | under1800 | total | root | tree | SPPRC exact | ng | terminal | fail reason |
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 30 | instance_001 | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 120.37258 | 119.928466 | None | 0.0 | [6, 10, 14, 30] | True | row time limit reached before root pool certificate |
