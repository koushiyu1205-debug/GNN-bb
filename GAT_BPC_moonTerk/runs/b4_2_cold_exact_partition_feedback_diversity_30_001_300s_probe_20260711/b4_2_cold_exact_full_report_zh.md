...
- root-pool worker selected/new/replacement: `92` / `91` / `1`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 276.66638 | 276.66638 | 86.544524 | 142.80976 | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 276.66638 | 86.544524 | 142.80976 | None | 340 | 0 | 92 | 0 | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | parallel partition gate did not satisfy official B4.2 criteria |
