...
- region MIP-start: enabled `38`; OK `15`; exact OK `10`; residual OK `5`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `10.061395`
...
| residual_task_count_006_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.139171278 | -0.139171278 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.242390968 | -0.242390968 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.227921968 | -0.227921968 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_004 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.199357968 | -0.199357968 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_005 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.144234207 | -0.144234207 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
| residual_task_count_006_active_sorties_006 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.063883468 | -0.063883468 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
