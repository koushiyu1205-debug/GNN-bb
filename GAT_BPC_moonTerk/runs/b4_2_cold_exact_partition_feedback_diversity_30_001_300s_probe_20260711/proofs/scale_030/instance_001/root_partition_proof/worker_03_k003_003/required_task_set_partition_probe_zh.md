...
- region MIP-start: enabled `35`; OK `12`; exact OK `10`; residual OK `2`
- negative RC audit fail count: `0`
- adaptive active-sortie refinement: enabled `False`; attempts `0`; coarse accepted `0`; refined `0`; discarded coarse wall `0.0`; total wall `3.049134`
...
| residual_task_count_003_active_sorties_001 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.085195552 | -0.085195552 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
| residual_task_count_003_active_sorties_002 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.062838552 | -0.062838552 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
| residual_task_count_003_active_sorties_003 | residual_task_count | V4_current_pair_conflict_capacity_bound | COMPACT_HIGHS_PRICING_OPTIMAL | REQUIRED_ACTIVE_SORTIE_COUNT_PRICING_OPTIMAL | -0.034273552 | -0.034273552 | 0.0 | 340 | 340 | True | False | True | True | False | new_task_set |
