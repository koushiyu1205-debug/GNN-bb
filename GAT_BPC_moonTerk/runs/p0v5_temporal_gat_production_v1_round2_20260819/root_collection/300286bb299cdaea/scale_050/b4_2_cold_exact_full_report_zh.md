...
- root-pool post-final-judge selected/new/replacement/added: `4363` / `4363` / `0` / `4363`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 593.583466 | 593.583466 | 591.554787 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_041 | GAT_COLLECTION_ROOT_TRAJECTORY_PERSISTED | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 593.583466 | 591.554787 | None | None | 4418 | 0 | 0 | 4363 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | diagnostic route-opportunity collection stopped after the configured natural root trajectory; tree closure was intentionally skipped and no  |
