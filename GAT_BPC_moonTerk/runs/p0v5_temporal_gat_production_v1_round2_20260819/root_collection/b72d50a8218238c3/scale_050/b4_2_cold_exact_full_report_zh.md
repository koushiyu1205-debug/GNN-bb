...
- root-pool post-final-judge selected/new/replacement/added: `4991` / `4991` / `0` / `4991`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 297.022958 | 297.022958 | 294.788858 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_001 | GAT_COLLECTION_ROOT_TRAJECTORY_PERSISTED | DIAGNOSTIC_PRICING_FRONTIER | CERTIFIED_NO_NEGATIVE | False | False | 297.022958 | 294.788858 | None | None | 5046 | 0 | 0 | 4991 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | diagnostic route-opportunity collection stopped after the configured natural root trajectory; tree closure was intentionally skipped and no  |
