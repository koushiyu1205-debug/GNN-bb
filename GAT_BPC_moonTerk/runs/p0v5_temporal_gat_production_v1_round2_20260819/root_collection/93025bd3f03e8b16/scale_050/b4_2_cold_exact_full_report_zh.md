...
- root-pool post-final-judge selected/new/replacement/added: `7508` / `7508` / `0` / `7508`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 593.900663 | 593.900663 | 591.341386 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_054 | GAT_COLLECTION_ROOT_TRAJECTORY_PERSISTED | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 593.900663 | 591.341386 | None | None | 7563 | 0 | 0 | 7508 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | diagnostic route-opportunity collection stopped after the configured natural root trajectory; tree closure was intentionally skipped and no  |
