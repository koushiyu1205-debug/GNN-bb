...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k20_active_sortie_pairconflict_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k20_active_sortie_pairconflict_full_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6656`；max constraints `19549`；max mean variables `4926.45`；max mean constraints `14393.8`。
- Partition slot pruning: max feasible assignments `275`；pruned assignments sum `2485`；pruned arc options sum `286`。
