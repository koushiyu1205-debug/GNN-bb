...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k12_active_sortie_m7_sequence_bound_1s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k12_active_sortie_m7_sequence_bound_1s_probe/b4_1_summary.json`
...
- Partition model size: max variables `4996`；max constraints `14498`；max mean variables `4996.0`；max mean constraints `14498.0`。
- Partition slot pruning: max feasible assignments `162`；pruned assignments sum `48`；pruned arc options sum `12`。
