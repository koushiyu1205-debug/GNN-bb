...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k13_active_sortie_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k13_active_sortie_full_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6306`；max constraints `18443`；max mean variables `4282.769231`；max mean constraints `12462.307692`。
- Partition slot pruning: max feasible assignments `238`；pruned assignments sum `757`；pruned arc options sum `163`。
