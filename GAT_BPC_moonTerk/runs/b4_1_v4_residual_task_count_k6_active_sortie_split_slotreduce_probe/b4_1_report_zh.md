...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k6_active_sortie_split_slotreduce_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k6_active_sortie_split_slotreduce_probe/b4_1_summary.json`
...
- Partition model size: max variables `4576`；max constraints `13262`；max mean variables `3084.0`；max mean constraints `8923.333333`。
- Partition slot pruning: max feasible assignments `144`；pruned assignments sum `85`；pruned arc options sum `46`。
