...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/native_live_sri_v1_warm_p0_20_009/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/native_live_sri_v1_warm_p0_20_009/b4_1_summary.json`
...
| diagnostic_claimed_certificate_count | 1 | 0 |
...
| --- | --- | --- | --- |
| R1_redlines_zero | fail | {"redline_count":9,"redline_failures":{"diagnostic_claimed_certificate_count":1}} | Fix failing redlines before interpreting any B4.1 diagnostic as evidence. |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 1 | 0 | 1 | 1 | 0 | -1e-06 | 3.915122 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 702.0 | 702.0 | None | None | 1.122014 |
