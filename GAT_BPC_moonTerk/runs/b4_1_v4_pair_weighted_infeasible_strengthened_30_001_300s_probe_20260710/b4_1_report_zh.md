...
- CSV rows: `runs/b4_1_v4_pair_weighted_infeasible_strengthened_30_001_300s_probe_20260710/b4_1_rows.csv`
- JSON summary: `runs/b4_1_v4_pair_weighted_infeasible_strengthened_30_001_300s_probe_20260710/b4_1_summary.json`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 1 | 1 | 1 | 0 | 0 | -7.21e-07 | 193.760231 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 371.0 | 371.0 | -1e-06 | -1e-06 | 192.729891 |
