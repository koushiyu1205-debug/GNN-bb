...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 1 | 338.522093 | 338.522093 | 337.081393 | None |

## Per-Instance

| scale | instance | status | scope | pricing | exact | under500 | total | root | tree | active cols | provenance | fail reason |
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---|---|
| 30 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 338.522093 | 337.081393 | None | 194 | instance_json_fixed_seed_and_same_run_checkpoints | root pool did not certify no-negative within cold-start row limit |
