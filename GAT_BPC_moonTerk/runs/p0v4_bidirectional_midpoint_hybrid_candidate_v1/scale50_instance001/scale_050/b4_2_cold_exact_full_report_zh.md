...
- model: `P0V4_BIDIRECTIONAL_MIDPOINT_HYBRID_CANDIDATE_V1_S50`
- config hash: `afae68fd3e4dc897`
...
- rows: `1`
- no-cheat fail: `0`
- worker certificate leaks: `1`
- tail-dual certificate leaks: `1`
...
- root-pool post-final-judge selected/new/replacement/added: `15321` / `15292` / `29` / `15294`
- root-partition post-final feedback selected/added: `0` / `0`
- all redlines zero: `False`
- accepted: `False`

| scale | rows | exact | under300 exact | fail-closed | mean total | max total | mean root | mean partition | mean tree |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 50 | 1 | 0 | 0 | 1 | 1181.955075 | 1181.955075 | 815.650441 | None | 361.832495 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 50 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 1181.955075 | 815.650441 | None | 361.832495 | 15347 | 0 | 0 | 15294 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | safety redline blocked official B4.2 exact certificate |
