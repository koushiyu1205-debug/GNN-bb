...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_pricing_formulation_diagnostic_resume_smoke/b4_pricing_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_pricing_formulation_diagnostic_resume_smoke/b4_pricing_summary.json`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| V0_current_compact_pricing | 1 | 0 | 0 | None | None | 0 | 2.990523 |
...
- Tested variants: `V0_current_compact_pricing`。
- Missing variants: `V1_endpoint_order_plus_pair_adjacency, V2_latest_service_start_slot_bound, V3_time_window_arc_pruning, V4_combined_endpoint_pair_latest_start_time_window, V5_subset_row_master_diagnostic_only`。

## Plan Questions

- Previous accepted baseline: B3B is accepted for 5/10/20; 30-scale remains diagnostic frontier.
- Formulation modes tested: `V0_current_compact_pricing`。
