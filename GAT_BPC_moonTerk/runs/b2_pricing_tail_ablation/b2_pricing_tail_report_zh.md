...
- 20-scale selected direct20 probe modes: B0_pure_direct_dp, B1A_full_universe_root_audit, B1B_seeded_root_CG, B2A_full_universe_rc_audit_fast_path, B2B_R2_worker_before_final_judge, B2B_R3_true_dual_negative_search_worker, B2B_seeded_tail_CG, B2C_limited_pricing_diagnostic, B2D_proof_tail_kernel_profile, B2_PRODUCT_EXACT_SOLVER。
...
| 5 | 5-scale full | B2B_R3_true_dual_negative_search_worker | 20 | 20 | 0 | 0 | 0.309018 | 0.409539 | 19.95 | 5.55 | 1.9 | 810 | 810 | 0 | 0 |
| 5 | 5-scale full | B2B_seeded_tail_CG | 20 | 20 | 0 | 0 | 0.28297 | 0.386306 | 20.05 | 3.25 | 3.25 | 1039 | 1039 | 0 | 0 |
| 5 | 5-scale full | B2C_limited_pricing_diagnostic | 20 | 0 | 0 | 0 | 0.114001 | 0.172244 | 0 | 0 | 0 | 20 | 0 | 0 | 0 |
| 5 | 5-scale full | B2D_proof_tail_kernel_profile | 20 | 0 | 0 | 0 | 0.11312 | 0.170204 | 0 | 0 | 0 | 20 | 0 | 0 | 0 |
...
| 10 | 10-scale selected5 | B2B_R3_true_dual_negative_search_worker | 5 | 5 | 0 | 0 | 0.656743 | 0.750468 | 96.4 | 6 | 3.2 | 685 | 685 | 0 | 361 |
| 10 | 10-scale selected5 | B2B_seeded_tail_CG | 5 | 0 | 5 | 5 | 10.0 | 10.0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| 10 | 10-scale selected5 | B2C_limited_pricing_diagnostic | 5 | 0 | 0 | 0 | 0.82371 | 0.949225 | 0 | 0 | 0 | 16 | 0 | 0 | 0 |
| 10 | 10-scale selected5 | B2D_proof_tail_kernel_profile | 5 | 0 | 0 | 0 | 0.821075 | 0.948553 | 0 | 0 | 0 | 16 | 0 | 0 | 0 |
...
| 20 | 20-scale fail-closed guard | B2B_R3_true_dual_negative_search_worker | 20 | 0 | 20 | 0 | 0.000701 | 0.000778 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| 20 | 20-scale selected direct20 probe | B2B_R3_true_dual_negative_search_worker | 5 | 0 | 5 | 0 | 34.483982 | 36.941234 | 185 | 8 | 2.2 | 47053 | 47053 | 0 | 17552 |
| 20 | 20-scale selected direct20 probe | B2B_seeded_tail_CG | 5 | 0 | 5 | 5 | 20.0 | 20.0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| 20 | 20-scale selected direct20 probe | B2C_limited_pricing_diagnostic | 5 | 0 | 0 | 0 | 1.083645 | 1.196511 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| 20 | 20-scale selected direct20 probe | B2D_proof_tail_kernel_profile | 5 | 0 | 0 | 0 | 1.080282 | 1.208901 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| 30 | 30-scale fail-closed diagnostic | B2B_R3_true_dual_negative_search_worker | 20 | 0 | 20 | 0 | 0.001714 | 0.001967 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
- B1/B2 direct20 timeout rows: 25/30。
- 若 B0 direct20 闭合而 B1/B2 root rows timeout，本组应解释为 BPC root proof-tail 成本问题，不是 B0 direct-DP 失败。
- B2B_R2/R3 direct20 improvement rows: 0/5。

## Addability Breakdown

- candidate_negative_count: 50525。
- addable_negative_count: 50453。
- selected_would_enter_master_count: 3431。
...
- duplicate_only_audit_status_counts: {'': 640}。

## Hidden-Negative Audit

- hidden_negative_count: 17913。
...
- labels_generated: 732873。
- labels_generated_total: 732873。
- labels_extended: 12144551。
- worker_found_addable_negative_count: 236。
- final_judge_saved_by_worker_count: 189。
...
- 3. B2B_R3 accepted: True；B2B_R2 accepted: False。
- 4. 10/20 timeout bottleneck: final judge / label generation：closure 阶段耗时或 labels_generated 主导。
- 5. 允许进入 B3: True；只有 B2B_R3 在 required coverage 上通过且 redlines 全 0 才能进入。
...
- B2B_R3 seeded tail accepted as next baseline: True。
- improvement_count: 241。
- B2B_R2 real-scale improvement count: 0。
- B2B_R2 10-scale improvement count: 0。
- B2B_R3 real-scale improvement count: 10。
- B2B_R3 10-scale improvement count: 5。
...
- This artifact contains only B2B_R3_true_dual_negative_search_worker rows and is intended to merge into an existing B2 matrix.
- B2B_R3_true_dual_negative_search_worker 10-scale ran selected 5/20.
- B2B_R3_true_dual_negative_search_worker 20-scale fail-closed guard uses max_direct_tasks below 20; fail-closed is expected.
- B2B_R3_true_dual_negative_search_worker 20-scale selected direct20 probe used 5 instance(s) from offset 0, with per-row timeout 120.0s.
