...
- latest_probe: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_true_dual_proof_tail_stage_b_30_v4_optimization_harvest_taskset_after_315_600s/stage_001/probe.json`
- stage_count: `1`
...
| stage | profile | mode | opt harvest | opt scope | opt found | batch | round cap | resume cols | active cols | added | rounds | state | scope | best neg RC | final phase | final RC | final bound | elapsed s |
|---:|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---|---|---:|---|---:|---:|---:|
| 1 | V4 | proof_only | 3 | task_set | 3 | 1 | 1 | 315 | 318 | 3 | 1 | INCOMPLETE_LIMIT | DIAGNOSTIC_PRICING_FRONTIER | -0.004252723 | optimization_harvest | -0.004252723 | -0.004252789 | 503.721428 |
