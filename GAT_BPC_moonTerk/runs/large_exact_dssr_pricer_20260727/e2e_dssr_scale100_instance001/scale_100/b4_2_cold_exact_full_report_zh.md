...
- model: `NATIVE_SPPRC_ACCEPTANCE_V1_S100_native_rcspp_dssr_host`
- config hash: `f6bae72b6a7c89ef`
...
- root-pool post-final-judge selected/new/replacement/added: `18689` / `18689` / `0` / `18689`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 100 | 1 | 0 | 0 | 1 | 3598.782888 | 3598.782888 | 3590.950687 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 100 | instance_001 | BPC_INCOMPLETE_PRICING | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 3598.782888 | 3590.950687 | None | None | 18797 | 0 | 0 | 18689 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | root pool did not certify no-negative within cold-start row limit |
