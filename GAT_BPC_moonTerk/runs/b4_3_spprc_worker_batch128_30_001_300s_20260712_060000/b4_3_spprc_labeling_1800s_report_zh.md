...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 1 | 0 | 0 | 0 | 1 | 305.14497 | 305.14497 | 0.0 | 0.0 |

## Per-Instance

| scale | instance | scope | pricing | exact | under1800 | total | root | tree | SPPRC exact | ng | terminal | fail reason |
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 30 | instance_001 | DIAGNOSTIC_PRICING_FRONTIER |  | False | False | 305.14497 | 0.0 | None | 0.0 | [6, 10, 14, 30] | True | STAGE_SUBPROCESS_TIMEOUT: command exceeded 304.858s fail-closed |
