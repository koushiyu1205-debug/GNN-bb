...
- root-pool support-continuation seeds/active/protected/leaks: `15` / `15` / `0` / `0`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 5 | 1 | 1 | 1 | 0 | 0.879499 | 0.879499 | 0.512353 | None | 0.247164 |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 5 | instance_001 | BPC_OPTIMAL | BPC_TREE_OPTIMAL | CERTIFIED_NO_NEGATIVE | True | True | 0.879499 | 0.512353 | None | 0.247164 | 27 | 0 | 21 | 0 | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback |  |
