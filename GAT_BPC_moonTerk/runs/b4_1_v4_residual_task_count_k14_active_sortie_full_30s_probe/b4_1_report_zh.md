...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k14_active_sortie_full_30s_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_residual_task_count_k14_active_sortie_full_30s_probe/b4_1_summary.json`
...
- Partition model size: max variables `6372`；max constraints `18655`；max mean variables `4432.0`；max mean constraints `12904.642857`。
- Partition slot pruning: max feasible assignments `245`；pruned assignments sum `932`；pruned arc options sum `182`。
