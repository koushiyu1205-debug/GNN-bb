...
- root-pool post-final-judge selected/new/replacement/added: `1401` / `1401` / `0` / `1401`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 30 | 3 | 0 | 0 | 3 | 240.40169 | 325.177788 | 31.497234 | None | None |
...
|---:|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| 30 | instance_001 | GAT_COLLECTION_ROOT_POOL_COMPLETE | DIAGNOSTIC_PRICING_FRONTIER | CERTIFIED_NO_NEGATIVE | False | False | 94.83622 | 94.491703 | None | None | 1435 | 0 | 0 | 1401 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | diagnostic route-opportunity collection stopped after the natural root-pool trajectory; tree closure was intentionally skipped and no certif |
| 30 | instance_002 | GAT_COLLECTION_ROOT_POOL_INCOMPLETE | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 325.177788 | 0.0 | None | None | None | 0 | 0 | 0 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | diagnostic route-opportunity collection stopped after the natural root-pool trajectory; tree closure was intentionally skipped and no certif |
| 30 | instance_003 | GAT_COLLECTION_ROOT_POOL_INCOMPLETE | DIAGNOSTIC_PRICING_FRONTIER | INCOMPLETE_LIMIT | False | False | 301.191061 | 0.0 | None | None | None | 0 | 0 | 0 | 0 | True | instance_json_fixed_seed_same_run_checkpoint_and_partition_feedback | diagnostic route-opportunity collection stopped after the natural root-pool trajectory; tree closure was intentionally skipped and no certif |
