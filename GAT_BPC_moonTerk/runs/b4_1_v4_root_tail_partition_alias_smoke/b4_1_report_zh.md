...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_root_tail_partition_alias_smoke/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_v4_root_tail_partition_alias_smoke/b4_1_summary.json`
...
- Partition candidate top issue: `unproven_residual_region`；issue counts `{"incomplete_residual_region":1,"negative_bound_exact_task_set_region":1,"negative_exact_task_set_region":1,"unproven_exact_task_set_region":1,"unproven_residual_region":1}`。
- Partition negative regions: `1`；payload available `1`；best negative RC `-0.000910522`。
- Partition negative relation: already active `1`；replacement `0`；new task-set `0`。
- Partition dual/active scope mismatch rows: `2`；max active-pool-after-dual delta `32`；negative RC audit fail `0`。
