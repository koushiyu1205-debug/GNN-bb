...
- CSV rows: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_route_template_seed_portfolio_harvest_only_stop_probe/b4_1_rows.csv`
- JSON summary: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_route_template_seed_portfolio_harvest_only_stop_probe/b4_1_summary.json`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 1 | 0 | 0 | 0 | 0 | None | 49.351942 |

## Stage B/C Telemetry

| stage | mode | variant | active cols | active after merge | best neg RC | last best RC | final judge wall |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| D | B4.1_30_tree_closure_from_probe | V4_root_tail_probe_tree_gate | 297.0 | 297.0 | -2e-09 | -2e-09 | 8.022897 |
