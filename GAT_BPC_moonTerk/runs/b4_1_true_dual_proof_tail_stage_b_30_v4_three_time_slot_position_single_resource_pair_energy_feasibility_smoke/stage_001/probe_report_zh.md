...
- single-task energy LB enabled: `True`
- single-task energy LB rows: `630`
- single-task shadow LB enabled: `True`
- single-task shadow LB rows: `630`
...
- final_judge_wall_time: `54.896969`
- resume source: `/home/kai/work/GAT_BPC_moonTerk/runs/b4_1_true_dual_proof_tail_stage_b_30_v4_three_time_pair_energy_slot_position_feasibility_smoke/stage_002/probe.json`
- resume initial columns: `305`
- active columns saved: `305`
...
|---:|---|---:|---:|---:|---|
| 1 | INCOMPLETE_LIMIT | 0 | None | -0.195820223 | negative_feasibility_proof |
