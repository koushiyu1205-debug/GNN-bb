...
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v658_all_counterfactual_delta_rows_20260628/gat_branch_action_v658_seed13.pt
sample_count = 206
train_sample_count = 179
...
train_branch_priority_metrics = {'weighted_row_count': 167.0, 'positive_count': 50.0, 'negative_count': 117.0, 'tp': 39.0, 'fp': 49.0, 'fn': 11.0, 'tn': 68.0, 'precision': 0.4431818181818182, 'recall': 0.78, 'f1': 0.5652173913043479, 'mean_score': 0.5325344242824765}
validation_branch_priority_metrics = {'weighted_row_count': 27.0, 'positive_count': 4.0, 'negative_count': 23.0, 'tp': 2.0, 'fp': 12.0, 'fn': 2.0, 'tn': 11.0, 'precision': 0.14285714285714285, 'recall': 0.5, 'f1': 0.22222222222222224, 'mean_score': 0.5722459179383738}
