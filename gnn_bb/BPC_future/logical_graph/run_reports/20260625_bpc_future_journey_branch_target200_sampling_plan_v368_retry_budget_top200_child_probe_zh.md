...
all_action_counts = {'BUILD_CHILD_PROBE_RUNBOOK': 19, 'COLLECT_FAMILY_GAP_TOP200_DIAG_LOG': 8, 'COLLECT_TOP200_DIAG_LOG': 1, 'DEFER_HARD_TIMEOUT_CONTEXT': 6, 'ROUTE_TO_ROOT_PRICING_TAIL': 2, 'SKIP_ALREADY_WITHIN_TARGET': 20, 'SKIP_KNOWN_TARGET200_INSTANCE': 4}
selected_action_counts = {'BUILD_CHILD_PROBE_RUNBOOK': 3, 'COLLECT_FAMILY_GAP_TOP200_DIAG_LOG': 8, 'COLLECT_TOP200_DIAG_LOG': 1}
selected_family_counts = {'greedy-anchor': 1, 'random-wave': 8, 'sector-wave': 3}
commands_path = BPC_future/results/journey_branch_target200_sampling_plan_v368_retry_budget_top200_child_probe_20260625/commands.sh
