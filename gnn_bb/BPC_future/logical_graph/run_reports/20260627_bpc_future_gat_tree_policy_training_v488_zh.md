...
```text
dataset_dir = BPC_future/data/gat_branch_action_sanity/v488_tree_policy_event_dataset_20260627
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v488_tree_policy_event_dataset_20260627/gat_tree_policy_v488.pt
sample_count = 57
train_sample_count = 52
validation_sample_count = 5
branch_priority_label_counts = {'not_walltime_gain': 0, 'walltime_gain_positive': 0}
row_kind_counts = {'tree_policy_hard_negative': 31, 'tree_policy_positive': 26}
epochs = 3
