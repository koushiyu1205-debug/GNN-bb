...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v795_pressure_coverage_with_depth1_reachability_fail_closed
target_wall = 200.0
wall_cap = 600.0
...
raw_row_count = 8
sample_count = 2
row_kind_counts = {'paired_probe_hard_negative_proxy': 1, 'paired_probe_neutral_proxy': 6, 'paired_probe_positive_proxy': 1}
