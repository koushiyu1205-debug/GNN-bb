...
- instance=tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_01_seed61001_logical_graph.json, baseline_selected=[2, 6], optin_selected=[2, 6], score=5.393553672, source=node:0:depth:0:2,6, wall_delta=-1.062621, exact_delta=0.0, node_delta=0.0
