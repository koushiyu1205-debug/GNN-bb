...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v796_pressure_coverage_with_root_highpressure_neutral
target_wall = 200.0
wall_cap = 600.0
...
raw_row_count = 9
sample_count = 2
row_kind_counts = {'paired_probe_hard_negative_proxy': 1, 'paired_probe_neutral_proxy': 7, 'paired_probe_positive_proxy': 1}
branch_priority_label_counts = {'aux_only_weak_positive': 1, 'not_walltime_gain': 1}
target_wall_crossing_label_counts = {'not_target_wall_crossing': 2}
tail_improved_aux_label_counts = {'tail_improved': 1, 'tail_not_improved': 1}
skipped_counts = {'not_training_sample:paired_probe_neutral_proxy': 7}
instance_count = 2
family_count = 1
phase2_pressure_observed_counts = {'phase2_same_child_negative_severity': 2, 'phase2_separate_child_negative_severity': 2, 'phase2_negative_severity_sum': 2, 'phase2_negative_severity_gap': 2, 'phase2_negative_severity_balance_ratio': 2, 'phase2_negative_child_presence_balance_gap': 2}
phase2_pressure_nonzero_counts = {'phase2_same_child_negative_severity': 2, 'phase2_separate_child_negative_severity': 0, 'phase2_negative_severity_sum': 2, 'phase2_negative_severity_gap': 2, 'phase2_negative_severity_balance_ratio': 0, 'phase2_negative_child_presence_balance_gap': 2}
