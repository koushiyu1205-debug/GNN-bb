...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v657_routeopt_bkf_full_replay_labels_20260628
target_wall = 200.0
wall_cap = 600.0
...
raw_row_count = 5
sample_count = 5
row_kind_counts = {'changed_timeout_no_effect_hard_negative': 3, 'hard_negative_regression': 1, 'walltime_gain_target_wall_crossing': 1}
branch_priority_label_counts = {'not_walltime_gain': 4, 'walltime_gain_positive': 1}
target_wall_crossing_label_counts = {'not_target_wall_crossing': 4, 'target_wall_crossing_positive': 1}
tail_improved_aux_label_counts = {'tail_improved': 1, 'tail_not_improved': 4}
skipped_counts = {}
instance_count = 5
family_count = 3
