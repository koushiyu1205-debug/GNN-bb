...
training_exclusion_reason_counts = {'roi_without_target_causal_match': 1}
positive_trajectory_roi_guard_reason_counts = {'worse_than_baseline_same_iter_objective': 3}
post_injection_guard_present_count = 3
post_injection_positive_downgraded_count = 3
label_counts = {'0': 2}
unique_label_counts = {'0': 2}
roi_class_counts = {'positive_exact_roi': 2, 'positive_pricing_roi': 1}
...
negative_region_counts = {'apollo15_20km': 2}
