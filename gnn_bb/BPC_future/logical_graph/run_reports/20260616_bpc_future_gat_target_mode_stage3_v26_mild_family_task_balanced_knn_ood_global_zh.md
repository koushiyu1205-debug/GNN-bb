...
```json
{
  "decision_reason_counts": {
    "below_batch_threshold_delay_queue": 102,
  ...
  "decision_scope_metrics": {
    ...
    "accepted_batch_rate": 0.1092436974789916,
  ...
  "threshold_group_info": {
    "global": {
      ...
      "safe_radius": 5.9780799359224925,
      "scope": "global",
      "train_count": 256
    },
    "groups": {},
  ...
  "validation_family_metrics": {
    ...
    "per_family": {
      ...
      "sector-wave": {
        ...
        "accepted_batch_roi": 6.379482107857863,
        "accepted_batch_roi_ci_low": -1.208169198242767,
        ...
        "decision_reason_counts": {
          "below_batch_threshold_delay_queue": 45,
          "candidate_false_high_priority_delay_queue": 1,
          "high_priority": 12,
          "knn_delay_fraction_delay_queue": 3
        },
