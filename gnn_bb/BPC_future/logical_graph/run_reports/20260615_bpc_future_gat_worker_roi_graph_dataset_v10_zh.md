...
sample_count = 46
candidate_count = 46
candidate_label_counts = {'abstain': 28, 'add': 18}
roi_class_counts = {'negative_primal_roi': 12, 'no_observed_roi': 16, 'positive_primal_roi': 18}
delay_queue_label_count = 28
instance_count = 24
family_count = 3
region_count = 2
skipped_counts = {'not_training_eligible:unsupported_roi_class:columns_only_roi': 3}
