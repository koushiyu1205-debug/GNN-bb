...
```text
dataset_dir = BPC_future/data/gat_branch_action_sanity/v492_tree_policy_event_dataset_20260627
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v492_tree_policy_event_dataset_20260627/gat_tree_policy_v492.pt
sample_count = 69
train_sample_count = 62
validation_sample_count = 7
branch_priority_label_counts = {'not_walltime_gain': 0, 'walltime_gain_positive': 0}
row_kind_counts = {'tree_policy_hard_negative': 40, 'tree_policy_positive': 29}
epochs = 4
loss_multipliers = {'branch_priority': 0.0, 'branch_positive': 1.0, 'tail_aux': 0.0, 'walltime_gain': 0.0, 'child_proof_cpu': 0.0, 'time_to_certificate': 0.0, 'tree_policy': 1.0}
