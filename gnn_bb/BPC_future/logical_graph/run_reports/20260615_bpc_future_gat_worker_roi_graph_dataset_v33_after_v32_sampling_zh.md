...
sample_count = 179
candidate_count = 179
candidate_label_counts = {'abstain': 121, 'add': 58}
roi_class_counts = {'negative_primal_roi': 37, 'negative_retry_roi': 49, 'no_observed_roi': 35, 'positive_primal_roi': 45, 'positive_retry_roi': 13}
delay_queue_label_count = 121
instance_count = 53
family_count = 3
region_count = 2
skipped_counts = {'not_training_eligible:no_worker_target_intervention_observed': 10, 'not_training_eligible:positive_roi_without_target_causal_match': 1, 'not_training_eligible:unsupported_roi_class:columns_only_roi': 11, 'not_training_eligible:worker_context_mismatch': 4}
