...
best_loss_epoch = 7
best_validation_loss = 2.890295338327602
...
```json
{
  ...
  "threshold_search": {
    ...
    "selected_metrics": {
      ...
      "high_priority_prediction_count": 1029,
  ...
  "train_deployment_metrics": {
    ...
    "false_high_priority_on_delay": 0.39183673469387753,
    "false_high_priority_on_delay_count": 96,
    "false_safe_rate_label_unsafe": 0.0,
    "false_safe_rate_union": 0.39183673469387753,
    "family_delay_fallback_families": [],
    ...
    "family_specific_delay_fallback_families": [],
    "high_priority_precision": 0.9699153870260107,
    "high_priority_precision_ci_low": 0.9634000604724348,
    "high_priority_prediction_count": 3191,
    "high_priority_true_positive_count": 3095,
    "safe_precision": 1.0,
