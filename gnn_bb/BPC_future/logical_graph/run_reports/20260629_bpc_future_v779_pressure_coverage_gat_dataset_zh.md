...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v779_pressure_coverage_seed61635_seed61311
target_wall = 200.0
wall_cap = 600.0
...
raw_row_count = 4
sample_count = 1
row_kind_counts = {'paired_probe_neutral_proxy': 3, 'paired_probe_positive_proxy': 1}
...
skipped_counts = {'not_training_sample:paired_probe_neutral_proxy': 3}
instance_count = 1
family_count = 1
