...
label_distribution_ready_details = {'positive_instances_ready': True, 'negative_instances_ready': True, 'positive_families_ready': False, 'negative_families_ready': False, 'positive_regions_ready': True, 'negative_regions_ready': False, 'positive_instance_fraction_ready': True, 'negative_instance_fraction_ready': True}
sample_collection_gaps = [{'name': 'positive_training_label_count', 'observed': 3, 'required': 5, 'missing': 2}, {'name': 'positive_family_count', 'observed': 1, 'required': 2, 'missing': 1}, {'name': 'negative_family_count', 'observed': 1, 'required': 2, 'missing': 1}, {'name': 'negative_region_count', 'observed': 1, 'required': 2, 'missing': 1}]
...
[
  {
    "best_true_reduced_cost": -0.3783075,
    "columns_delta": 0.0,
    "decision_probability": 0.7615143656730652,
  ...
  {
    "best_true_reduced_cost": -0.453632,
    "columns_delta": -12.0,
    "decision_probability": 0.7552135586738586,
    "label_worker_roi_positive": 0,
  ...
  {
    "best_true_reduced_cost": -0.442105,
    "columns_delta": -5.0,
    "decision_probability": 0.7594432830810547,
    "label_worker_roi_positive": 0,
  ...
  {
    "best_true_reduced_cost": -2.3129872,
    "columns_delta": 0.0,
    "decision_probability": 0.9783666729927063,
    "label_worker_roi_positive": 0,
  ...
  {
    "best_true_reduced_cost": -2.589705,
    "columns_delta": -6.0,
    "decision_probability": 0.9706774950027466,
    "label_worker_roi_positive": 0,
  ...
  },
  {
    ...
    "columns_delta": 1.0,
    "decision_probability": 0.9405129551887512,
  ...
  {
    "best_true_reduced_cost": -10.798366,
    "columns_delta": -43.0,
    "decision_probability": 0.7383743524551392,
    "label_worker_roi_positive": 1,
