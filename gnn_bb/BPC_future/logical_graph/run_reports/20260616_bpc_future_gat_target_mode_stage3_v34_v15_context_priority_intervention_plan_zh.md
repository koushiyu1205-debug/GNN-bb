...
```json
{
  ...
  "context_priority_jsonl_paths": [
    "BPC_future/results/gat_batch_impact_context_contrast_priority_v15_structural_gap_20260616/context_contrast_priority.jsonl"
  ],
