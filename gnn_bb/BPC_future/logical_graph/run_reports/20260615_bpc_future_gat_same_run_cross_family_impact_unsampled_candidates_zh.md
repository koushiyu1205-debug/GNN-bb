...
```json
{
  ...
  "exclude_existing_roi_jsonl": "BPC_future/results/gat_same_run_combined_plus_seed_cross_family_v2_worker_roi_dataset_20260615/gat_worker_roi_rows.jsonl",
  "existing_roi_target_count": 24,
  "include_delay_queue": false,
  "skipped_counts": {
    "decision_not_high_priority": 46,
    "existing_roi_target": 2
  }
}
```
