...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v437_randomtw60_branch_replay_20260626
target_wall = 200.0
wall_cap = 600.0
...
target_wall_crossing_label_counts = {'not_target_wall_crossing': 90, 'target_wall_crossing_positive': 32}
tail_improved_aux_label_counts = {'tail_improved': 44, 'tail_not_improved': 78}
skipped_counts = {'not_training_sample:budget_dominant_improvement': 2, 'not_training_sample:local_only_hard_negative': 18, 'not_training_sample:regression': 2, 'not_training_sample:unknown_right_censored': 5, 'not_training_sample:unsupported': 52}
instance_count = 20
family_count = 3
