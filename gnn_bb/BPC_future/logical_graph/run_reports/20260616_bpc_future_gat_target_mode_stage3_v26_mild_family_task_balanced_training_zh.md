...
loss_options = {'false_high_priority_loss_multiplier': 16.0, 'bad_mode_loss_multiplier': 2.0, 'regression_loss_multiplier': 0.15, 'hard_roi_loss_multiplier': 1.0, 'hard_roi_candidate_loss_multiplier': 2.0, 'hard_roi_positive_candidate_loss_multiplier': 1.0, 'hard_roi_positive_group_balance': 'family_task', 'hard_roi_positive_group_weight_power': 0.5, 'max_hard_roi_positive_group_weight': 2.5, 'hard_roi_positive_group_counts': {'greedy-anchor|10': 1, 'random-wave|20': 14, 'random-wave|30': 6, 'random-wave|50': 3, 'sector-wave|20': 9}, 'hard_roi_positive_group_weights': {'greedy-anchor|10': 2.5, 'random-wave|20': 1.0, 'random-wave|30': 1.0488088481701514, 'random-wave|50': 1.4832396974191324, 'sector-wave|20': 1.0}, 'hard_roi_threshold': 0.65, 'pairwise_ranking_loss_multiplier': 1.0, 'pairwise_candidate_ranking_loss_multiplier': 0.75, 'pairwise_roi_margin': 0.05, 'min_pairwise_roi_delta': 1e-06, 'max_grad_norm': 5.0}
...
best_epoch = 5
selected_validation_loss = 6.205846570955574
best_loss_epoch = 3
best_validation_loss = 5.679403243363211
...
```json
{
  "family_holdout_metrics": {
    ...
    "family_holdout_per_family": {
      ...
      "sector-wave": {
        ...
        "accepted_batch_roi": 10.982702634731929,
  ...
  "threshold_search": {
    ...
    "selected_metrics": {
      ...
      "accepted_batch_roi_over_baseline": 10.365407323464751,
      "accepted_batch_roi_over_baseline_ci_low": 3.04184528049667,
      "accepted_batch_roi_over_best_rc_baseline": 10.365407323464751,
      "accepted_batch_roi_over_best_rc_baseline_ci_low": 3.04184528049667,
      "accepted_batch_roi_over_old_gat_baseline": 10.365407323464751,
      "accepted_batch_roi_over_old_gat_baseline_ci_low": 3.04184528049667,
      "accepted_batch_roi_over_random_baseline": 10.365407323464751,
      "accepted_batch_roi_over_random_baseline_ci_low": 3.04184528049667,
      ...
      "batch_threshold": 0.5503599047660828,
      ...
      "expected_trajectory_utility": 10.396657323464751,
      ...
      "high_priority_prediction_count": 762,
      "high_priority_true_positive_count": 761,
  ...
  "train_deployment_metrics": {
    ...
    "accepted_batch_precision": 1.0,
    "accepted_batch_rate": 0.09375,
    "accepted_batch_roi": 3.0386516582220793,
    "accepted_batch_roi_ci_low": 0.19595110423336637,
    "accepted_batch_roi_over_baseline": 3.0386516582220793,
    "accepted_batch_roi_over_baseline_ci_low": 0.19595110423336637,
    "accepted_batch_roi_over_best_rc_baseline": 3.0386516582220793,
    "accepted_batch_roi_over_best_rc_baseline_ci_low": 0.19595110423336637,
    "accepted_batch_roi_over_old_gat_baseline": 3.0386516582220793,
    "accepted_batch_roi_over_old_gat_baseline_ci_low": 0.19595110423336637,
    "accepted_batch_roi_over_random_baseline": 3.0386516582220793,
    "accepted_batch_roi_over_random_baseline_ci_low": 0.19595110423336637,
    "baseline_roi_ci_high": 0.0,
    "baseline_roi_ci_high_source": "configured_point_estimate_no_baseline_distribution",
    "baseline_selection_roi": 0.0,
    "batch_threshold": 0.5503599047660828,
    ...
    "delay_rate": 0.90625,
    "expected_trajectory_utility": 3.0886516582220795,
    ...
    "family_holdout_min_accepted_roi": 1.056901718179385,
    ...
    "family_holdout_per_family": {
      ...
      "random-wave": {
        ...
        "accepted_batch_roi": 3.699234971569644,
        "accepted_high_roi_count": 13,
        "high_roi_capture_rate": 0.5652173913043478,
      ...
      "sector-wave": {
        ...
        "accepted_batch_roi": 1.056901718179385,
    ...
    "high_priority_precision": 0.9994903160040775,
    "high_priority_precision_ci_low": 0.9971184233662933,
    "high_priority_prediction_count": 1962,
    "high_priority_true_positive_count": 1961,
    "max_accepted_bad_mode_count": 0,
    "min_family_accepted_high_roi_count": 1,
    "min_family_high_roi_capture_rate": 0.1,
    "old_gat_baseline_accepted_batch_roi": 0.0,
