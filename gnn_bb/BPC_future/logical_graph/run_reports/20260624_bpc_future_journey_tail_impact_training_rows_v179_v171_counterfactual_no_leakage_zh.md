...
output_dir = BPC_future/results/journey_tail_impact_training_rows_v179_v171_full_replay11_counterfactual_no_leakage_20260624
training_row_count = 33
raw_training_row_count = 33
deduplicated_row_count = 0
weak_row_count = 0
branch_row_count = 0
tail_action_row_count = 28
tail_action_counterfactual_row_count = 5
late_negative_row_count = 0
source_counts = {'tail_action_counterfactual_delta': 5, 'tail_action_proof_cost': 28}
tail_class_counts = {'tail_action_local_only_hard_negative': 5, 'tail_action_no_column': 28}
label_positive_counts = {'y_useful_tail_reduction': 0, 'y_tail_risk': 33, 'y_weak_negative_filtered': 0, 'y_completion_bound_tail': 28, 'y_early_branch_continues': 0, 'y_negative_chain_continues': 28, 'y_active_touch': 0, 'y_inactive_only': 0, 'y_child_negative_pricing_events': 33, 'y_child_completion_bound_retries': 33, 'y_child_early_branch_triggers': 0, 'y_tail_action_no_column': 28, 'y_tail_action_counterfactual': 5, 'y_local_tail_improved': 5, 'y_whole_run_improved': 0, 'y_local_improved_but_whole_run_not': 5, 'y_timeout_resolved': 0, 'y_timeout_regression': 0, 'y_right_censored_counterfactual': 5, 'y_child_unstarted': 0, 'y_subtree_no_column_chain': 0, 'y_late_true_negative': 0, 'y_late_active_support_changing': 0, 'y_late_inactive_only': 0, 'y_late_weak_filtered': 0}
regression_label_totals = {'child_negative_pricing_events': 387, 'child_completion_bound_retries': 398, 'child_early_branch_triggers': 0, 'child_unstarted': 0, 'subtree_no_column_chain': 0, 'late_true_negative': 0, 'late_active_support_changing': 0, 'late_inactive_only': 0, 'late_weak_filtered': 0, 'tail_action_counterfactual': 5, 'local_tail_improved': 5, 'whole_run_improved': 0, 'local_improved_but_whole_run_not': 5, 'right_censored_counterfactual': 5}
