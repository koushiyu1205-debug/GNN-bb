...
output_dir = BPC_future/results/journey_tail_impact_training_rows_v154_forced_pairs_20260623
training_row_count = 4
raw_training_row_count = 4
...
label_positive_counts = {'y_useful_tail_reduction': 0, 'y_tail_risk': 4, 'y_weak_negative_filtered': 0, 'y_completion_bound_tail': 1, 'y_early_branch_continues': 2, 'y_negative_chain_continues': 1, 'y_active_touch': 3, 'y_inactive_only': 1, 'y_child_negative_pricing_events': 4, 'y_child_completion_bound_retries': 1, 'y_child_early_branch_triggers': 2}
regression_label_totals = {'child_negative_pricing_events': 26, 'child_completion_bound_retries': 1, 'child_early_branch_triggers': 2}
