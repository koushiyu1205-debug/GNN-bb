...
sample_count = 2
candidate_count = 2
candidate_label_counts = {'abstain': 2}
roi_class_counts = {'positive_exact_roi': 1, 'positive_pricing_roi': 1}
delay_queue_label_count = 2
instance_count = 1
family_count = 1
region_count = 1
skipped_counts = {'not_training_eligible:roi_without_target_causal_match': 1}
has_high_priority_and_delay_labels = false
