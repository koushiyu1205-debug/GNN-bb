...
all_action_counts = {'COLLECT_BRANCH_CANDIDATE_DIAG_LOG': 23, 'ROUTE_TO_ROOT_PRICING_TAIL': 4, 'SKIP_ALREADY_ATTEMPTED_CONTEXT': 10, 'SKIP_ALREADY_WITHIN_TARGET': 20, 'SKIP_KNOWN_TARGET200_INSTANCE': 3}
selected_action_counts = {'COLLECT_BRANCH_CANDIDATE_DIAG_LOG': 12}
selected_family_counts = {'greedy-anchor': 7, 'sector-wave': 5}
commands_path = BPC_future/results/journey_branch_target200_sampling_plan_v303_full600_v252_branch_candidate_diag260_20260625/commands.sh
...
- action=COLLECT_BRANCH_CANDIDATE_DIAG_LOG, reason=branch_events_without_candidate_log, priority=105.0, family=greedy-anchor, terrain=tranquillitatis_balmer_like_20km, seed=61414, status=TIME_LIMIT, wall=555.746155, nodes=13, candidate_events=0, branch_events=6, instance=tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_05_seed61414_logical_graph.json
