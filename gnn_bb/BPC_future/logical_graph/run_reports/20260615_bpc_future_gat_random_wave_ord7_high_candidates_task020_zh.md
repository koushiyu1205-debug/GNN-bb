...
```json
{
  ...
  "candidate_family_region_counts": {
    "random-wave|tranquillitatis_balmer_like_20km": 3
  },
  ...
  "exclude_existing_roi_jsonl": "BPC_future/results/gat_same_run_combined_plus_seed_cross_family_v10_worker_roi_dataset_20260615/gat_worker_roi_rows.jsonl",
  "existing_roi_target_count": 49,
