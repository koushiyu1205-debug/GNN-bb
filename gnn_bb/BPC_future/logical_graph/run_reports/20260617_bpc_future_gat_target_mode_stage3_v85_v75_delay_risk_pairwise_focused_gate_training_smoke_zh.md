...
focused_pair_gate_summary = {'focused_row_count': 9, 'context_count': 3, 'contexts_with_positive_and_negative': 2, 'positive_row_count': 2, 'negative_row_count': 7, 'ambiguous_row_count': 0, 'pair_count': 4, 'raw_pair_pass_count': 0, 'admission_pair_pass_count': 0, 'delay_risk_pair_pass_count': 1, 'strict_pair_pass_count': 0, 'raw_pair_pass_rate': 0.0, 'admission_pair_pass_rate': 0.0, 'delay_risk_pair_pass_rate': 0.25, 'strict_pair_pass_rate': 0.0, 'label_counts': {'delay_or_hard_negative': 7, 'positive_high_priority': 2}, 'family_counts': {'sector-wave': 9}, 'primary': 'candidate_head_context_ranking_failure'}
...
rejected_checkpoint_reasons = ['accepted_batch_roi_ci_low_below_baseline_margin_or_not_measurable', 'admission_pair_pass_rate_below_threshold', 'delay_risk_pair_pass_rate_below_threshold', 'knn_ood_audit_missing', 'raw_pair_pass_rate_below_threshold', 'safe_precision_ci_low_below_threshold_or_not_measurable', 'strict_pair_pass_rate_below_threshold']
rejected_checkpoint_reason_categories = ['focused_pair_gate_failed', 'knn_ood_audit_missing', 'precision_ci_below_gate', 'roi_ci_below_baseline']
best_epoch = 1
selected_validation_loss = 2.9205066928761996
best_loss_epoch = 1
best_validation_loss = 2.9205066928761996
...
```json
{
  "family_holdout_metrics": {
    ...
    "family_holdout_min_accepted_roi": 0.6712561632905688,
    "family_holdout_min_high_roi_capture_rate": 0.15384615384615385,
    ...
    "family_holdout_per_family": {
      ...
      "sector-wave": {
        ...
        "accepted_batch_roi": 0.6712561632905688,
        "accepted_high_roi_count": 4,
        "high_roi_capture_rate": 0.15384615384615385,
  ...
  "focused_pair_gate": {
    ...
    "pair_rows": [
      {
        "admission_margin": -0.002986133098602295,
        "admission_positive_above_negative": false,
        "context_hash": "ac15bc4e7e3d6fff",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_02_seed61104|ac15bc4e7e3d6fff",
        "delay_risk_margin": -0.0012164413928985596,
        "family": "sector-wave",
        ...
        "raw_margin": -0.002986133098602295,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.001899421215057373,
        "admission_positive_above_negative": false,
        "context_hash": "ac15bc4e7e3d6fff",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_02_seed61104|ac15bc4e7e3d6fff",
        "delay_risk_margin": 0.0029446184635162354,
        "family": "sector-wave",
        ...
        "raw_margin": -0.001899421215057373,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.010607391595840454,
        "admission_positive_above_negative": false,
        "context_hash": "79fde658840fe2b8",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_08_seed61718|79fde658840fe2b8",
        "delay_risk_margin": -0.004355430603027344,
        "family": "sector-wave",
        ...
        "raw_margin": -0.010607391595840454,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.004754930734634399,
        "admission_positive_above_negative": false,
        "context_hash": "79fde658840fe2b8",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_08_seed61718|79fde658840fe2b8",
        "delay_risk_margin": -0.000458449125289917,
        "family": "sector-wave",
        ...
        "raw_margin": -0.004754930734634399,
        "raw_positive_above_negative": false
      }
    ],
    "production_ready": false,
    ...
    "summary": {
      ...
      "raw_pair_pass_count": 0,
      "raw_pair_pass_rate": 0.0,
      "strict_pair_pass_count": 0,
      "strict_pair_pass_rate": 0.0
    },
    "thresholds": {
      "min_admission_pair_pass_rate": 1.0,
  ...
  "threshold_search": {
    ...
    "selected_metrics": {
      ...
      "accepted_batch_rate": 0.11029411764705882,
      "accepted_batch_roi": 0.7002375960350037,
      "accepted_batch_roi_ci_low": 0.40042289048287344,
      "accepted_batch_roi_over_baseline": 0.7002375960350037,
      "accepted_batch_roi_over_baseline_ci_low": 0.40042289048287344,
      "accepted_batch_roi_over_best_rc_baseline": 0.7002375960350037,
      "accepted_batch_roi_over_best_rc_baseline_ci_low": 0.40042289048287344,
      "accepted_batch_roi_over_old_gat_baseline": 0.7002375960350037,
      "accepted_batch_roi_over_old_gat_baseline_ci_low": 0.40042289048287344,
      "accepted_batch_roi_over_random_baseline": 0.7002375960350037,
      "accepted_batch_roi_over_random_baseline_ci_low": 0.40042289048287344,
      ...
      "batch_threshold": 0.5243692994117737,
      "batch_thresholds_by_family": {
        "random-wave": 0.5243692994117737,
        "sector-wave": 0.49967166781425476
      },
      ...
      "candidate_score_threshold_blocked_count": 343,
      "candidate_threshold": 0.49559056758880615,
      "checkpoint_gate_pass": false,
      ...
      "delay_rate": 0.8897058823529411,
      "evaluated_candidate_count": 1236,
      "expected_trajectory_utility": 0.743570929368337,
      ...
      "high_priority_precision_ci_low": 0.9957165234083698,
      "high_priority_prediction_count": 893,
      "high_priority_true_positive_count": 893,
  ...
  "train_deployment_metrics": {
    ...
    "accepted_batch_precision": 1.0,
    "accepted_batch_rate": 0.08203125,
    "accepted_batch_roi": 0.7160614153281564,
    "accepted_batch_roi_ci_low": 0.3380070434903175,
    "accepted_batch_roi_over_baseline": 0.7160614153281564,
    "accepted_batch_roi_over_baseline_ci_low": 0.3380070434903175,
    "accepted_batch_roi_over_best_rc_baseline": 0.7160614153281564,
    "accepted_batch_roi_over_best_rc_baseline_ci_low": 0.3380070434903175,
    "accepted_batch_roi_over_old_gat_baseline": 0.7160614153281564,
    "accepted_batch_roi_over_old_gat_baseline_ci_low": 0.3380070434903175,
    "accepted_batch_roi_over_random_baseline": 0.7160614153281564,
    "accepted_batch_roi_over_random_baseline_ci_low": 0.3380070434903175,
    "baseline_roi_ci_high": 0.0,
    "baseline_roi_ci_high_source": "configured_point_estimate_no_baseline_distribution",
    "baseline_selection_roi": 0.0,
    "batch_threshold": 0.5243692994117737,
    ...
    "candidate_rescue_window_promoted_count": 0,
    "candidate_risk_adjusted_suppressed_count": 0,
    "candidate_score_threshold_blocked_count": 633,
    "candidate_threshold": 0.49559056758880615,
    "checkpoint_gate_pass": false,
    "checkpoint_gate_reject_reasons": [
      "safe_precision_ci_low_below_threshold_or_not_measurable",
    ...
    "delay_rate": 0.91796875,
    "evaluated_candidate_count": 3467,
    "expected_trajectory_utility": 0.7541566534233946,
    "false_high_priority_on_delay": 0.22180451127819548,
    "false_high_priority_on_delay_count": 59,
    "false_safe_rate_label_unsafe": 0.0,
    "false_safe_rate_union": 0.22180451127819548,
    "family_delay_fallback_families": [],
    ...
    "family_holdout_per_family": {
      ...
      "random-wave": {
        ...
        "accepted_batch_roi": 1.6157235503196716,
    ...
    "high_priority_precision": 0.9791813690896259,
    "high_priority_precision_ci_low": 0.9732396526925513,
    "high_priority_prediction_count": 2834,
    "high_priority_true_positive_count": 2775,
    "max_accepted_bad_mode_count": 0,
    "min_family_accepted_high_roi_count": 0,
    "min_family_high_roi_capture_rate": 0.0,
    "old_gat_baseline_accepted_batch_roi": 0.0,
