...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v421_v417_plus_v418_failclosed_20260625
target_wall = 200.0
raw_row_count = 37
sample_count = 28
...
tail_improved_aux_label_counts = {'tail_improved': 20, 'tail_not_improved': 8}
skipped_counts = {'not_training_sample:budget_dominant_improvement': 1, 'not_training_sample:local_only_hard_negative': 8}
instance_count = 6
family_count = 3
