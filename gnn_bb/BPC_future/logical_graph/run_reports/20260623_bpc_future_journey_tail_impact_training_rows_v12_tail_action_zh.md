...
output_dir = BPC_future/results/journey_tail_impact_training_rows_v12_tail_action_20260623
...
label_positive_counts = {'y_useful_tail_reduction': 0, 'y_tail_risk': 3, 'y_weak_negative_filtered': 0, 'y_completion_bound_tail': 0, 'y_early_branch_continues': 1, 'y_negative_chain_continues': 1, 'y_active_touch': 0, 'y_inactive_only': 0, 'y_child_negative_pricing_events': 1, 'y_child_completion_bound_retries': 0, 'y_child_early_branch_triggers': 1, 'y_tail_action_no_column': 2, 'y_child_unstarted': 2, 'y_subtree_no_column_chain': 1}
regression_label_totals = {'child_negative_pricing_events': 3, 'child_completion_bound_retries': 0, 'child_early_branch_triggers': 2, 'child_unstarted': 3, 'subtree_no_column_chain': 2}
