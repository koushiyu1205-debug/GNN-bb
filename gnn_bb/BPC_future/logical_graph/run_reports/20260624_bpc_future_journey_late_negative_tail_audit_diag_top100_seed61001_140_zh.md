...
output_dir = BPC_future/results/journey_late_negative_tail_audit_diag_top100_seed61001_140_20260624
log_count = 1
tail_event_count = 5
min_cg_iter = 0
min_time = 80.0
...
total_inactive_changed_task_sets = 17
...
```json
{
  ...
  "true_negative_no_addition_observed": 3
}
```
