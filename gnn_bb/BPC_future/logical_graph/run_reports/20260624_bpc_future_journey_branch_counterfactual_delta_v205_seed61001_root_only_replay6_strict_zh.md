...
output_dir = BPC_future/results/journey_branch_counterfactual_delta_v205_seed61001_root_only_replay6_strict_20260624
...
label_positive_counts = {'y_counterfactual_local_improved_but_whole_run_not': 2, 'y_counterfactual_proof_cost_proxy_improved': 6, 'y_counterfactual_right_censored': 2, 'y_counterfactual_timeout_resolved': 4}
counterfactual_label_type_counts = {'local_only_hard_negative': 2, 'strong_positive': 4}
status_pair_counts = {'EXTERNAL_TIME_LIMIT->EXTERNAL_TIME_LIMIT': 1, 'EXTERNAL_TIME_LIMIT->OPTIMAL': 4, 'EXTERNAL_TIME_LIMIT->TIME_LIMIT': 1}
