...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v653_routeopt_bkf_positive_full_replay_20260628
target_wall = 200.0
wall_cap = 600.0
...
raw_row_count = 2
sample_count = 2
row_kind_counts = {'changed_timeout_no_effect_hard_negative': 1, 'walltime_gain_target_wall_crossing': 1}
branch_priority_label_counts = {'not_walltime_gain': 1, 'walltime_gain_positive': 1}
target_wall_crossing_label_counts = {'not_target_wall_crossing': 1, 'target_wall_crossing_positive': 1}
