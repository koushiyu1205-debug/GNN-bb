...
```json
{
  ...
  "validation_metrics": {
    ...
    "add_precision": 0.38095238095238093,
    "add_recall": 0.9411764705882353,
    "false_high_priority_rate": 0.7222222222222222,
    "false_negative_delay_queue": 1,
    "false_positive_high_priority": 26,
    "predicted_delay_queue": 11,
    "predicted_high_priority": 42,
    "total": 53,
    "true_negative_delay_queue": 10,
    "true_positive_high_priority": 16
  }
}
```
