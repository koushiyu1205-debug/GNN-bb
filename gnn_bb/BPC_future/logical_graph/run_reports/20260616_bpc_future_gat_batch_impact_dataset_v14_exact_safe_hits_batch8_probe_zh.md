...
batch_label_counts = {'non_improving': 1, 'roi_positive': 3}
candidate_label_counts = {'delay_queue': 1, 'high_priority': 3}
batch_type_counts = {'new_task_set': 4}
pairwise_context_stats = {'context_count': 1, 'multi_context_count': 1, 'same_context_pair_count': 6, 'largest_context_size': 4, 'sample_count': 4, 'same_context_comparable_pair_count': 6, 'roi_diverse_context_count': 1, 'positive_negative_label_pair_count': 3, 'by_family': {'sector-wave': {'sample_count': 4, 'context_count': 1, 'multi_context_count': 1, 'same_context_pair_count': 6, 'largest_context_size': 4}}, 'by_task_count': {'20': {'sample_count': 4, 'context_count': 1, 'multi_context_count': 1, 'same_context_pair_count': 6, 'largest_context_size': 4}}}
ranking_ready = true
ranking_blockers = []
family_counts = {'sector-wave': 4}
task_count_counts = {'20': 4}
instance_count = 1
region_count = 1
