...
[
  {
    "baseline_csv": "BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task005_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task005_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "sector-wave",
  ...
  {
    "baseline_csv": "BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task010_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task010_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "sector-wave",
  ...
  {
    "baseline_csv": "BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "random-wave",
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_5_journey.yaml --time-limit 60.000000 --timeout-kill-after 30s --max-workers 1 --results-csv BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task005_baseline/results.csv --log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task005_baseline/logs --solution-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task005_baseline/solutions --run-log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task005_baseline/run_logs --quiet --instances BPC_future/logical_graph/tasks_005/sector-wave/apollo15_20km/apollo15_20km_sector-wave_randomtw_tasks005_01_seed2046000_logical_graph.json BPC_future/logical_graph/tasks_005/sector-wave/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks005_01_seed2146011_logical_graph.json
```
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_10_journey.yaml --time-limit 60.000000 --timeout-kill-after 30s --max-workers 1 --results-csv BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task010_capture/results.csv --log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task010_capture/logs --solution-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task010_capture/solutions --run-log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task010_capture/run_logs --quiet --instances BPC_future/logical_graph/tasks_010/sector-wave/apollo15_20km/apollo15_20km_sector-wave_randomtw_tasks010_01_seed51001_logical_graph.json BPC_future/logical_graph/tasks_010/sector-wave/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks010_01_seed51001_logical_graph.json --set journey_counterfactual_replay_capture_enabled=true --set journey_counterfactual_replay_capture_active_basis_enabled=true --set journey_counterfactual_replay_capture_forbidden_signatures_enabled=true --set journey_counterfactual_replay_capture_log_empty=true --set journey_counterfactual_replay_capture_active_basis_max_rows=96 --set journey_counterfactual_replay_capture_max_journeys=32 --set journey_counterfactual_replay_capture_pool_max_journeys=256 --set journey_counterfactual_replay_capture_forbidden_signature_max_count=256
```
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_20_smoke.yaml --time-limit 85.000000 --timeout-kill-after 30s --max-workers 1 --results-csv BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_baseline/results.csv --log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_baseline/logs --solution-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_baseline/solutions --run-log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_baseline/run_logs --quiet --instances BPC_future/logical_graph/tasks_020/random-wave/apollo15_20km/apollo15_20km_random-wave_randomtw_tasks020_05_seed61408_logical_graph.json BPC_future/logical_graph/tasks_020/random-wave/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_05_seed61411_logical_graph.json
```
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_20_smoke.yaml --time-limit 85.000000 --timeout-kill-after 30s --max-workers 1 --results-csv BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_capture/results.csv --log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_capture/logs --solution-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_capture/solutions --run-log-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_capture/run_logs --quiet --instances BPC_future/logical_graph/tasks_020/random-wave/apollo15_20km/apollo15_20km_random-wave_randomtw_tasks020_05_seed61408_logical_graph.json BPC_future/logical_graph/tasks_020/random-wave/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_05_seed61411_logical_graph.json --set journey_counterfactual_replay_capture_enabled=true --set journey_counterfactual_replay_capture_active_basis_enabled=true --set journey_counterfactual_replay_capture_forbidden_signatures_enabled=true --set journey_counterfactual_replay_capture_log_empty=true --set journey_counterfactual_replay_capture_active_basis_max_rows=96 --set journey_counterfactual_replay_capture_max_journeys=32 --set journey_counterfactual_replay_capture_pool_max_journeys=256 --set journey_counterfactual_replay_capture_forbidden_signature_max_count=256
```
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/build_gat_same_run_batch_impact_dataset.py --output-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/same_run_batch_impact_dataset --report BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/same_run_batch_impact_dataset_zh.md --log-root BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task005_capture/logs --log-root BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task010_capture/logs --log-root BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/task020_capture/logs
```
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/build_gat_same_run_target_priority_candidates.py --decision-records BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/same_run_gat_knn_ood_audit/decision_records.jsonl --output-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/target_priority_candidates --report BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/target_priority_candidates_zh.md --max-candidates 12
```
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/build_gat_same_run_target_priority_candidates.py --decision-records BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/same_run_gat_knn_ood_audit/decision_records.jsonl --output-dir BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/delay_queue_target_candidates --report BPC_future/results/gat_same_run_random_wave_ord5_capture_runbook_20260615/delay_queue_target_candidates_zh.md --max-candidates 12 --delay-queue-only
```
