...
probe_hard_negative_count = 354
probe_positive_context_count = 2
probe_hard_negative_context_count = 301
probe_instance_count = 27
probe_time_window_family_count = 3
family_counts = {'greedy-anchor': 232, 'random-wave': 159, 'sector-wave': 288}
probe_hard_negative_reason_counts = {'completion_bound_retry': 346, 'low_proxy_score': 354, 'negative_pricing_event': 352, 'right_censored_probe': 354, 'unstarted_child': 25}
...
remaining_for_probe_serious_training = {'probe_branch_row_min': 321, 'probe_positive_min': 48, 'probe_positive_context_min': 8}
