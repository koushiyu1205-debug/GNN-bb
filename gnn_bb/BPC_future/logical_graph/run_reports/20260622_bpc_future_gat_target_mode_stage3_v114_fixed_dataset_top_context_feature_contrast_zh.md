...
本报告只审计 v112/v113 focused same-context pair failure 的 top contexts 在 `BPC_future/data/gat_batch_impact/v114_context_feature_no_outcome_delta_5000_stage4_biased_20260622` 数据集中的模型可见输入。它不运行 BPC、pricing、RMP、worker 或 certificate。

## 机器字段

```text
status = gat_batch_impact_top_context_feature_contrast_audited
dataset_dir = BPC_future/data/gat_batch_impact/v114_context_feature_no_outcome_delta_5000_stage4_biased_20260622
...
- `BPC_future/data/gat_batch_impact/v114_context_feature_no_outcome_delta_5000_stage4_biased_20260622` tensor 已包含 candidate path token、trace scalar 和 slack scalar；旧 feature-structure 审计里“path/timing/slack 全缺失”的结论对当前数据集需要收窄。
...
```text
summary = BPC_future/results/gat_batch_impact_top_context_feature_contrast_v114_fixed_dataset_v112_v113_20260622/summary.json
rows = BPC_future/results/gat_batch_impact_top_context_feature_contrast_v114_fixed_dataset_v112_v113_20260622/top_context_row_feature_records.jsonl
pairs = BPC_future/results/gat_batch_impact_top_context_feature_contrast_v114_fixed_dataset_v112_v113_20260622/top_context_pair_feature_contrast_rows.jsonl
contexts = BPC_future/results/gat_batch_impact_top_context_feature_contrast_v114_fixed_dataset_v112_v113_20260622/top_context_feature_contrast_contexts.jsonl
```
