...
wall_improved_count = 0
wall_regressed_count = 1
wall_time_delta_sum = 19.077458
exact_pricing_calls_delta_sum = 2.0
...
- instance=tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_01_seed61001_logical_graph.json, baseline_selected=[2, 6], optin_selected=[2, 6], score=5.393553672, source=node:0:depth:0:2,6, wall_delta=19.077458, exact_delta=2.0, node_delta=0.0
