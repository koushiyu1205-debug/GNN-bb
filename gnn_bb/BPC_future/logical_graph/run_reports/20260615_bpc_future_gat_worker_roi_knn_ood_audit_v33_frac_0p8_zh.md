...
```json
{
  "decision_reason_counts": {
    "high_priority": 29,
    "neighbor_delay_fraction_too_high": 8,
  ...
  "safe_radius": 1.0707288068195515,
  "threshold": 0.6200661063194275,
  "validation_metrics": {
    "accuracy": 0.4358974358974359,
    "add_precision": 0.3448275862068966,
    "add_recall": 0.7692307692307693,
    "false_high_priority_rate": 0.7307692307692307,
    "false_negative_delay_queue": 3,
    "false_positive_high_priority": 19,
    "predicted_delay_queue": 10,
    "predicted_high_priority": 29,
    "total": 39,
    "true_negative_delay_queue": 7,
    "true_positive_high_priority": 10
  }
}
```
