...
```text
summary = BPC_future/results/gat_batch_impact_focused_pair_gate_v77_v76_path_token_smoke_20260617/summary.json
scored_rows = BPC_future/results/gat_batch_impact_focused_pair_gate_v77_v76_path_token_smoke_20260617/scored_individual_rows.jsonl
context_rows = BPC_future/results/gat_batch_impact_focused_pair_gate_v77_v76_path_token_smoke_20260617/context_ranking_rows.jsonl
pair_rows = BPC_future/results/gat_batch_impact_focused_pair_gate_v77_v76_path_token_smoke_20260617/positive_negative_pair_rows.jsonl
```
