...
proxy_branch_row_count = 11
proxy_context_count = 6
proxy_ranking_pair_count = 7
right_censored_proxy_ranking_pair_count = 7
min_proxy_score_gap = 0.05
context_counts = {'all_right_censored_context': 3, 'single_pair_context': 3}
...
- node=1 depth=1 alts=1 spread=0.0 best=[3, 7] score=-10.0 worst=[3, 7] score=-10.0
- node=2 depth=1 alts=1 spread=0.0 best=[2, 9] score=-10.0 worst=[2, 9] score=-10.0
- node=0 depth=0 alts=3 spread=0.479780508 best=[10, 18] score=-8.895945175 worst=[1, 20] score=-9.375725683
- node=1 depth=1 alts=1 spread=0.0 best=[1, 2] score=-14.0 worst=[1, 2] score=-14.0
- node=2 depth=1 alts=2 spread=2.0 best=[12, 16] score=-10.0 worst=[4, 13] score=-12.0

## Top Proxy Ranking Pairs

- node=2 depth=1 better=[12, 16] worse=[4, 13] gap=2.0 reason=child_probe_proxy_score right_censored=True
