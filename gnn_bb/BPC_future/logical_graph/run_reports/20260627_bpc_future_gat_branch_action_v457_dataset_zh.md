...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v457_v453_plus_v456_walltime_20260627
target_wall = 200.0
wall_cap = 600.0
...
target_wall_crossing_label_counts = {'not_target_wall_crossing': 109, 'target_wall_crossing_positive': 31}
tail_improved_aux_label_counts = {'tail_improved': 46, 'tail_not_improved': 94}
