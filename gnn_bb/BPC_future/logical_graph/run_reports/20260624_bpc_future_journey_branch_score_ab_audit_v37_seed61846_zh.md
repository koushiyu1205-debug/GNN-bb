...
- instance=tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_09_seed61846_logical_graph.json, baseline_selected=[2, 5], optin_selected=[3, 18], score=10.0, source=node:0:depth:0:3,18, wall_delta=-107.912854, exact_delta=-18.0, node_delta=-4.0
