...
target_wall = 200.0
row_count = 33
usable_counterfactual_training_count = 25
strict_full_replay_positive_count = 18
...
weak_positive_not_target_count = 7
regression_count = 7
local_only_hard_negative_count = 8
...
counterfactual_label_type_counts = {'budget_dominant_improvement': 1, 'local_only_hard_negative': 8, 'regression': 6, 'strong_positive': 18}
status_pair_counts = {'EXTERNAL_TIME_LIMIT->EXTERNAL_TIME_LIMIT': 1, 'EXTERNAL_TIME_LIMIT->OPTIMAL': 8, 'EXTERNAL_TIME_LIMIT->TIME_LIMIT': 1, 'OPTIMAL->EXTERNAL_TIME_LIMIT': 5, 'OPTIMAL->OPTIMAL': 10, 'OPTIMAL->TIME_LIMIT': 1, 'TIME_LIMIT->EXTERNAL_TIME_LIMIT': 4, 'TIME_LIMIT->OPTIMAL': 1, 'TIME_LIMIT->TIME_LIMIT': 2}
...
remaining_for_serious_training = {'target_200_positive_min': 9, 'hard_negative_min': 23, 'target_200_context_min': 3, 'target_200_instance_min': 3, 'holdout_context_min': 2}
remaining_for_optin_training = {'target_200_positive_min': 29, 'hard_negative_min': 53, 'target_200_context_min': 10, 'target_200_instance_min': 10, 'holdout_context_min': 3}
missing_for_pipeline_debug_training = {}
missing_for_sanity_training = {}
missing_for_serious_training = {'target_200_positive_min': 9, 'hard_negative_min': 23, 'target_200_context_min': 3, 'target_200_instance_min': 3, 'holdout_context_min': 2}
missing_for_optin_training = {'target_200_positive_min': 29, 'hard_negative_min': 53, 'target_200_context_min': 10, 'target_200_instance_min': 10, 'holdout_context_min': 3}
