...
sample_count = 120
candidate_count = 120
candidate_label_counts = {'abstain': 81, 'add': 39}
roi_class_counts = {'negative_primal_roi': 26, 'negative_retry_roi': 27, 'no_observed_roi': 28, 'positive_primal_roi': 34, 'positive_retry_roi': 5}
delay_queue_label_count = 81
instance_count = 48
family_count = 3
region_count = 2
skipped_counts = {'missing_source_file': 36, 'not_training_eligible:no_worker_target_intervention_observed': 10, 'not_training_eligible:positive_roi_without_target_causal_match': 1, 'not_training_eligible:unsupported_roi_class:columns_only_roi': 10, 'not_training_eligible:worker_context_mismatch': 3}
