...
max_per_cell = 4
roi_class_counts = {'columns_only_roi': 6, 'negative_primal_roi': 16, 'negative_retry_roi': 7, 'no_observed_roi': 37, 'positive_primal_roi': 21, 'positive_retry_roi': 1}
...
```json
{
  "greedy-anchor|apollo15_20km": {
    ...
    "positive_count": 5,
    "positive_rate": 0.45454545454545453,
    "roi_class_counts": {
  ...
  "greedy-anchor|tranquillitatis_balmer_like_20km": {
    ...
    "positive_count": 8,
    "positive_rate": 0.6153846153846154,
    "roi_class_counts": {
...
[
  {
    ...
    "best_true_reduced_cost": -0.577199,
    ...
    "sample_path": "samples/sample_000056.pt",
  ...
  },
  {
    ...
    "best_true_reduced_cost": -0.049694,
    "branch_hash": "da39a3ee5e6b4b0d",
    "candidate_ranking": "impact",
    "capture_cg_iter": 17,
    "capture_pricing_kind": "exact",
    ...
    "cell_training_negative_count": 5,
    "certificate_effect": false,
    "context_hash": "7714263901aeb2ec",
    "cut_hash": "d653e60106177bb4",
    "decision_name": "DELAY_QUEUE",
    "decision_probability": 0.7261249423027039,
    "decision_reason": "below_threshold_delay_queue",
    "decision_record_index": 32,
    "existing_roi_target": false,
    ...
    "requires_worker_target_causal_match": true,
    "roi_yield_signal": 0.667823,
    "sample_path": "samples/sample_000032.pt",
    "schema_version": "gat_same_run_target_priority_candidate_v1",
    "score": 6.913878,
    "source_candidate_file": "BPC_future/results/gat_bulk_sampling_runbook_v14_multiscale_20260615/combined_delay_queue_target_candidates/candidates.json",
  ...
  {
    "active_hash_before": "8a93da8ed9d9c4ac",
    "best_true_reduced_cost": -1.943188,
    "branch_hash": "da39a3ee5e6b4b0d",
    "candidate_ranking": "impact",
    "capture_cg_iter": 14,
    "capture_pricing_kind": "exact",
    ...
    "cell_training_negative_count": 5,
    "certificate_effect": false,
    "context_hash": "5d9c7e881a00ee06",
    "cut_hash": "d653e60106177bb4",
    "decision_name": "DELAY_QUEUE",
    "decision_probability": 0.6275163888931274,
    "decision_reason": "below_threshold_delay_queue",
    "decision_record_index": 55,
    "existing_roi_target": false,
    ...
    "requires_worker_target_causal_match": true,
    "roi_yield_signal": 0.667823,
    "sample_path": "samples/sample_000055.pt",
    "schema_version": "gat_same_run_target_priority_candidate_v1",
    "score": 6.909944,
    "source_candidate_file": "BPC_future/results/gat_bulk_sampling_runbook_v14_multiscale_20260615/combined_delay_queue_target_candidates/candidates.json",
    "source_file": "BPC_future/results/gat_bulk_sampling_runbook_v13_20260615/task020_bulk_capture_wave03/logs/BPC_future/logical_graph/tasks_020/greedy-anchor/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520_logical_graph.json.jsonl",
  ...
  },
  {
    ...
    "best_true_reduced_cost": -0.513282,
    "branch_hash": "da39a3ee5e6b4b0d",
    "candidate_ranking": "impact",
    "capture_cg_iter": 13,
    "capture_pricing_kind": "exact",
    ...
    "cell_training_negative_count": 5,
    "certificate_effect": false,
    "context_hash": "6cbf8d7c2c4fe23f",
    "cut_hash": "d653e60106177bb4",
    "decision_name": "DELAY_QUEUE",
    "decision_probability": 0.6935039162635803,
    "decision_reason": "below_threshold_delay_queue",
    "decision_record_index": 54,
    "existing_roi_target": false,
    ...
    "requires_worker_target_causal_match": true,
    "roi_yield_signal": 0.667823,
    "sample_path": "samples/sample_000054.pt",
    "schema_version": "gat_same_run_target_priority_candidate_v1",
    "score": 6.904436,
    "source_candidate_file": "BPC_future/results/gat_bulk_sampling_runbook_v14_multiscale_20260615/combined_delay_queue_target_candidates/candidates.json",
    "source_file": "BPC_future/results/gat_bulk_sampling_runbook_v13_20260615/task020_bulk_capture_wave03/logs/BPC_future/logical_graph/tasks_020/greedy-anchor/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520_logical_graph.json.jsonl",
  ...
  },
  {
    ...
    "best_true_reduced_cost": -1.2496114,
    "branch_hash": "da39a3ee5e6b4b0d",
    "candidate_ranking": "impact",
    "capture_cg_iter": 53,
    "capture_pricing_kind": "exact",
    ...
    "certificate_effect": false,
    "context_hash": "b1fb77954b949bf0",
    "cut_hash": "d653e60106177bb4",
    "decision_name": "HIGH_PRIORITY",
    "decision_probability": 0.973918080329895,
    "decision_reason": "high_priority",
    "decision_record_index": 28,
    "existing_roi_target": false,
    ...
    "ordinal_positive_rate": 0.333333,
    "pool_signature_hash": "e2151485b49e03db",
    "pool_task_set_hash": "74fb358c2ad9aae8",
    "positive_gap": 0,
    "positive_gap_weight": 5.636364,
    "reason": "candidate_pool_high_score",
    "recommendation_bucket": "positive_rich_exploit",
    "requires_worker_target_causal_match": true,
    "roi_yield_signal": 0.454545,
    "sample_path": "samples/sample_000028.pt",
    "schema_version": "gat_same_run_target_priority_candidate_v1",
    "score": 4.482427,
    "source_candidate_file": "BPC_future/results/gat_bulk_sampling_runbook_v14_multiscale_20260615/combined_target_priority_candidates/candidates.json",
