...
output_dir = BPC_future/results/journey_branch_counterfactual_delta_v210_v173_sector_apollo_seed61408_root_replay6_strict_20260624
...
label_positive_counts = {'y_counterfactual_proof_cost_improved': 2, 'y_counterfactual_proof_cost_proxy_improved': 2, 'y_counterfactual_regression': 2, 'y_counterfactual_timeout_regression': 2, 'y_counterfactual_wall_improved': 4}
counterfactual_label_type_counts = {'regression': 2, 'strong_positive': 4}
status_pair_counts = {'OPTIMAL->EXTERNAL_TIME_LIMIT': 2, 'OPTIMAL->OPTIMAL': 4}
wall_improvement_positive_count = 4
