...
output_dir = BPC_future/results/journey_tail_impact_training_rows_v154_depth_sequence_20260623
training_row_count = 2
raw_training_row_count = 2
deduplicated_row_count = 0
weak_row_count = 0
branch_row_count = 2
source_counts = {'branch_impact': 2}
tail_class_counts = {'completion_bound_tail': 1, 'early_branch_continues': 1}
label_positive_counts = {'y_useful_tail_reduction': 0, 'y_tail_risk': 2, 'y_weak_negative_filtered': 0, 'y_completion_bound_tail': 1, 'y_early_branch_continues': 1, 'y_negative_chain_continues': 0, 'y_active_touch': 1, 'y_inactive_only': 1, 'y_child_negative_pricing_events': 2, 'y_child_completion_bound_retries': 1, 'y_child_early_branch_triggers': 1}
regression_label_totals = {'child_negative_pricing_events': 17, 'child_completion_bound_retries': 1, 'child_early_branch_triggers': 1}
