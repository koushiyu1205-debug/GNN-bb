...
output_dir = BPC_future/results/journey_late_negative_tail_audit_v270_seed61921_root_tail_20260625
log_count = 1
tail_event_count = 13
min_cg_iter = 0
min_time = 80.0
...
```json
{
  "true_negative_inactive_only": 6,
  "true_negative_no_addition_observed": 7
}
```
