...
output_dir = BPC_future/results/journey_branch_counterfactual_delta_v402_v90_positive_delta_focus_next4_current_audit
runbook_entry_count = 4
...
timeout_resolved_count = 2
timeout_regression_count = 0
label_positive_counts = {'y_counterfactual_proof_cost_proxy_improved': 2, 'y_counterfactual_right_censored': 2, 'y_counterfactual_timeout_resolved': 2}
counterfactual_label_type_counts = {'strong_positive': 2, 'unknown_right_censored': 2}
status_pair_counts = {'EXTERNAL_TIME_LIMIT->EXTERNAL_TIME_LIMIT': 1, 'EXTERNAL_TIME_LIMIT->OPTIMAL': 2, 'EXTERNAL_TIME_LIMIT->TIME_LIMIT': 1}
