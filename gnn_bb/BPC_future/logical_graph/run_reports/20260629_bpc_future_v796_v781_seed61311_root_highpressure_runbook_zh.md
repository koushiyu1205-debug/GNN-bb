...
```text
output_dir = BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure
entry_count = 4
...
accepted_event_count_by_instance = {'BPC_future/logical_graph/tasks_020/greedy-anchor/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph.json': 1}
...
### 001_candidate_selected_d0_n0_2_16_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph
...
source_node_id = 0
source_depth = 0
source_event_time = 17.32375
pair_group_id = tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph__d0__n0__sel_2,16
pair_role = selected_baseline
source_selected_pair = [2, 16]
forced_pair = [2, 16]
...
source_selected_pair = [2, 16]
forced_pair = [2, 8]
forced_pair_path_rule = force_pair_path:0:2,8
probe_mode = child_probe
effective_time_limit = 180
probe_max_nodes = 1000
probe_max_cg_iterations = None
...
```bash
/home/kai/miniconda3/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_20_smoke.yaml --instances BPC_future/logical_graph/tasks_020/greedy-anchor/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph.json --time-limit 180 --results-csv BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/002_candidate_alt_d0_n0_r1_2_8_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/results.csv --log-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/002_candidate_alt_d0_n0_r1_2_8_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/logs --solution-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/002_candidate_alt_d0_n0_r1_2_8_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/solutions --run-log-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/002_candidate_alt_d0_n0_r1_2_8_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/run_logs --python /home/kai/miniconda3/bin/python --timeout-kill-after 30s --max-workers 1 --quiet --set journey_branch_candidate_priority=force_pair_path:0:2,8 --set journey_branch_candidate_log_top_n=200 --set max_nodes=1000 --set journey_max_nodes=1000 --set journey_tail_action_audit_enabled=True --set journey_corrected_node_bound_audit_enabled=True --set journey_corrected_node_bound_fathom_enabled=False --set journey_tail_action_early_branch_enabled=False --set journey_tail_action_no_column_early_branch_enabled=False --set journey_branch_candidate_phased_testing_preset=routeopt_bkf_v762 --set journey_branch_candidate_phased_testing_enabled=True --set journey_branch_candidate_phased_testing_phase1_lp_enabled=True --set journey_branch_candidate_phased_testing_phase2_heuristic_enabled=True --set journey_branch_candidate_phased_testing_bkf_score_order_enabled=True
```

### 003_candidate_alt_d0_n0_r2_2_11_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph
...
source_alt_pool_balance_gap = 32
source_alt_branch_score = None
coverage_gap_priority = 0.0
coverage_gap_priority_reason = None
coverage_best_scored_pair = None
...
```bash
/home/kai/miniconda3/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_20_smoke.yaml --instances BPC_future/logical_graph/tasks_020/greedy-anchor/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph.json --time-limit 180 --results-csv BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/003_candidate_alt_d0_n0_r2_2_11_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/results.csv --log-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/003_candidate_alt_d0_n0_r2_2_11_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/logs --solution-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/003_candidate_alt_d0_n0_r2_2_11_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/solutions --run-log-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/003_candidate_alt_d0_n0_r2_2_11_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/run_logs --python /home/kai/miniconda3/bin/python --timeout-kill-after 30s --max-workers 1 --quiet --set journey_branch_candidate_priority=force_pair_path:0:2,11 --set journey_branch_candidate_log_top_n=200 --set max_nodes=1000 --set journey_max_nodes=1000 --set journey_tail_action_audit_enabled=True --set journey_corrected_node_bound_audit_enabled=True --set journey_corrected_node_bound_fathom_enabled=False --set journey_tail_action_early_branch_enabled=False --set journey_tail_action_no_column_early_branch_enabled=False --set journey_branch_candidate_phased_testing_preset=routeopt_bkf_v762 --set journey_branch_candidate_phased_testing_enabled=True --set journey_branch_candidate_phased_testing_phase1_lp_enabled=True --set journey_branch_candidate_phased_testing_phase2_heuristic_enabled=True --set journey_branch_candidate_phased_testing_bkf_score_order_enabled=True
```

### 004_candidate_alt_d0_n0_r21_8_16_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph
...
```bash
/home/kai/miniconda3/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_20_smoke.yaml --instances BPC_future/logical_graph/tasks_020/greedy-anchor/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph.json --time-limit 180 --results-csv BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/004_candidate_alt_d0_n0_r21_8_16_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/results.csv --log-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/004_candidate_alt_d0_n0_r21_8_16_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/logs --solution-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/004_candidate_alt_d0_n0_r21_8_16_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/solutions --run-log-dir BPC_future/results/journey_branch_candidate_replay_runbook_v796_v781_seed61311_root_highpressure/runs/004_candidate_alt_d0_n0_r21_8_16_tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_04_seed61311_logical_graph/run_logs --python /home/kai/miniconda3/bin/python --timeout-kill-after 30s --max-workers 1 --quiet --set journey_branch_candidate_priority=force_pair_path:0:8,16 --set journey_branch_candidate_log_top_n=200 --set max_nodes=1000 --set journey_max_nodes=1000 --set journey_tail_action_audit_enabled=True --set journey_corrected_node_bound_audit_enabled=True --set journey_corrected_node_bound_fathom_enabled=False --set journey_tail_action_early_branch_enabled=False --set journey_tail_action_no_column_early_branch_enabled=False --set journey_branch_candidate_phased_testing_preset=routeopt_bkf_v762 --set journey_branch_candidate_phased_testing_enabled=True --set journey_branch_candidate_phased_testing_phase1_lp_enabled=True --set journey_branch_candidate_phased_testing_phase2_heuristic_enabled=True --set journey_branch_candidate_phased_testing_bkf_score_order_enabled=True
```
