...
[
  {
    "active_hash_before": "e10c71a75881a25e",
    ...
    "forbidden_signature_hash": "dadd51ff3fb24704",
    ...
    "pool_signature_hash": "c2dbf5e5f3be80f8",
    "pool_task_set_hash": "a7cb4b87c6b949d2",
    ...
    "true_dual_hash": "6f24be448930c1df",
  ...
  {
    "active_hash_before": "4e99ab4308fcfd4e",
    ...
    "forbidden_signature_hash": "216a7cede7c65db2",
    ...
    "pool_signature_hash": "a6c22561562d05b1",
    "pool_task_set_hash": "35e567246e021961",
    "target_arc_option_sequence": [
      "0->14:low_risk:1",
      "14->5:low_risk:2",
      "5->0:low_risk:2"
    ...
    "target_sortie_traces": [
      ...
      },
      {
        ...
        "start_time": 172.199992
      }
    ],
    "true_dual_hash": "f9d86bbe51e11275",
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/run_bpc_future_external_timeout_batch.py --config BPC_future/configs/moon_trek_10_journey.yaml --time-limit 60.000000 --timeout-kill-after 30s --max-workers 1 --results-csv BPC_future/results/gat_same_run_random_wave_ord6_high_stratified_worker_ab_20260615/task010_mainline_no_regression_gat_kept/results.csv --log-dir BPC_future/results/gat_same_run_random_wave_ord6_high_stratified_worker_ab_20260615/task010_mainline_no_regression_gat_kept/logs --solution-dir BPC_future/results/gat_same_run_random_wave_ord6_high_stratified_worker_ab_20260615/task010_mainline_no_regression_gat_kept/solutions --run-log-dir BPC_future/results/gat_same_run_random_wave_ord6_high_stratified_worker_ab_20260615/task010_mainline_no_regression_gat_kept/run_logs --quiet --instances BPC_future/logical_graph/tasks_010/sector-wave/apollo15_20km/apollo15_20km_sector-wave_randomtw_tasks010_01_seed51001_logical_graph.json BPC_future/logical_graph/tasks_010/sector-wave/tranquillitatis_balmer_like_20km/tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks010_01_seed51001_logical_graph.json
```

### task020_apollo15_20km_random_wave_randomtw_tasks020_06_seed61510_4bdbc33c25c0cc96_2_15_1_mainline_baseline
