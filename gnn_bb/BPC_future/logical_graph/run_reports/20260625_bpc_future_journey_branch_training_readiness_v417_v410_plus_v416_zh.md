...
target_wall = 200.0
row_count = 37
usable_counterfactual_training_count = 28
strict_full_replay_positive_count = 20
strict_full_replay_positive_context_count = 7
strict_full_replay_positive_instance_count = 6
strict_full_replay_positive_time_window_family_count = 3
target_200_positive_count = 11
target_200_positive_context_count = 5
target_200_positive_instance_count = 5
target_200_positive_time_window_family_count = 3
weak_positive_not_target_count = 9
regression_count = 8
local_only_hard_negative_count = 9
hard_negative_count = 8
right_censored_counterfactual_count = 9
timeout_resolved_count = 9
timeout_regression_count = 7
target_200_positive_holdout_context_count = 0
counterfactual_label_type_counts = {'budget_dominant_improvement': 1, 'local_only_hard_negative': 9, 'regression': 7, 'strong_positive': 20}
status_pair_counts = {'EXTERNAL_TIME_LIMIT->EXTERNAL_TIME_LIMIT': 1, 'EXTERNAL_TIME_LIMIT->OPTIMAL': 8, 'EXTERNAL_TIME_LIMIT->TIME_LIMIT': 1, 'OPTIMAL->EXTERNAL_TIME_LIMIT': 6, 'OPTIMAL->OPTIMAL': 12, 'OPTIMAL->TIME_LIMIT': 1, 'TIME_LIMIT->EXTERNAL_TIME_LIMIT': 4, 'TIME_LIMIT->OPTIMAL': 1, 'TIME_LIMIT->TIME_LIMIT': 3}
...
remaining_for_serious_training = {'target_200_positive_min': 9, 'hard_negative_min': 22, 'target_200_context_min': 3, 'target_200_instance_min': 3, 'holdout_context_min': 2}
remaining_for_optin_training = {'target_200_positive_min': 29, 'hard_negative_min': 52, 'target_200_context_min': 10, 'target_200_instance_min': 10, 'holdout_context_min': 3}
missing_for_pipeline_debug_training = {}
missing_for_sanity_training = {}
missing_for_serious_training = {'target_200_positive_min': 9, 'hard_negative_min': 22, 'target_200_context_min': 3, 'target_200_instance_min': 3, 'holdout_context_min': 2}
missing_for_optin_training = {'target_200_positive_min': 29, 'hard_negative_min': 52, 'target_200_context_min': 10, 'target_200_instance_min': 10, 'holdout_context_min': 3}
