...
output_dir = BPC_future/results/journey_tail_impact_training_rows_v170_v166_plus_v169_counterfactual_20260624
training_row_count = 22
raw_training_row_count = 22
...
tail_class_counts = {'tail_action_local_only_hard_negative': 2, 'tail_action_no_column': 20}
label_positive_counts = {'y_useful_tail_reduction': 0, 'y_tail_risk': 22, 'y_weak_negative_filtered': 0, 'y_completion_bound_tail': 7, 'y_early_branch_continues': 10, 'y_negative_chain_continues': 12, 'y_active_touch': 0, 'y_inactive_only': 0, 'y_child_negative_pricing_events': 14, 'y_child_completion_bound_retries': 9, 'y_child_early_branch_triggers': 10, 'y_tail_action_no_column': 20, 'y_tail_action_counterfactual': 2, 'y_local_tail_improved': 2, 'y_whole_run_improved': 0, 'y_local_improved_but_whole_run_not': 2, 'y_timeout_resolved': 0, 'y_timeout_regression': 0, 'y_right_censored_counterfactual': 2, 'y_child_unstarted': 8, 'y_subtree_no_column_chain': 10, 'y_late_true_negative': 0, 'y_late_active_support_changing': 0, 'y_late_inactive_only': 0, 'y_late_weak_filtered': 0}
regression_label_totals = {'child_negative_pricing_events': 126, 'child_completion_bound_retries': 81, 'child_early_branch_triggers': 40, 'child_unstarted': 15, 'subtree_no_column_chain': 40, 'late_true_negative': 0, 'late_active_support_changing': 0, 'late_inactive_only': 0, 'late_weak_filtered': 0, 'tail_action_counterfactual': 2, 'local_tail_improved': 2, 'whole_run_improved': 0, 'local_improved_but_whole_run_not': 2, 'right_censored_counterfactual': 2}
