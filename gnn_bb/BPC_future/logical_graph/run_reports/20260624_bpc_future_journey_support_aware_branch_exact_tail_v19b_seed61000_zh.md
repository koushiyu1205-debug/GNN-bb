...
output_dir = BPC_future/results/journey_support_aware_branch_exact_tail_v19b_seed61000_20260624
log_count = 1
admission_event_count = 2
support_enabled_event_count = 0
min_depth = 1
min_time = 0.0
pricing_kind_prefixes = ['exact']
total_candidate_journeys = 3
total_true_negative_journeys = 0
total_support_active_journeys = 0
total_support_new_journeys = 0
...
```json
{
  "support_context_missing_or_disabled": 2
}
```
