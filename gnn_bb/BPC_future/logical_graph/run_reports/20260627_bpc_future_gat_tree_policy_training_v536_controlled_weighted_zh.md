...
```text
dataset_dir = BPC_future/data/gat_branch_action_sanity/v535_tree_policy_v534_controlled_weighted_dataset_20260627
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v535_tree_policy_v534_controlled_weighted_dataset_20260627/gat_tree_policy_v536_controlled_weighted.pt
sample_count = 967
train_sample_count = 967
validation_sample_count = 0
branch_priority_label_counts = {'not_walltime_gain': 0, 'walltime_gain_positive': 0}
row_kind_counts = {'tree_policy_hard_negative': 936, 'tree_policy_positive': 31}
epochs = 16
loss_multipliers = {'branch_priority': 0.0, 'branch_positive': 1.0, 'tail_aux': 0.0, 'walltime_gain': 0.0, 'child_proof_cpu': 0.0, 'time_to_certificate': 0.0, 'tree_policy': 0.5, 'tree_policy_pairwise': 8.0, 'tree_policy_pairwise_margin': 0.8}
