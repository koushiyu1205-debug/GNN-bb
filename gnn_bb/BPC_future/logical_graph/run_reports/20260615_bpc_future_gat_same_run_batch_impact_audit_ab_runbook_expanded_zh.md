...
[
  {
    "baseline_csv": "BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/task005_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/task005_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "sector-wave",
  ...
  {
    "baseline_csv": "BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/task010_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/task010_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "sector-wave",
  ...
  {
    "baseline_csv": "BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/task020_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/task020_capture/results.csv",
    "instance_count": 12,
    "instances": [
      {
        "family": "sector-wave",
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/build_gat_same_run_target_priority_candidates.py --decision-records BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/same_run_gat_knn_ood_audit/decision_records.jsonl --output-dir BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/delay_queue_target_candidates --report BPC_future/results/gat_same_run_batch_impact_audit_ab_runbook_expanded_20260615/delay_queue_target_candidates_zh.md --max-candidates 12 --delay-queue-only
```
