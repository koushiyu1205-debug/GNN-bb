...
```text
dataset_dir = BPC_future/data/gat_branch_action_sanity/v501_tree_policy_context_competitor_dataset_20260627
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v501_tree_policy_context_competitor_dataset_20260627/gat_tree_policy_v502_context_competitor.pt
sample_count = 189
train_sample_count = 184
...
epochs = 15
loss_multipliers = {'branch_priority': 0.0, 'branch_positive': 1.0, 'tail_aux': 0.0, 'walltime_gain': 0.0, 'child_proof_cpu': 0.0, 'time_to_certificate': 0.0, 'tree_policy': 0.5, 'tree_policy_pairwise': 2.0, 'tree_policy_pairwise_margin': 0.75}
