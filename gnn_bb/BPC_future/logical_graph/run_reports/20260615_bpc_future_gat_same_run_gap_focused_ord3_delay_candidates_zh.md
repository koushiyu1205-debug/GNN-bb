...
```json
{
  ...
  "candidate_replacement_like_proxy_count": 1,
  ...
  "exclude_existing_roi_jsonl": "BPC_future/results/gat_same_run_combined_plus_seed_cross_family_v5_worker_roi_dataset_20260615/gat_worker_roi_rows.jsonl",
  "existing_roi_target_count": 37,
