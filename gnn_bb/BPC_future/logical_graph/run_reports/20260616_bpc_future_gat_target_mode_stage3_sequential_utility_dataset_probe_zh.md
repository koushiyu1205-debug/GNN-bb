...
batch_type_counts = {'replacement_heavy': 2}
pairwise_context_stats = {'context_count': 2, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1, 'sample_count': 2, 'same_context_comparable_pair_count': 0, 'roi_diverse_context_count': 0, 'positive_negative_label_pair_count': 0, 'by_family': {'sector-wave': {'sample_count': 2, 'context_count': 2, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1}}, 'by_task_count': {'20': {'sample_count': 2, 'context_count': 2, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1}}}
ranking_ready = false
