...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v447_v445_forced_root_top3_walltime_20260626
target_wall = 200.0
wall_cap = 600.0
...
raw_row_count = 3
sample_count = 3
row_kind_counts = {'changed_timeout_no_effect_hard_negative': 2, 'walltime_gain_positive': 1}
branch_priority_label_counts = {'not_walltime_gain': 2, 'walltime_gain_positive': 1}
target_wall_crossing_label_counts = {'not_target_wall_crossing': 3}
tail_improved_aux_label_counts = {'tail_not_improved': 3}
skipped_counts = {}
instance_count = 3
family_count = 1
