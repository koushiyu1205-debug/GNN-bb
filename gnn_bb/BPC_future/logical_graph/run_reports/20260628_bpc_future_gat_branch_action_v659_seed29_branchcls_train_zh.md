...
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v658_all_counterfactual_delta_rows_20260628/gat_branch_action_v659_branchcls_seed29.pt
sample_count = 206
train_sample_count = 161
validation_sample_count = 45
...
train_branch_priority_metrics = {'weighted_row_count': 154.0, 'positive_count': 41.0, 'negative_count': 113.0, 'tp': 24.0, 'fp': 3.0, 'fn': 17.0, 'tn': 110.0, 'precision': 0.8888888888888888, 'recall': 0.5853658536585366, 'f1': 0.7058823529411764, 'mean_score': 0.35384134254750926}
validation_branch_priority_metrics = {'weighted_row_count': 40.0, 'positive_count': 13.0, 'negative_count': 27.0, 'tp': 0.0, 'fp': 0.0, 'fn': 13.0, 'tn': 27.0, 'precision': 0.0, 'recall': 0.0, 'f1': 0.0, 'mean_score': 0.27937636338174343}
