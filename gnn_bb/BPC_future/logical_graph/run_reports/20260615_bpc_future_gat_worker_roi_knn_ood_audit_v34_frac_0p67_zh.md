...
```json
{
  "decision_reason_counts": {
    "high_priority": 33,
    "neighbor_delay_fraction_too_high": 9,
  ...
  "validation_metrics": {
    ...
    "add_precision": 0.42424242424242425,
    "add_recall": 0.8235294117647058,
    "false_high_priority_rate": 0.5277777777777778,
    "false_negative_delay_queue": 3,
    "false_positive_high_priority": 19,
    "predicted_delay_queue": 20,
    "predicted_high_priority": 33,
    "total": 53,
    "true_negative_delay_queue": 17,
    "true_positive_high_priority": 14
  }
}
```
