...
output_dir = BPC_future/results/journey_tail_impact_training_rows_force26_depth3_49_20260623
training_row_count = 9
raw_training_row_count = 9
...
label_positive_counts = {'y_useful_tail_reduction': 0, 'y_tail_risk': 9, 'y_weak_negative_filtered': 5, 'y_completion_bound_tail': 1, 'y_early_branch_continues': 3, 'y_negative_chain_continues': 0, 'y_active_touch': 1, 'y_inactive_only': 3, 'y_child_negative_pricing_events': 4, 'y_child_completion_bound_retries': 1, 'y_child_early_branch_triggers': 3}
regression_label_totals = {'child_negative_pricing_events': 19, 'child_completion_bound_retries': 1, 'child_early_branch_triggers': 3}
