...
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v658_all_counterfactual_delta_rows_20260628/gat_branch_action_v659_branchcls_seed13.pt
sample_count = 206
...
train_branch_priority_metrics = {'weighted_row_count': 167.0, 'positive_count': 50.0, 'negative_count': 117.0, 'tp': 34.0, 'fp': 42.0, 'fn': 16.0, 'tn': 75.0, 'precision': 0.4473684210526316, 'recall': 0.68, 'f1': 0.5396825396825397, 'mean_score': 0.4811113355402461}
validation_branch_priority_metrics = {'weighted_row_count': 27.0, 'positive_count': 4.0, 'negative_count': 23.0, 'tp': 0.0, 'fp': 10.0, 'fn': 4.0, 'tn': 13.0, 'precision': 0.0, 'recall': 0.0, 'f1': 0.0, 'mean_score': 0.4659955037964715}
