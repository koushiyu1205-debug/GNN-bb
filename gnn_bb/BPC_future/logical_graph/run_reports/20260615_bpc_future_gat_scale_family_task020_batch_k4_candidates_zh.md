...
```json
{
  ...
  "candidate_family_region_counts": {
    ...
    "random-wave|tranquillitatis_balmer_like_20km": 20
  },
  "candidate_impact_bucket_counts": {
    "new_support_changing": 32
  },
  "candidate_new_task_set_count": 32,
  "candidate_policy": {
  ...
  "candidate_support_changing_proxy_count": 32,
