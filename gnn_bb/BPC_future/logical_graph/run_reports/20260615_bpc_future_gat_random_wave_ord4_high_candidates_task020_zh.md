...
```json
{
  ...
  "candidate_family_region_counts": {
    "random-wave|tranquillitatis_balmer_like_20km": 2
  },
  "candidate_impact_bucket_counts": {
    "new_support_changing": 2
  },
  "candidate_new_task_set_count": 2,
  "candidate_policy": {
  ...
  "candidate_support_changing_proxy_count": 2,
  ...
  "exclude_existing_roi_jsonl": "BPC_future/results/gat_same_run_combined_plus_seed_cross_family_v6_worker_roi_dataset_20260615/gat_worker_roi_rows.jsonl",
  "existing_roi_target_count": 41,
  ...
  "skipped_counts": {
    "decision_not_high_priority": 8,
    "task_count_not_selected": 2
  }
}
```
