...
focused_pair_gate_summary = {'focused_row_count': 9, 'context_count': 3, 'contexts_with_positive_and_negative': 2, 'positive_row_count': 2, 'negative_row_count': 7, 'ambiguous_row_count': 0, 'pair_count': 4, 'raw_pair_pass_count': 3, 'admission_pair_pass_count': 3, 'delay_risk_pair_pass_count': 2, 'strict_pair_pass_count': 1, 'raw_pair_pass_rate': 0.75, 'admission_pair_pass_rate': 0.75, 'delay_risk_pair_pass_rate': 0.5, 'strict_pair_pass_rate': 0.25, 'label_counts': {'delay_or_hard_negative': 7, 'positive_high_priority': 2}, 'family_counts': {'sector-wave': 9}, 'primary': 'candidate_head_context_ranking_failure'}
...
best_epoch = 1
selected_validation_loss = 3.795448833479654
best_loss_epoch = 1
best_validation_loss = 3.795448833479654
...
```json
{
  "family_holdout_metrics": {
    ...
    "family_holdout_min_high_roi_capture_rate": 0.1111111111111111,
    ...
    "family_holdout_per_family": {
      ...
      "sector-wave": {
        "accepted_batch_count": 2,
        "accepted_batch_roi": 1.0688260197639465,
  ...
  "focused_pair_gate": {
    ...
    "pair_rows": [
      {
        "admission_margin": 6.252527236938477e-05,
        "admission_positive_above_negative": true,
        "context_hash": "ac15bc4e7e3d6fff",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_02_seed61104|ac15bc4e7e3d6fff",
        "delay_risk_margin": -0.0076485276222229,
        "family": "sector-wave",
        ...
        "raw_margin": 6.252527236938477e-05,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0004954040050506592,
        "admission_positive_above_negative": true,
        "context_hash": "ac15bc4e7e3d6fff",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_02_seed61104|ac15bc4e7e3d6fff",
        "delay_risk_margin": -0.0010298490524291992,
        "family": "sector-wave",
        ...
        "raw_margin": 0.0004954040050506592,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.0007468163967132568,
        "admission_positive_above_negative": false,
        "context_hash": "79fde658840fe2b8",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_08_seed61718|79fde658840fe2b8",
        "delay_risk_margin": 0.0016003251075744629,
        "family": "sector-wave",
        ...
        "raw_margin": -0.0007468163967132568,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 5.510449409484863e-05,
        "admission_positive_above_negative": true,
        "context_hash": "79fde658840fe2b8",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_08_seed61718|79fde658840fe2b8",
        "delay_risk_margin": 2.4437904357910156e-05,
        "family": "sector-wave",
        ...
        "raw_margin": 5.510449409484863e-05,
        "raw_positive_above_negative": true
      }
    ],
    "production_ready": false,
  ...
  "threshold_search": {
    ...
    "selected_metrics": {
      ...
      "accepted_batch_rate": 0.0547945205479452,
      "accepted_batch_roi": 1.0203525871038437,
      "accepted_batch_roi_ci_low": 0.7272379493695975,
      "accepted_batch_roi_over_baseline": 1.0203525871038437,
      "accepted_batch_roi_over_baseline_ci_low": 0.7272379493695975,
      "accepted_batch_roi_over_best_rc_baseline": 1.0203525871038437,
      "accepted_batch_roi_over_best_rc_baseline_ci_low": 0.7272379493695975,
      "accepted_batch_roi_over_old_gat_baseline": 1.0203525871038437,
      "accepted_batch_roi_over_old_gat_baseline_ci_low": 0.7272379493695975,
      "accepted_batch_roi_over_random_baseline": 1.0203525871038437,
      "accepted_batch_roi_over_random_baseline_ci_low": 0.7272379493695975,
      ...
      "batch_threshold": 0.4841189682483673,
      "batch_thresholds_by_family": {
        "random-wave": 0.4841189682483673,
        "sector-wave": 0.0
      },
      ...
      "candidate_score_threshold_blocked_count": 734,
      "candidate_threshold": 0.5017145276069641,
      "checkpoint_gate_pass": false,
      ...
      "delay_rate": 0.9452054794520548,
      "evaluated_candidate_count": 912,
      "expected_trajectory_utility": 1.0578525871038438,
      ...
      "high_priority_precision_ci_low": 0.9788739210389702,
      "high_priority_prediction_count": 178,
      "high_priority_true_positive_count": 178,
  ...
  "train_deployment_metrics": {
    ...
    "accepted_batch_precision": 1.0,
    "accepted_batch_rate": 0.05956112852664577,
    "accepted_batch_roi": 1.4450537658933746,
    "accepted_batch_roi_ci_low": 0.6544123765114349,
    "accepted_batch_roi_over_baseline": 1.4450537658933746,
    "accepted_batch_roi_over_baseline_ci_low": 0.6544123765114349,
    "accepted_batch_roi_over_best_rc_baseline": 1.4450537658933746,
    "accepted_batch_roi_over_best_rc_baseline_ci_low": 0.6544123765114349,
    "accepted_batch_roi_over_old_gat_baseline": 1.4450537658933746,
    "accepted_batch_roi_over_old_gat_baseline_ci_low": 0.6544123765114349,
    "accepted_batch_roi_over_random_baseline": 1.4450537658933746,
    "accepted_batch_roi_over_random_baseline_ci_low": 0.6544123765114349,
    "baseline_roi_ci_high": 0.0,
    "baseline_roi_ci_high_source": "configured_point_estimate_no_baseline_distribution",
    "baseline_selection_roi": 0.0,
    "batch_threshold": 0.4841189682483673,
    ...
    "candidate_rescue_window_promoted_count": 0,
    "candidate_risk_adjusted_suppressed_count": 0,
    "candidate_score_threshold_blocked_count": 1613,
    "candidate_threshold": 0.5017145276069641,
    "checkpoint_gate_pass": false,
    "checkpoint_gate_reject_reasons": [
      "safe_precision_ci_low_below_threshold_or_not_measurable",
    ...
    "delay_rate": 0.9404388714733543,
    "evaluated_candidate_count": 3791,
    "expected_trajectory_utility": 1.484527450103901,
    "false_high_priority_on_delay": 0.31875,
    "false_high_priority_on_delay_count": 102,
    "false_safe_rate_label_unsafe": 0.0,
    "false_safe_rate_union": 0.31875,
    "family_delay_fallback_families": [],
    "family_holdout_min_accepted_high_roi_count": 0,
    "family_holdout_min_accepted_roi": 0.9405616872012615,
    ...
    "family_holdout_per_family": {
      ...
      "random-wave": {
        ...
        "accepted_batch_roi": 2.0056005199957223,
      ...
      "sector-wave": {
        ...
        "accepted_batch_roi": 0.9405616872012615,
    ...
    "high_priority_precision": 0.953168044077135,
    "high_priority_precision_ci_low": 0.9434688699864692,
    "high_priority_prediction_count": 2178,
    "high_priority_true_positive_count": 2076,
    "max_accepted_bad_mode_count": 0,
    "min_family_accepted_high_roi_count": 0,
    "min_family_high_roi_capture_rate": 0.0,
    "old_gat_baseline_accepted_batch_roi": 0.0,
