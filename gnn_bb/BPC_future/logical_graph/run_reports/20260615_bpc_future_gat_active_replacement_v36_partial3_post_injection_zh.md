...
record_count = 3
skipped_missing_log_count = 6
target_injection_success_count = 3
target_returned_journeys_sum = 9.0
target_active_changed_task_set_sum = 3.0
target_inactive_changed_task_set_sum = 6.0
immediate_objective_improved_count = 3
immediate_vs_baseline_same_iter_improved_count = 0
worker_next_objective_delta_sum = -16.411707018
worker_next_dual_l1_delta_mean = 21.666484447666665
worker_next_objective_vs_baseline_same_iter_delta_sum = 166.40559400000006
followup_pricing_event_sum = 55.0
followup_exact_event_sum = 25.0
followup_completion_retry_event_sum = 6.0
context_mismatch_skip_sum = 19.0
final_positive_roi_count = 3
final_negative_roi_count = 0
strict_trajectory_positive_count = 0
strict_trajectory_negative_count = 3
