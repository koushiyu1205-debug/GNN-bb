...
output_dir = BPC_future/results/journey_branch_counterfactual_delta_v243_v240_seed61821_top_proxy_full_replay_20260624
runbook_entry_count = 8
...
label_positive_counts = {'y_counterfactual_proof_cost_improved': 2, 'y_counterfactual_proof_cost_proxy_improved': 2, 'y_counterfactual_regression': 1, 'y_counterfactual_timeout_regression': 1, 'y_counterfactual_wall_improved': 2}
counterfactual_label_type_counts = {'regression': 1, 'strong_positive': 2}
status_pair_counts = {'OPTIMAL->EXTERNAL_TIME_LIMIT': 1, 'OPTIMAL->OPTIMAL': 2}
