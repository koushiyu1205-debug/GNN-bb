...
sample_collection_gaps = [{'name': 'positive_training_label_count', 'observed': 2, 'required': 5, 'missing': 3}, {'name': 'negative_training_label_count', 'observed': 2, 'required': 5, 'missing': 3}, {'name': 'positive_family_count', 'observed': 1, 'required': 2, 'missing': 1}]
