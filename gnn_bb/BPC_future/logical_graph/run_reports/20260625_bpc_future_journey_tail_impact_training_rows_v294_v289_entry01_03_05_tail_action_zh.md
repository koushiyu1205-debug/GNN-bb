...
output_dir = BPC_future/results/journey_tail_impact_training_rows_v294_v289_entry01_03_05_tail_action_20260625
...
tail_class_counts = {'tail_action_no_column': 3}
counterfactual_label_type_counts = {}
label_positive_counts = {'y_useful_tail_reduction': 0, 'y_tail_risk': 3, 'y_weak_negative_filtered': 0, 'y_completion_bound_tail': 3, 'y_early_branch_continues': 0, 'y_negative_chain_continues': 3, 'y_active_touch': 0, 'y_inactive_only': 0, 'y_child_negative_pricing_events': 3, 'y_child_completion_bound_retries': 3, 'y_child_early_branch_triggers': 0, 'y_tail_action_no_column': 3, 'y_tail_action_counterfactual': 0, 'y_local_tail_improved': 0, 'y_whole_run_improved': 0, 'y_budget_dominant_improvement': 0, 'y_local_improved_but_whole_run_not': 0, 'y_timeout_resolved': 0, 'y_timeout_regression': 0, 'y_right_censored_counterfactual': 0, 'y_child_unstarted': 0, 'y_subtree_no_column_chain': 0, 'y_tail_min_fill_completion_retry': 0, 'y_tail_min_fill_found_negative': 1, 'y_tail_min_fill_certified_no_negative': 3, 'y_late_true_negative': 0, 'y_late_active_support_changing': 0, 'y_late_inactive_only': 0, 'y_late_weak_filtered': 0}
regression_label_totals = {'child_negative_pricing_events': 71, 'child_completion_bound_retries': 61, 'child_early_branch_triggers': 0, 'child_unstarted': 0, 'subtree_no_column_chain': 0, 'late_true_negative': 0, 'late_active_support_changing': 0, 'late_inactive_only': 0, 'late_weak_filtered': 0, 'tail_action_counterfactual': 0, 'local_tail_improved': 0, 'whole_run_improved': 0, 'budget_dominant_improvement': 0, 'local_improved_but_whole_run_not': 0, 'right_censored_counterfactual': 0, 'tail_min_fill_completion_retry': 0, 'tail_min_fill_found_negative': 1, 'tail_min_fill_certified_no_negative': 3}
