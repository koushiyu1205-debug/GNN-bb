...
```json
{
  "decision_reason_counts": {
    "high_priority": 83,
    "neighbor_delay_fraction_too_high": 45,
    "score_below_threshold": 36
  },
  "production_block_reasons": [
    "validation_false_high_priority_rate_above_max",
    "validation_candidate_not_ready"
  ],
  "safe_radius": 1.8795575080796425,
  "threshold": 0.4919646978378296,
  "validation_metrics": {
    "accuracy": 0.6216216216216216,
    "add_precision": 0.48,
    "add_recall": 0.9230769230769231,
    "false_high_priority_rate": 0.5416666666666666,
    "false_negative_delay_queue": 1,
    "false_positive_high_priority": 13,
    "predicted_delay_queue": 12,
    "predicted_high_priority": 25,
    "total": 37,
