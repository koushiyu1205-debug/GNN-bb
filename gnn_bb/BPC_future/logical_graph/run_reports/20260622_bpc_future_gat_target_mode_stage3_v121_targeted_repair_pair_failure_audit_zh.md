...
```text
summary = BPC_future/results/gat_batch_impact_focused_pair_failure_audit_v121_targeted_repair_20260622/summary.json
pair_rows = BPC_future/results/gat_batch_impact_focused_pair_failure_audit_v121_targeted_repair_20260622/focused_pair_failure_rows.jsonl
context_rows = BPC_future/results/gat_batch_impact_focused_pair_failure_audit_v121_targeted_repair_20260622/focused_pair_failure_contexts.jsonl
```
