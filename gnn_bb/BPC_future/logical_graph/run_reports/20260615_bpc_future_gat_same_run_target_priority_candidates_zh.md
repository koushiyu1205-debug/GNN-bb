...
从 same-run GAT+kNN/OOD 的 HIGH_PRIORITY 决策中抽取 target-priority worker 候选。
...
- 候选来自 same-context batch-impact 的 HIGH_PRIORITY 决策；
...
```json
{
  ...
  "checks": {
    ...
    "all_candidates_high_priority": true,
