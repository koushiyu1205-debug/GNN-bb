...
target_wall = 200.0
row_count = 26
usable_counterfactual_training_count = 18
strict_full_replay_positive_count = 12
...
counterfactual_label_type_counts = {'budget_dominant_improvement': 1, 'local_only_hard_negative': 7, 'regression': 6, 'strong_positive': 12}
status_pair_counts = {'EXTERNAL_TIME_LIMIT->EXTERNAL_TIME_LIMIT': 1, 'EXTERNAL_TIME_LIMIT->OPTIMAL': 5, 'EXTERNAL_TIME_LIMIT->TIME_LIMIT': 1, 'OPTIMAL->EXTERNAL_TIME_LIMIT': 5, 'OPTIMAL->OPTIMAL': 7, 'OPTIMAL->TIME_LIMIT': 1, 'TIME_LIMIT->EXTERNAL_TIME_LIMIT': 4, 'TIME_LIMIT->TIME_LIMIT': 2}
