...
train_label_counts = {'delay_queue': 61, 'high_priority': 183}
...
```json
{
  "decision_reason_counts": {
    ...
    "no_candidate_high_priority_delay_queue": 108
  },
  "decision_scope_metrics": {
    "accepted_batch_count": 9,
    "accepted_batch_rate": 0.07563025210084033,
    "accepted_batch_roi": 13.5515608853764,
    "accepted_batch_roi_ci_low": 4.003538240157702,
  ...
  "validation_family_metrics": {
    ...
    "per_family": {
      ...
      "sector-wave": {
        ...
        "accepted_batch_roi": 15.107258789241314,
        "accepted_batch_roi_ci_low": 4.847727997802547,
        ...
        "decision_reason_counts": {
          ...
          "high_priority": 8,
          "knn_delay_fraction_delay_queue": 1,
          "no_candidate_high_priority_delay_queue": 51
        },
        "delay_count": 53,
