...
negative_region_counts = {'apollo15_20km': 2, 'tranquillitatis_balmer_like_20km': 3}
...
sample_collection_gaps = [{'name': 'positive_training_label_count', 'observed': 0, 'required': 5, 'missing': 5}, {'name': 'positive_instance_count', 'observed': 0, 'required': 2, 'missing': 2}, {'name': 'positive_family_count', 'observed': 0, 'required': 2, 'missing': 2}, {'name': 'positive_region_count', 'observed': 0, 'required': 2, 'missing': 2}]
