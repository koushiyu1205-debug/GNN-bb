...
```json
{
  ...
  "csv_path": "BPC_future/results/cbf_family_capture_worklist_global_available_20260614/datasets/greedy-anchor/cbf_gate_transitions.csv",
  "input_file_count": 2,
  "jsonl_path": "BPC_future/results/cbf_family_capture_worklist_global_available_20260614/datasets/greedy-anchor/cbf_gate_transitions.jsonl",
  "row_count": 4,
