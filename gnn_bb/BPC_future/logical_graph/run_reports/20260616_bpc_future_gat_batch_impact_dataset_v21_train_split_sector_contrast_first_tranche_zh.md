...
batch_label_counts = {'non_improving': 94, 'roi_positive': 269}
candidate_label_counts = {'delay_queue': 377, 'high_priority': 4289}
batch_type_counts = {'new_task_set': 310, 'replacement_heavy': 53}
pairwise_context_stats = {'context_count': 295, 'multi_context_count': 16, 'same_context_pair_count': 208, 'largest_context_size': 8, 'sample_count': 363, 'same_context_comparable_pair_count': 203, 'roi_diverse_context_count': 16, 'positive_negative_label_pair_count': 72, 'by_family': {'greedy-anchor': {'sample_count': 54, 'context_count': 54, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1}, 'random-wave': {'sample_count': 209, 'context_count': 190, 'multi_context_count': 5, 'same_context_pair_count': 55, 'largest_context_size': 7}, 'sector-wave': {'sample_count': 100, 'context_count': 51, 'multi_context_count': 11, 'same_context_pair_count': 153, 'largest_context_size': 8}}, 'by_task_count': {'5': {'sample_count': 2, 'context_count': 2, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1}, '10': {'sample_count': 8, 'context_count': 8, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1}, '20': {'sample_count': 180, 'context_count': 119, 'multi_context_count': 14, 'same_context_pair_count': 186, 'largest_context_size': 8}, '30': {'sample_count': 76, 'context_count': 76, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1}, '50': {'sample_count': 96, 'context_count': 89, 'multi_context_count': 2, 'same_context_pair_count': 22, 'largest_context_size': 7}, '100': {'sample_count': 1, 'context_count': 1, 'multi_context_count': 0, 'same_context_pair_count': 0, 'largest_context_size': 1}}}
ranking_ready = true
ranking_blockers = []
