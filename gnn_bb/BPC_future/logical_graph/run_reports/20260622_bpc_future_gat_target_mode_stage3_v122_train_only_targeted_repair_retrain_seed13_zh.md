...
loss_options = {'false_high_priority_loss_multiplier': 8.0, 'bad_mode_loss_multiplier': 2.0, 'regression_loss_multiplier': 0.15, 'hard_roi_loss_multiplier': 1.0, 'hard_roi_candidate_loss_multiplier': 0.5, 'hard_roi_positive_candidate_loss_multiplier': 0.0, 'hard_roi_positive_group_balance': 'none', 'hard_roi_positive_group_weight_power': 0.5, 'max_hard_roi_positive_group_weight': 4.0, 'hard_roi_positive_group_counts': {}, 'hard_roi_positive_group_weights': {}, 'candidate_delay_loss_multiplier': 1.25, 'hard_roi_negative_delay_loss_multiplier': 1.25, 'hard_roi_safe_delay_loss_multiplier': 0.35, 'candidate_admission_score_mode': 'risk_adjusted_product', 'candidate_delay_score_penalty': 1.5, 'candidate_rescue_raw_score_threshold': 1.0, 'candidate_rescue_delay_risk_threshold': 1.0, 'candidate_rescue_delay_score_penalty': 0.0, 'hard_roi_threshold': 0.65, 'pairwise_ranking_loss_multiplier': 1.0, 'pairwise_candidate_ranking_loss_multiplier': 0.75, 'pairwise_false_delay_contrast_loss_multiplier': 0.5, 'pairwise_delay_risk_contrast_loss_multiplier': 1.0, 'focused_pair_loss_multiplier': 1.25, 'focused_pair_candidate_loss_multiplier': 2.0, 'focused_pair_admission_loss_multiplier': 3.0, 'focused_pair_delay_risk_loss_multiplier': 3.0, 'focused_pair_batch_loss_multiplier': 1.0, 'focused_pair_boost_row_indices_file': 'BPC_future/results/gat_batch_impact_v122_train_only_targeted_repair_selectors_20260622/focused_boost_row_indices.json', 'focused_pair_boost_row_indices': [176, 177, 398, 779, 780, 781, 782, 783, 842, 843, 846, 847], 'focused_pair_boost_loss_multiplier': 2.0, 'targeted_safe_positive_row_indices_file': 'BPC_future/results/gat_batch_impact_v122_train_only_targeted_repair_selectors_20260622/targeted_safe_positive_row_indices.json', 'targeted_safe_positive_row_indices': [5, 176, 177, 252, 408, 409, 461, 648, 751, 779, 780, 781, 782, 787, 791, 836, 840, 841, 842, 847, 890, 891, 896, 897, 912, 913, 959, 963, 977, 1018, 1019, 1022, 1128, 1132, 1146], 'targeted_safe_positive_loss_multiplier': 0.75, 'focused_pair_row_index_min': None, 'focused_pair_row_indices_file': 'BPC_future/results/gat_batch_impact_focused_tranche_mining_v120_v119_clean_20260622/focused_row_indices.json', 'focused_pair_row_indices': [106, 109, 133, 176, 177, 183, 326, 331, 362, 390, 391, 392, 398, 402, 411, 412, 413, 425, 426, 509, 514, 767, 768, 770, 779, 780, 781, 782, 783, 792, 793, 795, 796, 797, 798, 799, 808, 809, 810, 811, 812, 813, 814, 815, 842, 843, 844, 845, 846, 847, 848, 849, 888, 889, 918, 919, 922, 923, 956, 958, 959, 960, 961, 962, 963, 966, 967, 969, 978, 979, 980, 981, 982, 983, 985, 990, 991, 992, 993, 998, 999, 1001, 1010, 1011, 1012, 1018, 1019, 1020, 1021, 1022, 1023, 1024, 1025, 1040, 1041, 1042, 1050, 1051, 1053, 1097, 1104, 1123], 'pairwise_roi_margin': 0.05, 'min_pairwise_roi_delta': 1e-06, 'max_grad_norm': 5.0}
...
focused_pair_batch_loss_multiplier = 1.0
focused_pair_boost_row_indices_file = BPC_future/results/gat_batch_impact_v122_train_only_targeted_repair_selectors_20260622/focused_boost_row_indices.json
focused_pair_boost_row_indices_count = 12
focused_pair_boost_loss_multiplier = 2.0
targeted_safe_positive_row_indices_file = BPC_future/results/gat_batch_impact_v122_train_only_targeted_repair_selectors_20260622/targeted_safe_positive_row_indices.json
targeted_safe_positive_row_indices_count = 35
...
focused_pair_gate_summary = {'focused_row_count': 102, 'context_count': 30, 'contexts_with_positive_and_negative': 30, 'positive_row_count': 56, 'negative_row_count': 46, 'ambiguous_row_count': 0, 'pair_count': 78, 'raw_pair_pass_count': 61, 'admission_pair_pass_count': 63, 'delay_risk_pair_pass_count': 61, 'strict_pair_pass_count': 59, 'raw_pair_pass_rate': 0.782051282051282, 'admission_pair_pass_rate': 0.8076923076923077, 'delay_risk_pair_pass_rate': 0.782051282051282, 'strict_pair_pass_rate': 0.7564102564102564, 'label_counts': {'delay_or_hard_negative': 46, 'positive_high_priority': 56}, 'family_counts': {'greedy-anchor': 33, 'random-wave': 47, 'sector-wave': 22}, 'primary': 'candidate_head_context_ranking_failure'}
...
best_epoch = 2
selected_validation_loss = 5.382676405434259
best_loss_epoch = 4
best_validation_loss = 4.455911147662029
...
```json
{
  "family_holdout_metrics": {
    ...
    "family_holdout_per_family": {
      ...
      "random-wave": {
        ...
        "accepted_batch_roi": 18.64091314971447,
        "accepted_high_roi_count": 10,
        "high_roi_capture_rate": 0.45454545454545453,
  ...
  "focused_pair_gate": {
    ...
    "gate": {
      ...
      "gate_pass": false,
      "observed": {
        "admission_pair_pass_rate": 0.8076923076923077,
        "delay_risk_pair_pass_rate": 0.782051282051282,
        "pair_count": 78,
        "raw_pair_pass_rate": 0.782051282051282,
    ...
    "pair_rows": [
      {
        "admission_margin": 0.029752110659640535,
        "admission_positive_above_negative": true,
        "context_hash": "b36178f6655c5f75",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_04_seed61308|b36178f6655c5f75",
        "delay_risk_margin": 0.03207683563232422,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.033160269260406494,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.02595880393837896,
        "admission_positive_above_negative": true,
        "context_hash": "b36178f6655c5f75",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_04_seed61308|b36178f6655c5f75",
        "delay_risk_margin": 0.028989046812057495,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.027130424976348877,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.02972646370606144,
        "admission_positive_above_negative": true,
        "context_hash": "b36178f6655c5f75",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_04_seed61308|b36178f6655c5f75",
        "delay_risk_margin": 0.03206250071525574,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 814,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.03311634063720703,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.025933156984799866,
        "admission_positive_above_negative": true,
        "context_hash": "b36178f6655c5f75",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_04_seed61308|b36178f6655c5f75",
        "delay_risk_margin": 0.028974711894989014,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 815,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.027086496353149414,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0063261974694049095,
        "admission_positive_above_negative": true,
        "context_hash": "7db256d4f7224cc6",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_05_seed61410|7db256d4f7224cc6",
        "delay_risk_margin": 0.008089691400527954,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.005994677543640137,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.02501759683905816,
        "admission_positive_above_negative": true,
        "context_hash": "7db256d4f7224cc6",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_05_seed61410|7db256d4f7224cc6",
        "delay_risk_margin": 0.040701210498809814,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 991,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.009752213954925537,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0018062696518272026,
        "admission_positive_above_negative": true,
        "context_hash": "7db256d4f7224cc6",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_05_seed61410|7db256d4f7224cc6",
        "delay_risk_margin": 0.0023206472396850586,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 991,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.0017348825931549072,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.005740998284416016,
        "admission_positive_above_negative": false,
        "context_hash": "f9d0b6b18a0a28d3",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_05_seed61410|f9d0b6b18a0a28d3",
        "delay_risk_margin": -0.007439136505126953,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.004982262849807739,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.004806208237059045,
        "admission_positive_above_negative": false,
        "context_hash": "f9d0b6b18a0a28d3",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_05_seed61410|f9d0b6b18a0a28d3",
        "delay_risk_margin": -0.006221264600753784,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.0041998326778411865,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.0007906573370109748,
        "admission_positive_above_negative": true,
        "context_hash": "84ae11479ed592d4",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_06_seed61512|84ae11479ed592d4",
        "delay_risk_margin": 0.0010122060775756836,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.0007566511631011963,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0020044054274565293,
        "admission_positive_above_negative": true,
        "context_hash": "84ae11479ed592d4",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_06_seed61512|84ae11479ed592d4",
        "delay_risk_margin": 0.0025715529918670654,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.0019220709800720215,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0018494662370758808,
        "admission_positive_above_negative": true,
        "context_hash": "39d7643d5a478407",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_07_seed61614|39d7643d5a478407",
        "delay_risk_margin": 0.0023714303970336914,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.0017728209495544434,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.030840388320208273,
        "admission_positive_above_negative": true,
        "context_hash": "39d7643d5a478407",
        "context_key": "apollo15_20km_greedy-anchor_randomtw_tasks020_07_seed61614|39d7643d5a478407",
        "delay_risk_margin": 0.04291963577270508,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 1041,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.02107653021812439,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.0036396177893962822,
        "admission_positive_above_negative": false,
        "context_hash": "62c86745ed2b3aaa",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_08_seed61715|62c86745ed2b3aaa",
        "delay_risk_margin": -0.002619236707687378,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.006235480308532715,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.0018503060543998695,
        "admission_positive_above_negative": false,
        "context_hash": "62c86745ed2b3aaa",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_08_seed61715|62c86745ed2b3aaa",
        "delay_risk_margin": -0.0013275742530822754,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 767,
        "negative_signature_ids": [
        ...
        "raw_margin": -0.0031624138355255127,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.013994693328020946,
        "admission_positive_above_negative": true,
        "context_hash": "1b5a36a64a700b58",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_10_seed61919|1b5a36a64a700b58",
        "delay_risk_margin": 0.01123899221420288,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.022455871105194092,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.013494060510717304,
        "admission_positive_above_negative": true,
        "context_hash": "1b5a36a64a700b58",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_10_seed61919|1b5a36a64a700b58",
        "delay_risk_margin": 0.010594934225082397,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 962,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.022016972303390503,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.013964910091666116,
        "admission_positive_above_negative": true,
        "context_hash": "1b5a36a64a700b58",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_10_seed61919|1b5a36a64a700b58",
        "delay_risk_margin": 0.011200696229934692,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 962,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.02242979407310486,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.001441481579259829,
        "admission_positive_above_negative": false,
        "context_hash": "4575716b3939cb89",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_10_seed61919|4575716b3939cb89",
        "delay_risk_margin": -0.001836538314819336,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.001373291015625,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.0004796675955984486,
        "admission_positive_above_negative": false,
        "context_hash": "4575716b3939cb89",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_10_seed61919|4575716b3939cb89",
        "delay_risk_margin": -0.0006121695041656494,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.0004576742649078369,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.002377944190593617,
        "admission_positive_above_negative": true,
        "context_hash": "ff6827bb236f4831",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_10_seed61919|ff6827bb236f4831",
        "delay_risk_margin": 0.006558716297149658,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.0029737651348114014,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.015994653986089236,
        "admission_positive_above_negative": false,
        "context_hash": "ff6827bb236f4831",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks020_10_seed61919|ff6827bb236f4831",
        "delay_risk_margin": -0.02293318510055542,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 956,
        "negative_signature_ids": [
        ...
        "raw_margin": -0.009389936923980713,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.019236041234068718,
        "admission_positive_above_negative": true,
        "context_hash": "9f80ae35ea87da5b",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks030_03_seed71204|9f80ae35ea87da5b",
        "delay_risk_margin": 0.021846145391464233,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.01285630464553833,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.005346147967435488,
        "admission_positive_above_negative": true,
        "context_hash": "9f80ae35ea87da5b",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks030_03_seed71204|9f80ae35ea87da5b",
        "delay_risk_margin": 0.00466156005859375,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 845,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.005998849868774414,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.01712849288463625,
        "admission_positive_above_negative": true,
        "context_hash": "9a2ca522ff49991c",
        "context_key": "apollo15_20km_random-wave_randomtw_tasks050_01_seed91000|9a2ca522ff49991c",
        "delay_risk_margin": 0.018714994192123413,
        "family": "random-wave",
        ...
        "raw_margin": 0.008408725261688232,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.01471114790343886,
        "admission_positive_above_negative": true,
        "context_hash": "ce3508e12ad69da7",
        "context_key": "apollo15_20km_sector-wave_randomtw_tasks020_07_seed61612|ce3508e12ad69da7",
        "delay_risk_margin": 0.017960011959075928,
        "family": "sector-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.01539662480354309,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.01471114790343886,
      ...
      {
        "admission_margin": 0.014225372196240121,
        "admission_positive_above_negative": true,
        "context_hash": "ce3508e12ad69da7",
        "context_key": "apollo15_20km_sector-wave_randomtw_tasks020_07_seed61612|ce3508e12ad69da7",
        "delay_risk_margin": 0.009707123041152954,
        "family": "sector-wave",
        "negative_roi": 0.0,
        "negative_row_index": 426,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.025419533252716064,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.01471114790343886,
      ...
      {
        "admission_margin": 0.012843884320860671,
        "admission_positive_above_negative": true,
        "context_hash": "1b9dab1b2a407abd",
        "context_key": "apollo15_20km_sector-wave_randomtw_tasks030_02_seed71102|1b9dab1b2a407abd",
        "delay_risk_margin": 0.010247528553009033,
        "family": "sector-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.020278453826904297,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.007827169407667312,
        "admission_positive_above_negative": true,
        "context_hash": "77bc967e4038b08b",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_05_seed61414|77bc967e4038b08b",
        "delay_risk_margin": 0.009900957345962524,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.007430016994476318,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.031114732157268177,
        "admission_positive_above_negative": true,
        "context_hash": "77bc967e4038b08b",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_05_seed61414|77bc967e4038b08b",
        "delay_risk_margin": 0.04309549927711487,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 1011,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.021399736404418945,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.001742505723798804,
        "admission_positive_above_negative": true,
        "context_hash": "67925c0d2fd4abde",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520|67925c0d2fd4abde",
        "delay_risk_margin": 0.0022500455379486084,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.0013820827007293701,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.0027128307924813855,
        "admission_positive_above_negative": false,
        "context_hash": "67925c0d2fd4abde",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520|67925c0d2fd4abde",
        "delay_risk_margin": -0.0034747421741485596,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 1021,
        "negative_signature_ids": [
        ...
        "raw_margin": -0.0022405385971069336,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.017711500329894464,
        "admission_positive_above_negative": true,
        "context_hash": "67925c0d2fd4abde",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520|67925c0d2fd4abde",
        "delay_risk_margin": 0.022759169340133667,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 1021,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.013126939535140991,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.012294222373785274,
        "admission_positive_above_negative": true,
        "context_hash": "ddb0ce64af10976a",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520|ddb0ce64af10976a",
        "delay_risk_margin": 0.0095406174659729,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.019915103912353516,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.012871784585325313,
        "admission_positive_above_negative": true,
        "context_hash": "ddb0ce64af10976a",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520|ddb0ce64af10976a",
        "delay_risk_margin": 0.00996178388595581,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.0209178626537323,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.00335030216464291,
        "admission_positive_above_negative": true,
        "context_hash": "ddb0ce64af10976a",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520|ddb0ce64af10976a",
        "delay_risk_margin": 0.00242730975151062,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 1023,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.005785316228866577,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.003927864376182949,
        "admission_positive_above_negative": true,
        "context_hash": "ddb0ce64af10976a",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_06_seed61520|ddb0ce64af10976a",
        "delay_risk_margin": 0.0028484761714935303,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        "negative_row_index": 1024,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.006788074970245361,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0010102471230349352,
        "admission_positive_above_negative": true,
        "context_hash": "f4e732e2cfdeea6e",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_07_seed61635|f4e732e2cfdeea6e",
        "delay_risk_margin": 0.0012758374214172363,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.000954747200012207,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.011570045276002472,
        "admission_positive_above_negative": true,
        "context_hash": "f4e732e2cfdeea6e",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks020_07_seed61635|f4e732e2cfdeea6e",
        "delay_risk_margin": 0.008175551891326904,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.020406275987625122,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0045394728610963775,
        "admission_positive_above_negative": true,
        "context_hash": "3d4ab1c1e344186b",
        "context_key": "tranquillitatis_balmer_like_20km_greedy-anchor_randomtw_tasks030_02_seed71115|3d4ab1c1e344186b",
        "delay_risk_margin": 0.004729330539703369,
        "family": "greedy-anchor",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.005767136812210083,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0005723599710585059,
        "admission_positive_above_negative": true,
        "context_hash": "5c522ff2995f86be",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_03_seed61205|5c522ff2995f86be",
        "delay_risk_margin": 0.0007037818431854248,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.00041419267654418945,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.009747059330281138,
        "admission_positive_above_negative": false,
        "context_hash": "5c522ff2995f86be",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_03_seed61205|5c522ff2995f86be",
        "delay_risk_margin": -0.011590391397476196,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 783,
        "negative_signature_ids": [
        ...
        "raw_margin": -0.007996678352355957,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.017361188770361524,
        "admission_positive_above_negative": false,
        "context_hash": "5c522ff2995f86be",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_03_seed61205|5c522ff2995f86be",
        "delay_risk_margin": -0.005834430456161499,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 783,
        "negative_signature_ids": [
        ...
        "raw_margin": -0.03585183620452881,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.009791765590767526,
        "admission_positive_above_negative": false,
        "context_hash": "9eb0dc7839bf91ec",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_03_seed61205|9eb0dc7839bf91ec",
        "delay_risk_margin": -0.007726222276687622,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.01520487666130066,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -0.0053722826410209645,
        "admission_positive_above_negative": false,
        "context_hash": "9eb0dc7839bf91ec",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_03_seed61205|9eb0dc7839bf91ec",
        "delay_risk_margin": -0.004137963056564331,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.00857234001159668,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.0033437398394042805,
        "admission_positive_above_negative": true,
        "context_hash": "ddcb5387bef3bf63",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_03_seed61205|ddcb5387bef3bf63",
        "delay_risk_margin": -0.0037478506565093994,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.013852238655090332,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.01718983618392772,
        "admission_positive_above_negative": true,
        "context_hash": "a77e5457bde80b8e",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_08_seed61717|a77e5457bde80b8e",
        "delay_risk_margin": 0.03204140067100525,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.001281827688217163,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.0236249167810543,
        "admission_positive_above_negative": true,
        "context_hash": "a77e5457bde80b8e",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_08_seed61717|a77e5457bde80b8e",
        "delay_risk_margin": 0.03669294714927673,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.01237514615058899,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.02640266869359753,
        "admission_positive_above_negative": true,
        "context_hash": "a77e5457bde80b8e",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_08_seed61717|a77e5457bde80b8e",
        "delay_risk_margin": 0.037566691637039185,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.01879715919494629,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.00917548445597935,
        "admission_positive_above_negative": true,
        "context_hash": "7cb380a02e30e5a8",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_09_seed61820|7cb380a02e30e5a8",
        "delay_risk_margin": 0.018236994743347168,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.0018843114376068115,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.032767948687298126,
        "admission_positive_above_negative": true,
        "context_hash": "7cb380a02e30e5a8",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_09_seed61820|7cb380a02e30e5a8",
        "delay_risk_margin": 0.04038086533546448,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.03004664182662964,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.02561775175025041,
        "admission_positive_above_negative": true,
        "context_hash": "7cb380a02e30e5a8",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_09_seed61820|7cb380a02e30e5a8",
        "delay_risk_margin": 0.035222262144088745,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.017749518156051636,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.012961205393705266,
        "admission_positive_above_negative": true,
        "context_hash": "03605a430acbd104",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_10_seed61923|03605a430acbd104",
        "delay_risk_margin": 0.02161860466003418,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.0034300386905670166,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.01819172788366677,
        "admission_positive_above_negative": true,
        "context_hash": "03605a430acbd104",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_10_seed61923|03605a430acbd104",
        "delay_risk_margin": 0.02555885910987854,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.011774122714996338,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.014918868346579628,
        "admission_positive_above_negative": true,
        "context_hash": "03605a430acbd104",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks020_10_seed61923|03605a430acbd104",
        "delay_risk_margin": 0.023173600435256958,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.006417512893676758,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.03640223714591559,
        "admission_positive_above_negative": true,
        "context_hash": "5368cf35ed6f06cb",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks030_02_seed71102|5368cf35ed6f06cb",
        "delay_risk_margin": 0.04163855314254761,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.01547926664352417,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.01917585212699341,
        "admission_positive_above_negative": false,
        "context_hash": "5368cf35ed6f06cb",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks030_02_seed71102|5368cf35ed6f06cb",
        "delay_risk_margin": -0.01647120714187622,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 846,
        "negative_signature_ids": [
        ...
        "raw_margin": -0.023053646087646484,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.05849898839555098,
        "admission_positive_above_negative": true,
        "context_hash": "a0f80eb374f29f44",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks030_02_seed71102|a0f80eb374f29f44",
        "delay_risk_margin": 0.06510946154594421,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": 0.03908669948577881,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.006439480648754714,
        "admission_positive_above_negative": true,
        "context_hash": "a0f80eb374f29f44",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks030_02_seed71102|a0f80eb374f29f44",
        "delay_risk_margin": 0.0032752156257629395,
        "family": "random-wave",
        "negative_roi": 0.0,
        "negative_row_index": 843,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.011622846126556396,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.0072853403486211055,
        "admission_positive_above_negative": false,
        "context_hash": "be33b2560df0147a",
        "context_key": "tranquillitatis_balmer_like_20km_random-wave_randomtw_tasks030_04_seed71306|be33b2560df0147a",
        "delay_risk_margin": -0.009089171886444092,
        "family": "random-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.005166172981262207,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.04907367331554599,
        "admission_positive_above_negative": true,
        "context_hash": "4e481a6307fca228",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_05_seed61410|4e481a6307fca228",
        "delay_risk_margin": 0.05632105469703674,
        "family": "sector-wave",
        ...
        "raw_margin": 0.0337638258934021,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.041113672098195386,
        "admission_positive_above_negative": true,
        "context_hash": "4e481a6307fca228",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_05_seed61410|4e481a6307fca228",
        "delay_risk_margin": 0.0392756462097168,
        "family": "sector-wave",
        ...
        "raw_margin": 0.037513911724090576,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.04907367331554599,
      ...
      {
        "admission_margin": 0.008135005670403123,
        "admission_positive_above_negative": true,
        "context_hash": "4e481a6307fca228",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_05_seed61410|4e481a6307fca228",
        "delay_risk_margin": 0.009527593851089478,
        "family": "sector-wave",
        "negative_roi": -71.0984261500001,
        "negative_row_index": 412,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.007263839244842529,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.00017500445305251855,
        "admission_positive_above_negative": true,
        "context_hash": "4e481a6307fca228",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_05_seed61410|4e481a6307fca228",
        "delay_risk_margin": -0.007517814636230469,
        "family": "sector-wave",
        "negative_roi": -72.99262605000008,
        "negative_row_index": 413,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.011013925075531006,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.04907367331554599,
      ...
      {
        "admission_margin": 0.034785961547201316,
        "admission_positive_above_negative": true,
        "context_hash": "4e481a6307fca228",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_05_seed61410|4e481a6307fca228",
        "delay_risk_margin": 0.03471416234970093,
        "family": "sector-wave",
        "negative_roi": -71.0984261500001,
        "negative_row_index": 412,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.03277933597564697,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.026825960329850712,
        "admission_positive_above_negative": true,
        "context_hash": "4e481a6307fca228",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_05_seed61410|4e481a6307fca228",
        "delay_risk_margin": 0.01766875386238098,
        "family": "sector-wave",
        "negative_roi": -72.99262605000008,
        "negative_row_index": 413,
        "negative_signature_ids": [
        ...
        "raw_margin": 0.03652942180633545,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.03235717843282501,
        "admission_positive_above_negative": true,
        "context_hash": "45baa40751a0bf77",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_07_seed61615|45baa40751a0bf77",
        "delay_risk_margin": 0.03085586428642273,
        "family": "sector-wave",
        ...
        "raw_margin": 0.03545099496841431,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.03991792349045478,
        "admission_positive_above_negative": true,
        "context_hash": "45baa40751a0bf77",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_07_seed61615|45baa40751a0bf77",
        "delay_risk_margin": 0.03698965907096863,
        "family": "sector-wave",
        ...
        "raw_margin": 0.04675754904747009,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 0.02374123247296861,
        "admission_positive_above_negative": true,
        "context_hash": "45baa40751a0bf77",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_07_seed61615|45baa40751a0bf77",
        "delay_risk_margin": 0.012743324041366577,
        "family": "sector-wave",
        ...
        "raw_margin": 0.03827771544456482,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": -0.00013555347426955078,
        "admission_positive_above_negative": false,
        "context_hash": "5a812898b6327d87",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks030_01_seed71001|5a812898b6327d87",
        "delay_risk_margin": -0.00017148256301879883,
        "family": "sector-wave",
        "negative_roi": 0.0,
        ...
        "raw_margin": -0.0001284182071685791,
        "raw_positive_above_negative": false
      }
    ],
    "production_ready": false,
    ...
    "summary": {
      ...
      "primary": "candidate_head_context_ranking_failure",
      "raw_pair_pass_count": 61,
      "raw_pair_pass_rate": 0.782051282051282,
      "strict_pair_pass_count": 59,
      "strict_pair_pass_rate": 0.7564102564102564
    },
    "thresholds": {
      "min_admission_pair_pass_rate": 1.0,
  ...
  "threshold_search": {
    ...
    "selected_metrics": {
      ...
      "accepted_batch_roi": 19.03570304470403,
      "accepted_batch_roi_ci_low": 9.871820818081614,
      "accepted_batch_roi_over_baseline": 19.03570304470403,
      "accepted_batch_roi_over_baseline_ci_low": 9.871820818081614,
      "accepted_batch_roi_over_best_rc_baseline": 19.03570304470403,
      "accepted_batch_roi_over_best_rc_baseline_ci_low": 9.871820818081614,
      "accepted_batch_roi_over_old_gat_baseline": 19.03570304470403,
      "accepted_batch_roi_over_old_gat_baseline_ci_low": 9.871820818081614,
      "accepted_batch_roi_over_random_baseline": 19.03570304470403,
      "accepted_batch_roi_over_random_baseline_ci_low": 9.871820818081614,
      ...
      "candidate_risk_adjusted_suppressed_count": 2112,
      "candidate_score_threshold_blocked_count": 2112,
      ...
      "expected_trajectory_utility": 19.05570304470403,
      ...
      "high_priority_precision": 0.9989711934156379,
      "high_priority_precision_ci_low": 0.9941954106075394,
      "high_priority_prediction_count": 972,
      "high_priority_true_positive_count": 971,
  ...
  "train_deployment_metrics": {
    "accepted_bad_mode_count": 0,
    "accepted_batch_count": 107,
    "accepted_batch_precision": 1.0,
    "accepted_batch_rate": 0.1296969696969697,
    "accepted_batch_roi": 6.798071745069366,
    "accepted_batch_roi_ci_low": 4.677910096606114,
    "accepted_batch_roi_over_baseline": 6.798071745069366,
    "accepted_batch_roi_over_baseline_ci_low": 4.677910096606114,
    "accepted_batch_roi_over_best_rc_baseline": 6.798071745069366,
    "accepted_batch_roi_over_best_rc_baseline_ci_low": 4.677910096606114,
    "accepted_batch_roi_over_old_gat_baseline": 6.798071745069366,
    "accepted_batch_roi_over_old_gat_baseline_ci_low": 4.677910096606114,
    "accepted_batch_roi_over_random_baseline": 6.798071745069366,
    "accepted_batch_roi_over_random_baseline_ci_low": 4.677910096606114,
    "baseline_roi_ci_high": 0.0,
    "baseline_roi_ci_high_source": "configured_point_estimate_no_baseline_distribution",
    "baseline_selection_roi": 0.0,
    "batch_threshold": 0.6541453003883362,
    ...
    "candidate_rescue_window_eligible_count": 0,
    "candidate_rescue_window_promoted_count": 0,
    "candidate_risk_adjusted_suppressed_count": 6211,
    "candidate_score_threshold_blocked_count": 6225,
    "candidate_threshold": 0.21690139287873939,
    "checkpoint_gate_pass": false,
    "checkpoint_gate_reject_reasons": [
      "knn_ood_audit_missing"
    ...
    "delay_rate": 0.8703030303030304,
    "evaluated_candidate_count": 9600,
    "expected_trajectory_utility": 6.825174548807684,
    ...
    "family_holdout_min_accepted_roi": 5.307482294986645,
    ...
    "family_holdout_per_family": {
      "greedy-anchor": {
        "accepted_batch_count": 15,
        "accepted_batch_roi": 5.307482294986645,
        "accepted_high_roi_count": 9,
      ...
      "random-wave": {
        "accepted_batch_count": 55,
        "accepted_batch_roi": 7.223014830696312,
        "accepted_high_roi_count": 32,
        "high_roi_capture_rate": 0.41025641025641024,
      ...
      "sector-wave": {
        ...
        "accepted_batch_roi": 6.770692611062849,
    ...
    "high_priority_precision": 0.9994074074074074,
    "high_priority_precision_ci_low": 0.9978417265186417,
    "high_priority_prediction_count": 3375,
    "high_priority_true_positive_count": 3373,
    "max_accepted_bad_mode_count": 0,
    "min_family_accepted_high_roi_count": 0,
    "min_family_high_roi_capture_rate": 0.0,
    "old_gat_baseline_accepted_batch_roi": 0.0,
    "random_baseline_accepted_batch_roi": 0.0,
    "safe_precision": 1.0,
    "safe_precision_ci_low": 0.9653415324210405,
    "threshold": 0.6541453003883362,
    "threshold_local_gate_pass": true,
    "threshold_local_hard_reject_reason_categories": [],
    "threshold_local_reject_reasons": [],
