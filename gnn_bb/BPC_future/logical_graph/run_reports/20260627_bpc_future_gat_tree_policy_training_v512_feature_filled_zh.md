...
```text
dataset_dir = BPC_future/data/gat_branch_action_sanity/v511_tree_policy_feature_filled_dataset_20260627
checkpoint_out = BPC_future/data/gat_branch_action_sanity/v511_tree_policy_feature_filled_dataset_20260627/gat_tree_policy_v512_feature_filled.pt
sample_count = 189
train_sample_count = 180
validation_sample_count = 9
branch_priority_label_counts = {'not_walltime_gain': 0, 'walltime_gain_positive': 0}
row_kind_counts = {'tree_policy_hard_negative': 160, 'tree_policy_positive': 29}
epochs = 18
