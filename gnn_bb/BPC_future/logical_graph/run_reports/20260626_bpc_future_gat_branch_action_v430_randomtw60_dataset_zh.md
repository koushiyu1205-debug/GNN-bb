...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v430_randomtw60_branch_replay_20260626
target_wall = 200.0
wall_cap = 600.0
...
target_wall_crossing_label_counts = {'not_target_wall_crossing': 83, 'target_wall_crossing_positive': 31}
tail_improved_aux_label_counts = {'tail_improved': 42, 'tail_not_improved': 72}
