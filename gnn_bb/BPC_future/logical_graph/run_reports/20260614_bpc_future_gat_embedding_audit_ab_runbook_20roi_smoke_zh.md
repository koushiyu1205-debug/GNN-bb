...
[
  {
    "baseline_csv": "BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task005_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task005_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "sector-wave",
  ...
  {
    "baseline_csv": "BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task010_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task010_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "sector-wave",
  ...
  {
    "baseline_csv": "BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task020_baseline/results.csv",
    "capture_csv": "BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task020_capture/results.csv",
    "instance_count": 2,
    "instances": [
      {
        "family": "sector-wave",
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. /home/kai/miniconda3/envs/ecole/bin/python BPC_future/scripts/audit_gat_embedding_knn_ood_capture_validation.py BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task020_capture/logs --train-dataset-dir BPC_future/data/gat_trajectory_cbf/v1 --checkpoint BPC_future/data/gat_trajectory_cbf/v1/context_aware_trajectory_cbf_gat.pt --output-dir BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task020_gat_embedding_capture_validation --report BPC_future/results/gat_embedding_audit_ab_runbook_20roi_smoke_20260614/task020_gat_embedding_capture_validation_zh.md --device cpu --knn-k 3 --max-neighbor-unsafe-fraction 0.0 --min-high-priority-threshold 0.750000 --safe-radius-quantile 1.000000 --safe-radius-multiplier 1.000000
```
