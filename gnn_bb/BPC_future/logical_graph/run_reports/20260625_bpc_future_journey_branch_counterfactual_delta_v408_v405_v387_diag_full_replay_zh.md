...
output_dir = BPC_future/results/journey_branch_counterfactual_delta_v408_v405_v387_diag_full_replay
...
label_positive_counts = {'y_counterfactual_local_improved_but_whole_run_not': 3, 'y_counterfactual_proof_cost_improved': 3, 'y_counterfactual_proof_cost_proxy_improved': 6, 'y_counterfactual_regression': 1, 'y_counterfactual_right_censored': 2, 'y_counterfactual_timeout_resolved': 1, 'y_counterfactual_wall_improved': 2}
counterfactual_label_type_counts = {'local_only_hard_negative': 3, 'strong_positive': 3}
status_pair_counts = {'OPTIMAL->OPTIMAL': 3, 'TIME_LIMIT->EXTERNAL_TIME_LIMIT': 1, 'TIME_LIMIT->OPTIMAL': 1, 'TIME_LIMIT->TIME_LIMIT': 1}
