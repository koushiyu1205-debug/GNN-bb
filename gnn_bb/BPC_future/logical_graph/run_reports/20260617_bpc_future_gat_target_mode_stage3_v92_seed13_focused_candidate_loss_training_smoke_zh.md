...
focused_pair_gate_summary = {'focused_row_count': 9, 'context_count': 3, 'contexts_with_positive_and_negative': 2, 'positive_row_count': 2, 'negative_row_count': 7, 'ambiguous_row_count': 0, 'pair_count': 4, 'raw_pair_pass_count': 2, 'admission_pair_pass_count': 2, 'delay_risk_pair_pass_count': 1, 'strict_pair_pass_count': 0, 'raw_pair_pass_rate': 0.5, 'admission_pair_pass_rate': 0.5, 'delay_risk_pair_pass_rate': 0.25, 'strict_pair_pass_rate': 0.0, 'label_counts': {'delay_or_hard_negative': 7, 'positive_high_priority': 2}, 'family_counts': {'sector-wave': 9}, 'primary': 'candidate_head_context_ranking_failure'}
...
best_epoch = 1
selected_validation_loss = 3.7577401096907144
best_loss_epoch = 1
best_validation_loss = 3.7577401096907144
...
```json
{
  ...
  "focused_pair_gate": {
    ...
    "pair_rows": [
      {
        "admission_margin": -0.0003896951675415039,
        "admission_positive_above_negative": false,
        "context_hash": "ac15bc4e7e3d6fff",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_02_seed61104|ac15bc4e7e3d6fff",
        "delay_risk_margin": -0.004711419343948364,
        "family": "sector-wave",
        ...
        "raw_margin": -0.0003896951675415039,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": -4.5299530029296875e-05,
        "admission_positive_above_negative": false,
        "context_hash": "ac15bc4e7e3d6fff",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_02_seed61104|ac15bc4e7e3d6fff",
        "delay_risk_margin": 0.001686394214630127,
        "family": "sector-wave",
        ...
        "raw_margin": -4.5299530029296875e-05,
        "raw_positive_above_negative": false
      },
      {
        "admission_margin": 0.0001220703125,
        "admission_positive_above_negative": true,
        "context_hash": "79fde658840fe2b8",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_08_seed61718|79fde658840fe2b8",
        "delay_risk_margin": -0.002455204725265503,
        "family": "sector-wave",
        ...
        "raw_margin": 0.0001220703125,
        "raw_positive_above_negative": true
      },
      {
        "admission_margin": 9.161233901977539e-05,
        "admission_positive_above_negative": true,
        "context_hash": "79fde658840fe2b8",
        "context_key": "tranquillitatis_balmer_like_20km_sector-wave_randomtw_tasks020_08_seed61718|79fde658840fe2b8",
        "delay_risk_margin": -0.0006542801856994629,
        "family": "sector-wave",
        ...
        "raw_margin": 9.161233901977539e-05,
        "raw_positive_above_negative": true
      }
    ],
    "production_ready": false,
  ...
  "threshold_search": {
    ...
    "selected_metrics": {
      ...
      "batch_threshold": 0.48789867758750916,
      "batch_thresholds_by_family": {
        "random-wave": 0.48789867758750916,
        "sector-wave": 0.4847116470336914
      },
      ...
      "candidate_score_threshold_blocked_count": 436,
      "candidate_threshold": 0.5087072253227234,
      "checkpoint_gate_pass": false,
      ...
      "high_priority_precision_ci_low": 0.991994024694816,
      "high_priority_prediction_count": 476,
      "high_priority_true_positive_count": 476,
  ...
  "train_deployment_metrics": {
    ...
    "accepted_batch_roi": 1.3963342119302404,
    "accepted_batch_roi_ci_low": 0.6291668563237732,
    "accepted_batch_roi_over_baseline": 1.3963342119302404,
    "accepted_batch_roi_over_baseline_ci_low": 0.6291668563237732,
    "accepted_batch_roi_over_best_rc_baseline": 1.3963342119302404,
    "accepted_batch_roi_over_best_rc_baseline_ci_low": 0.6291668563237732,
    "accepted_batch_roi_over_old_gat_baseline": 1.3963342119302404,
    "accepted_batch_roi_over_old_gat_baseline_ci_low": 0.6291668563237732,
    "accepted_batch_roi_over_random_baseline": 1.3963342119302404,
    "accepted_batch_roi_over_random_baseline_ci_low": 0.6291668563237732,
    "baseline_roi_ci_high": 0.0,
    "baseline_roi_ci_high_source": "configured_point_estimate_no_baseline_distribution",
    "baseline_selection_roi": 0.0,
    "batch_threshold": 0.48789867758750916,
    ...
    "candidate_rescue_window_promoted_count": 0,
    "candidate_risk_adjusted_suppressed_count": 0,
    "candidate_score_threshold_blocked_count": 941,
    "candidate_threshold": 0.5087072253227234,
    "checkpoint_gate_pass": false,
    "checkpoint_gate_reject_reasons": [
      "safe_precision_ci_low_below_threshold_or_not_measurable",
    ...
    "expected_trajectory_utility": 1.4331763171933982,
    "false_high_priority_on_delay": 0.175,
    "false_high_priority_on_delay_count": 56,
    "false_safe_rate_label_unsafe": 0.0,
    "false_safe_rate_union": 0.175,
    "family_delay_fallback_families": [],
    "family_holdout_min_accepted_high_roi_count": 0,
    "family_holdout_min_accepted_roi": 0.8911898266524076,
    ...
    "family_holdout_per_family": {
      ...
      "random-wave": {
        ...
        "accepted_batch_roi": 1.7637119466777553,
      ...
      "sector-wave": {
        "accepted_batch_count": 8,
        "accepted_batch_roi": 0.8911898266524076,
    ...
    "high_priority_precision": 0.9803508771929824,
    "high_priority_precision_ci_low": 0.9745712033201608,
    "high_priority_prediction_count": 2850,
    "high_priority_true_positive_count": 2794,
    "max_accepted_bad_mode_count": 0,
    "min_family_accepted_high_roi_count": 0,
    "min_family_high_roi_capture_rate": 0.0,
    "old_gat_baseline_accepted_batch_roi": 0.0,
