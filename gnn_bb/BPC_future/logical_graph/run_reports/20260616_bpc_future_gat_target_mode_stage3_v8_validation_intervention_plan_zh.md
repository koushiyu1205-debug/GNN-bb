...
pairwise_context_target_count = 10
candidate_count = 38
...
```json
{
  ...
  "candidate_family_region_counts": {
    "sector-wave|apollo15_20km": 10,
    "sector-wave|tranquillitatis_balmer_like_20km": 28
  },
  "candidate_impact_bucket_counts": {
    "new_support_changing": 30,
    "new_task_set": 4,
    "replacement_like": 3,
    "support_changing": 1
  },
  "candidate_selection_ranking_counts": {
    "active_replacement": 9,
    "best_rc": 10,
    "diverse": 9,
    "impact": 10
  },
...
```bash
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python BPC_future/scripts/build_gat_target_priority_worker_ab_runbook.py --candidates-file BPC_future/results/gat_batch_impact_multibatch_intervention_plan_v8_validation_context_fallback_20260616/candidates.json --output-dir BPC_future/results/gat_batch_impact_multibatch_intervention_plan_v8_validation_context_fallback_20260616/worker_ab_runbook --report BPC_future/results/gat_batch_impact_multibatch_intervention_plan_v8_validation_context_fallback_20260616/worker_ab_runbook.md --worker-method target_materialization_fixed --worker-batch-size 1
```
