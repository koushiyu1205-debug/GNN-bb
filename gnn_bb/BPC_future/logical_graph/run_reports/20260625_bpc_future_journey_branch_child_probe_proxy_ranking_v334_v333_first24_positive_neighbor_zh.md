...
context_counts = {'all_right_censored_context': 6, 'single_pair_context': 1}
...
promotion_blocked_branch_count = 17
...
- node=0 depth=0 alts=2 spread=2.504829141 best=[4, 16] score=-6.050001492 promote=False worst=[12, 15] score=-8.554830633
...
- node=0 depth=0 alts=2 spread=0.862043192 best=[18, 19] score=-7.818881883 promote=False worst=[12, 16] score=-8.680925075
- node=0 depth=0 alts=2 spread=2.636673436 best=[6, 17] score=-5.951422197 promote=False worst=[3, 18] score=-8.588095633
- node=0 depth=0 alts=2 spread=0.00363775 best=[3, 14] score=-8.27636835 promote=False worst=[9, 14] score=-8.2800061
- node=0 depth=0 alts=1 spread=0.0 best=[6, 20] score=-6.308049642 promote=False worst=[6, 20] score=-6.308049642
...
- node=0 depth=0 better=[6, 17] worse=[3, 18] gap=2.636673436 reason=corrected_gain_then_proxy_score right_censored=True better_promote=False
- node=0 depth=0 better=[4, 16] worse=[12, 15] gap=2.504829141 reason=corrected_gain_then_proxy_score right_censored=True better_promote=False
- node=0 depth=0 better=[18, 19] worse=[12, 16] gap=0.862043192 reason=corrected_gain_then_proxy_score right_censored=True better_promote=False
