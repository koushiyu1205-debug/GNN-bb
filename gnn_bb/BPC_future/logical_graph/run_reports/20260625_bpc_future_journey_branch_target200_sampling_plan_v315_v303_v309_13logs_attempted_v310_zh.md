...
attempted_context_count = 12
all_action_counts = {'BUILD_CHILD_PROBE_RUNBOOK': 11, 'COLLECT_BRANCH_CANDIDATE_DIAG_LOG': 10, 'ROUTE_TO_ROOT_PRICING_TAIL': 4, 'SKIP_ALREADY_ATTEMPTED_CONTEXT': 12, 'SKIP_ALREADY_WITHIN_TARGET': 20, 'SKIP_KNOWN_TARGET200_INSTANCE': 3}
...
commands_path = BPC_future/results/journey_branch_target200_sampling_plan_v315_v303_v309_13logs_attempted_v310_20260625/commands.sh
...
- action=COLLECT_BRANCH_CANDIDATE_DIAG_LOG, reason=branch_events_without_candidate_log, priority=82.0, family=sector-wave, terrain=apollo15_20km, seed=61204, status=EXTERNAL_TIME_LIMIT, wall=600.018615, nodes=0, candidate_events=0, branch_events=21, instance=apollo15_20km_sector-wave_randomtw_tasks020_03_seed61204_logical_graph.json
