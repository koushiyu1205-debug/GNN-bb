...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v658_all_counterfactual_delta_rows_20260628
target_wall = 200.0
wall_cap = 600.0
...
target_wall_crossing_label_counts = {'not_target_wall_crossing': 172, 'target_wall_crossing_positive': 34}
tail_improved_aux_label_counts = {'tail_improved': 50, 'tail_not_improved': 156}
