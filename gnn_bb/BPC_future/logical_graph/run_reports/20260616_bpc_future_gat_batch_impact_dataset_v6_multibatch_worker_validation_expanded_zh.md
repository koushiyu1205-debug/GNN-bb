...
batch_label_counts = {'non_improving': 2, 'roi_positive': 12}
candidate_label_counts = {'delay_queue': 2, 'high_priority': 12}
batch_type_counts = {'new_task_set': 10, 'replacement_heavy': 4}
pairwise_context_stats = {'context_count': 5, 'multi_context_count': 5, 'same_context_pair_count': 13, 'largest_context_size': 3, 'sample_count': 14, 'same_context_comparable_pair_count': 13, 'roi_diverse_context_count': 5, 'positive_negative_label_pair_count': 3, 'by_family': {'random-wave': {'sample_count': 3, 'context_count': 1, 'multi_context_count': 1, 'same_context_pair_count': 3, 'largest_context_size': 3}, 'sector-wave': {'sample_count': 11, 'context_count': 4, 'multi_context_count': 4, 'same_context_pair_count': 10, 'largest_context_size': 3}}, 'by_task_count': {'20': {'sample_count': 14, 'context_count': 5, 'multi_context_count': 5, 'same_context_pair_count': 13, 'largest_context_size': 3}}}
ranking_ready = true
ranking_blockers = []
family_counts = {'random-wave': 3, 'sector-wave': 11}
task_count_counts = {'20': 14}
instance_count = 5
region_count = 2
training_ready = true
training_blockers = []
