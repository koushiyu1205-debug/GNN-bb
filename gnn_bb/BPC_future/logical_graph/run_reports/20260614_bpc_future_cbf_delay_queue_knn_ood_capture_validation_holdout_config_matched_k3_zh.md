...
```json
{
  ...
  "trajectory_dataset": "BPC_future/results/cbf_delay_queue_knn_ood_capture_validation_holdout_config_matched_k3_20260614/trajectory_validation_dataset/cbf_trajectory_gate_transitions.jsonl",
  "validation_candidate_ready": false,
  "validation_metrics": {
    "by_family": {
      "20|greedy-anchor": {
