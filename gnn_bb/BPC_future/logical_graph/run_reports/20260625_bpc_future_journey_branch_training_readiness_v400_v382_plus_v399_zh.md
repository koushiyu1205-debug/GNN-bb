...
target_wall = 200.0
row_count = 27
usable_counterfactual_training_count = 19
strict_full_replay_positive_count = 13
strict_full_replay_positive_context_count = 6
strict_full_replay_positive_instance_count = 5
...
timeout_resolved_count = 5
timeout_regression_count = 6
target_200_positive_holdout_context_count = 0
counterfactual_label_type_counts = {'budget_dominant_improvement': 1, 'local_only_hard_negative': 7, 'regression': 6, 'strong_positive': 13}
status_pair_counts = {'EXTERNAL_TIME_LIMIT->EXTERNAL_TIME_LIMIT': 1, 'EXTERNAL_TIME_LIMIT->OPTIMAL': 5, 'EXTERNAL_TIME_LIMIT->TIME_LIMIT': 1, 'OPTIMAL->EXTERNAL_TIME_LIMIT': 5, 'OPTIMAL->OPTIMAL': 8, 'OPTIMAL->TIME_LIMIT': 1, 'TIME_LIMIT->EXTERNAL_TIME_LIMIT': 4, 'TIME_LIMIT->TIME_LIMIT': 2}
...
remaining_for_serious_training = {'target_200_positive_min': 13, 'hard_negative_min': 24, 'target_200_context_min': 4, 'target_200_instance_min': 4, 'holdout_context_min': 2}
remaining_for_optin_training = {'target_200_positive_min': 33, 'hard_negative_min': 54, 'target_200_context_min': 11, 'target_200_instance_min': 11, 'holdout_context_min': 3}
missing_for_pipeline_debug_training = {}
missing_for_sanity_training = {}
missing_for_serious_training = {'target_200_positive_min': 13, 'hard_negative_min': 24, 'target_200_context_min': 4, 'target_200_instance_min': 4, 'holdout_context_min': 2}
missing_for_optin_training = {'target_200_positive_min': 33, 'hard_negative_min': 54, 'target_200_context_min': 11, 'target_200_instance_min': 11, 'holdout_context_min': 3}
