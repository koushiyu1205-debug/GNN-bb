...
input_row_count = 4
output_row_count = 0
input_paired_label_counts = {'missing_result': 2, 'target_not_replayed': 1}
output_counterfactual_label_counts = {}
skipped_counts = {'not_convertible': 4}
nonconvertible_label_counts = {'baseline': 1, 'missing_result': 2, 'target_not_replayed': 1}
nonconvertible_target_replay_reason_counts = {'log_missing': 2, 'source_node_not_replayed': 2}
rows_path = BPC_future/results/journey_paired_probe_delta_rows_v793_v787_seed61744_root_source_stable/branch_counterfactual_delta_rows.jsonl
