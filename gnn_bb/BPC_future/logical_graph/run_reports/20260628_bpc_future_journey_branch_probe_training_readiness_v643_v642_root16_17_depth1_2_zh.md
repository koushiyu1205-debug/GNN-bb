...
strict_uncensored_probe_positive_count = 0
probe_hard_negative_count = 16
probe_positive_context_count = 0
probe_hard_negative_context_count = 16
probe_instance_count = 1
probe_time_window_family_count = 1
family_counts = {'greedy-anchor': 34}
probe_hard_negative_reason_counts = {'completion_bound_retry': 16, 'low_proxy_score': 16, 'negative_pricing_event': 16, 'right_censored_probe': 16, 'unstarted_child': 5}
...
remaining_for_probe_debug_training = {'probe_branch_row_min': 66, 'probe_positive_min': 10, 'probe_positive_context_min': 2, 'probe_instance_min': 2}
remaining_for_probe_sanity_training = {'probe_branch_row_min': 466, 'probe_positive_min': 30, 'probe_hard_negative_min': 14, 'probe_positive_context_min': 6, 'probe_instance_min': 7, 'probe_time_window_family_min': 1}
remaining_for_probe_serious_training = {'probe_branch_row_min': 966, 'probe_positive_min': 50, 'probe_hard_negative_min': 34, 'probe_positive_context_min': 10, 'probe_instance_min': 11, 'probe_time_window_family_min': 2}
