...
```json
{
  ...
  "candidate_impact_bucket_counts": {
    "new_support_changing": 3
  },
  "candidate_new_task_set_count": 3,
  "candidate_policy": {
  ...
  "candidate_support_changing_proxy_count": 3,
  ...
  "exclude_existing_roi_jsonl": "BPC_future/results/gat_same_run_combined_plus_seed_cross_family_v9_worker_roi_dataset_20260615/gat_worker_roi_rows.jsonl",
  "existing_roi_target_count": 47,
  ...
  "skipped_counts": {
    "decision_not_high_priority": 6,
    "task_count_not_selected": 1
  }
}
```
