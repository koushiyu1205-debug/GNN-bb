...
```json
{
  ...
  "validation_metrics": {
    ...
    "add_precision": 0.3142857142857143,
    "add_recall": 0.6470588235294118,
    "false_high_priority_rate": 0.6666666666666666,
    "false_negative_delay_queue": 6,
    "false_positive_high_priority": 24,
    "predicted_delay_queue": 18,
    "predicted_high_priority": 35,
    "total": 53,
    "true_negative_delay_queue": 12,
    "true_positive_high_priority": 11
  }
}
```
