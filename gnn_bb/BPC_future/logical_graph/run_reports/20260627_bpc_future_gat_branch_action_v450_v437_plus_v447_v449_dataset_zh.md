...
```text
output_dir = BPC_future/data/gat_branch_action_sanity/v450_v437_plus_v447_v449_walltime_20260627
target_wall = 200.0
wall_cap = 600.0
...
target_wall_crossing_label_counts = {'not_target_wall_crossing': 98, 'target_wall_crossing_positive': 30}
tail_improved_aux_label_counts = {'tail_improved': 44, 'tail_not_improved': 84}
