...
from BPC_future.scripts.audit_cbf_delay_queue_knn_ood_grid import audit_knn_ood_grid
...
class CBFDelayQueueKNNOODGridTests(unittest.TestCase):
    def test_knn_ood_grid_preserves_exactness_and_proof_budget_guards(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn("production_candidate_count", summary)
