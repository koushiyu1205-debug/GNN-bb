...
def _parse_log_metrics(path: str | Path) -> dict[str, Any]:
    ...
    metrics: dict[str, Any] = {
        ...
        "schedule_pack_adaptive_events": 0,
        "schedule_pack_adaptive_runs": 0,
        "schedule_pack_adaptive_skips": 0,
        "schedule_pack_adaptive_easy_skips": 0,
        "schedule_pack_adaptive_bound_skips": 0,
        "route_enumeration_adaptive_events": 0,
        "route_enumeration_adaptive_runs": 0,
        "route_enumeration_adaptive_skips": 0,
        "route_enumeration_adaptive_easy_skips": 0,
        "rim_conflict_diag_events": 0,
        "rim_conflict_checked": 0,
        "rim_conflict_pair_cuts_added": 0,
        "rim_conflict_route_set_packing_cuts_added": 0,
        "rim_conflict_route_set_packing_budget_skips": 0,
        "rim_conflict_route_set_packing_cache_hits": 0,
    ...
    with log_path.open("r", encoding="utf-8") as handle:
        for line in handle:
            ...
            if event == "cut_added":
                ...
                elif family == "limited_memory_rank1":
                    metrics["lm_rank1_cut_events"] += int(_as_float(record.get("added")) or 1)
            ...
            if event == "schedule_pack_adaptive":
                metrics["schedule_pack_adaptive_events"] += 1
                if record.get("action") == "run":
                    metrics["schedule_pack_adaptive_runs"] += 1
                else:
                    metrics["schedule_pack_adaptive_skips"] += 1
                    if record.get("reason") == "easy_gap":
                        metrics["schedule_pack_adaptive_easy_skips"] += 1
                    elif record.get("reason") == "already_fathomable":
                        metrics["schedule_pack_adaptive_bound_skips"] += 1
            if event == "route_enumeration_adaptive":
                metrics["route_enumeration_adaptive_events"] += 1
                if record.get("action") == "run":
                    metrics["route_enumeration_adaptive_runs"] += 1
                else:
                    metrics["route_enumeration_adaptive_skips"] += 1
                    if record.get("reason") == "easy_gap":
                        metrics["route_enumeration_adaptive_easy_skips"] += 1
            ...
            if event == "rim_conflict_diagnostics":
                ...
                metrics["rim_conflict_route_set_packing_cuts_added"] += int(
                    _as_float(record.get("route_set_packing_cuts_added")) or 0
                )
                metrics["rim_conflict_route_set_packing_budget_skips"] += int(
                    _as_float(record.get("route_set_packing_budget_skips")) or 0
                )
                metrics["rim_conflict_route_set_packing_cache_hits"] += int(
                    _as_float(record.get("route_set_packing_cache_hits")) or 0
                )
...
def _solve_bpc_clean_job(job: dict[str, Any]) -> dict[str, Any]:
    ...
    result = solve_bpc_clean(
        ...
        schedule_pack_diagnostic_max_candidate_routes=int(config.get("schedule_pack_diagnostic_max_candidate_routes", 180)),
        ...
        schedule_pack_relaxation_use_for_priority=_bool_config(config, "schedule_pack_relaxation_use_for_priority", True),
...
def _write_csv(path: Path, rows: list[dict[str, Any]]) -> None:
    ...
    preferred = [
        ...
        "result_cuts_added",
        "result_subset_row_cuts_added",
        "result_lm_rank1_cuts_added",
        ...
        "result_schedule_pack_diagnostic_status",
        "result_schedule_pack_diagnostic_objective",
        "result_schedule_pack_diagnostic_gap_vs_root",
        "result_schedule_pack_relaxation_calls",
        "result_schedule_pack_relaxation_root_objective",
        "result_schedule_pack_relaxation_best_objective",
        "result_schedule_pack_relaxation_best_gap_vs_node",
        "result_schedule_pack_relaxation_candidate_exact",
        "result_schedule_pack_relaxation_full_exact",
        "result_schedule_pack_relaxation_full_pricing_states",
        "result_schedule_pack_relaxation_full_pricing_time",
        "result_schedule_pack_adaptive_decisions",
        "result_schedule_pack_adaptive_runs",
        "result_schedule_pack_adaptive_skips",
        "result_schedule_pack_adaptive_easy_skips",
        "result_schedule_pack_adaptive_bound_skips",
        "result_route_enumeration_adaptive_decisions",
        "result_route_enumeration_adaptive_runs",
        "result_route_enumeration_adaptive_skips",
        "result_route_enumeration_adaptive_easy_skips",
        "metric_time_to_first_incumbent",
        "metric_time_to_best_incumbent",
        "metric_root_pricing_events",
        "metric_lm_rank1_cut_events",
        ...
        "metric_schedule_pack_adaptive_events",
        "metric_schedule_pack_adaptive_runs",
        "metric_schedule_pack_adaptive_skips",
        "metric_schedule_pack_adaptive_easy_skips",
        "metric_schedule_pack_adaptive_bound_skips",
        "metric_route_enumeration_adaptive_events",
        "metric_route_enumeration_adaptive_runs",
        "metric_route_enumeration_adaptive_skips",
        "metric_route_enumeration_adaptive_easy_skips",
