...
def _solve_hybrid_route_bpc(
    ...
    *,
    ...
    result = solve_bpc_clean(
        ...
        restricted_master_repair_enabled=_hybrid_bool(config, "restricted_master_repair_enabled", True),
        ...
        three_pb_candidate_budget_enabled=_hybrid_bool(config, "three_pb_candidate_budget_enabled", False),
        three_pb_root_pseudocost_candidates=int(_hybrid_value(config, "three_pb_root_pseudocost_candidates", 6)),
        three_pb_root_fractional_candidates=int(_hybrid_value(config, "three_pb_root_fractional_candidates", 6)),
        three_pb_root_lp_candidates=int(_hybrid_value(config, "three_pb_root_lp_candidates", 3)),
        three_pb_nonroot_pseudocost_candidates=int(_hybrid_value(config, "three_pb_nonroot_pseudocost_candidates", 4)),
        three_pb_nonroot_fractional_candidates=int(_hybrid_value(config, "three_pb_nonroot_fractional_candidates", 4)),
        three_pb_nonroot_lp_candidates=int(_hybrid_value(config, "three_pb_nonroot_lp_candidates", 2)),
        three_pb_deep_depth=int(_hybrid_value(config, "three_pb_deep_depth", 3)),
        three_pb_deep_pseudocost_candidates=int(_hybrid_value(config, "three_pb_deep_pseudocost_candidates", 3)),
        three_pb_deep_fractional_candidates=int(_hybrid_value(config, "three_pb_deep_fractional_candidates", 3)),
        three_pb_deep_lp_candidates=int(_hybrid_value(config, "three_pb_deep_lp_candidates", 1)),
        ...
        root_schedule_capacity_cuts_enabled=_hybrid_bool(config, "root_schedule_capacity_cuts_enabled", False),
        root_schedule_capacity_max_depth=int(_hybrid_value(config, "root_schedule_capacity_max_depth", 0)),
        root_schedule_capacity_pair_budget=int(_hybrid_value(config, "root_schedule_capacity_pair_budget", 100)),
        root_schedule_capacity_triple_budget=int(_hybrid_value(config, "root_schedule_capacity_triple_budget", 50)),
        root_schedule_capacity_oracle_max_states=int(_hybrid_value(config, "root_schedule_capacity_oracle_max_states", 200000)),
        root_schedule_capacity_time_budget=float(_hybrid_value(config, "root_schedule_capacity_time_budget", 5.0)),
        root_schedule_capacity_min_violation=float(_hybrid_value(config, "root_schedule_capacity_min_violation", 1.0e-5)),
        root_schedule_capacity_stop_after_no_add_rounds=int(
            _hybrid_value(config, "root_schedule_capacity_stop_after_no_add_rounds", 1)
        ),
        ...
        route_set_schedule_packing_roi_guard_enabled=_hybrid_bool(
            config, "route_set_schedule_packing_roi_guard_enabled", True
        ),
        route_set_schedule_packing_stop_after_no_add_rounds=int(
            _hybrid_value(config, "route_set_schedule_packing_stop_after_no_add_rounds", 1)
        ),
        route_set_schedule_packing_min_objective_improvement=float(
            _hybrid_value(config, "route_set_schedule_packing_min_objective_improvement", 1.0e-7)
        ),
        route_set_schedule_packing_stop_after_no_improve_rounds=int(
            _hybrid_value(config, "route_set_schedule_packing_stop_after_no_improve_rounds", 2)
        ),
        route_set_schedule_packing_global_time_limit_ratio=float(
            _hybrid_value(config, "route_set_schedule_packing_global_time_limit_ratio", 0.10)
        ),
        fleet_lower_bound_cuts_enabled=_hybrid_bool(config, "fleet_lower_bound_cuts_enabled", False),
        fleet_lower_bound_oracle_max_states=int(_hybrid_value(config, "fleet_lower_bound_oracle_max_states", 500000)),
        schedule_pack_diagnostic_enabled=_hybrid_bool(config, "schedule_pack_diagnostic_enabled", False),
        schedule_pack_diagnostic_max_candidate_routes=int(_hybrid_value(config, "schedule_pack_diagnostic_max_candidate_routes", 180)),
        schedule_pack_diagnostic_max_columns=int(_hybrid_value(config, "schedule_pack_diagnostic_max_columns", 8000)),
        schedule_pack_diagnostic_beam_width=int(_hybrid_value(config, "schedule_pack_diagnostic_beam_width", 800)),
        schedule_pack_diagnostic_max_sorties=int(_hybrid_value(config, "schedule_pack_diagnostic_max_sorties", 0)),
        schedule_pack_diagnostic_time_limit=float(_hybrid_value(config, "schedule_pack_diagnostic_time_limit", 60.0)),
        schedule_pack_pricing_batch_size=int(_hybrid_value(config, "schedule_pack_pricing_batch_size", 32)),
        schedule_pack_relaxation_enabled=_hybrid_bool(config, "schedule_pack_relaxation_enabled", False),
        schedule_pack_relaxation_max_depth=int(_hybrid_value(config, "schedule_pack_relaxation_max_depth", 2)),
        schedule_pack_relaxation_time_limit=float(_hybrid_value(config, "schedule_pack_relaxation_time_limit", 30.0)),
        schedule_pack_relaxation_use_for_priority=_hybrid_bool(config, "schedule_pack_relaxation_use_for_priority", True),
        schedule_pack_full_pricing_enabled=_hybrid_bool(config, "schedule_pack_full_pricing_enabled", False),
        schedule_pack_full_pricing_max_depth=int(_hybrid_value(config, "schedule_pack_full_pricing_max_depth", 0)),
        schedule_pack_full_pricing_max_states=int(_hybrid_value(config, "schedule_pack_full_pricing_max_states", 0)),
